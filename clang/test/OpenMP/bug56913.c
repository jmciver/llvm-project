...
// CHECK-NEXT:    [[SUB2:%.*]] = add nsw i32 [[N]], -1
// CHECK-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[N]], 0
// CHECK-NEXT:    br i1 [[CMP]], label [[SIMD_IF_THEN:%.*]], label [[SIMD_IF_END:%.*]]
// CHECK:       simd.if.then:
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr @j, align 4, !tbaa [[TBAA2:![0-9]+]], !freeze_bits [[FREEZE_BITS6:![0-9]+]]
...
// CHECK-NEXT:    [[DOTOMP_IV_026:%.*]] = phi i32 [ 0, [[SIMD_IF_THEN]] ], [ [[ADD12:%.*]], [[OMP_INNER_FOR_BODY]] ]
// CHECK-NEXT:    [[ADD12]] = add i32 [[DOTOMP_IV_026]], 1
// CHECK-NEXT:    [[CMP8_NOT:%.*]] = icmp ugt i32 [[ADD12]], [[SUB2]]
// CHECK-NEXT:    br i1 [[CMP8_NOT]], label [[OMP_INNER_FOR_END:%.*]], label [[OMP_INNER_FOR_BODY]], !llvm.loop [[LOOP10:![0-9]+]]
// CHECK:       omp.inner.for.end:
// CHECK-NEXT:    [[ADD11:%.*]] = add i32 [[TMP0]], 1
// CHECK-NEXT:    [[INC_LE:%.*]] = add i32 [[ADD11]], [[DOTOMP_IV_026]]
// CHECK-NEXT:    [[TMP1:%.*]] = freeze i32 [[INC_LE]]
// CHECK-NEXT:    store i32 [[TMP1]], ptr [[J]], align 4, !tbaa [[TBAA2]]
// CHECK-NEXT:    store i32 [[TMP1]], ptr @j, align 4, !tbaa [[TBAA2]]
