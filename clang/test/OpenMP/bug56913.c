...
// CHECK:       simd.if.then:
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr @j, align 4, !tbaa [[TBAA2:![0-9]+]], !freeze_bits [[META6:![0-9]+]]
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 4, ptr nonnull [[J]]) #[[ATTR2:[0-9]+]]
// CHECK-NEXT:    store i32 0, ptr [[J]], align 4
// CHECK-NEXT:    store ptr [[J]], ptr @u, align 8, !tbaa [[TBAA7:![0-9]+]], !llvm.access.group [[ACC_GRP10:![0-9]+]]
