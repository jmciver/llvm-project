...
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l68.omp_outlined.omp_outlined, i64 [[TMP14]], i64 [[TMP16]], ptr [[G7]], ptr [[TMP17]], ptr [[SVAR12]], ptr [[SFVAR14]]), !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 8, !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP11]], align 8, !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store ptr [[SVAR12]], ptr [[TMP19]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK1-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR14]], ptr [[TMP20]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK1-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load double, ptr [[TMP0]], align 8, !freeze_bits [[META5:![0-9]+]]
...
// CHECK3-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP5]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l68.omp_outlined.omp_outlined, i32 [[TMP13]], i32 [[TMP14]], ptr [[G7]], ptr [[TMP15]], ptr [[SVAR12]], ptr [[SFVAR14]]), !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP10]], align 4, !llvm.access.group [[ACC_GRP10]], !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP10]], align 4, !llvm.access.group [[ACC_GRP10]], !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR11]], ptr [[TMP19]], align 4, !llvm.access.group [[ACC_GRP10]]
// CHECK3-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR13]], ptr [[TMP20]], align 4, !llvm.access.group [[ACC_GRP10]]
...
// CHECK3-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
...
// CHECK13-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META2:![0-9]+]]
// CHECK13-NEXT:    store ptr [[TMP2]], ptr [[_TMP4]], align 8
// CHECK13-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP4]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP5]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP9:%.*]] = load i32, ptr [[T_VAR11]], align 4, !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP16]], align 8, !llvm.access.group [[ACC_GRP3]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX19]], ptr align 4 [[TMP11]], i64 4, i1 false), !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    store i32 [[ADD20]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP2]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    br i1 [[ARRAYCTOR_DONE]], label [[ARRAYCTOR_CONT:%.*]], label [[ARRAYCTOR_LOOP]]
// CHECK13:       arrayctor.cont:
// CHECK13-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP9:%.*]] = load i32, ptr [[T_VAR9]], align 4, !llvm.access.group [[ACC_GRP7]]
...
// CHECK13-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP14]], align 8, !llvm.access.group [[ACC_GRP7]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP11]], i64 4, i1 false), !llvm.access.group [[ACC_GRP7]]
// CHECK13-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK13:       omp.body.continue:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK13:       omp.inner.for.inc:
...
// CHECK13-NEXT:    store i32 [[ADD17]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP7]]
...
// CHECK15-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP]], align 4, !freeze_bits [[META3:![0-9]+]]
// CHECK15-NEXT:    store ptr [[TMP2]], ptr [[_TMP4]], align 4
// CHECK15-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP4]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP5]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP9:%.*]] = load i32, ptr [[T_VAR11]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP16]], align 4, !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META3]]
...
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX18]], ptr align 4 [[TMP11]], i32 4, i1 false), !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    store i32 [[ADD19]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP2]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    br i1 [[ARRAYCTOR_DONE]], label [[ARRAYCTOR_CONT:%.*]], label [[ARRAYCTOR_LOOP]]
// CHECK15:       arrayctor.cont:
// CHECK15-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP3]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP9:%.*]] = load i32, ptr [[T_VAR9]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK15-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP14]], align 4, !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META3]]
...
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP11]], i32 4, i1 false), !llvm.access.group [[ACC_GRP8]]
// CHECK15-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK15:       omp.body.continue:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK15:       omp.inner.for.inc:
...
// CHECK15-NEXT:    store i32 [[ADD16]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP8]]
