...
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32, ptr [[G_ADDR]], align 4, !freeze_bits [[META4]]
// CHECK9-NEXT:    store i32 [[TMP11]], ptr [[G_CASTED]], align 4
// CHECK9-NEXT:    [[TMP12:%.*]] = load i64, ptr [[G_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK9-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META4]]
// CHECK9-NEXT:    [[TMP14:%.*]] = load volatile i32, ptr [[TMP13]], align 4, !freeze_bits [[META4]]
// CHECK9-NEXT:    store i32 [[TMP14]], ptr [[G1_CASTED]], align 4
// CHECK9-NEXT:    [[TMP15:%.*]] = load i64, ptr [[G1_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK9-NEXT:    [[TMP16:%.*]] = load i32, ptr [[SIVAR_ADDR]], align 4, !freeze_bits [[META4]]
// CHECK9-NEXT:    store i32 [[TMP16]], ptr [[SIVAR_CASTED]], align 4
// CHECK9-NEXT:    [[TMP17:%.*]] = load i64, ptr [[SIVAR_CASTED]], align 8, !freeze_bits [[META4]]
...
// CHECK9-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META4]]
