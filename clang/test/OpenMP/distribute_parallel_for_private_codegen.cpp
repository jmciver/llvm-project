...
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META5]]
...
// CHECK11-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[_TMP7]], align 4, !freeze_bits [[META6]]
