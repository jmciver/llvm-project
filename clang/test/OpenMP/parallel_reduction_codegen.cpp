...
// CHECK1-NEXT:    [[TMP6:%.*]] = load float, ptr [[T_VAR2]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load float, ptr [[T_VAR15]], align 4, !freeze_bits [[META3]]
...
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP20:%.*]] = load float, ptr [[T_VAR15]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
...
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP21:%.*]] = load float, ptr [[T_VAR2]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    call void @__kmpc_end_critical(ptr @[[GLOB2]], i32 [[TMP12]], ptr @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[TMP24:%.*]] = load float, ptr [[T_VAR15]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP28:%.*]] = load float, ptr [[T_VAR15]], align 4, !freeze_bits [[META3]]
...
// CHECK1:       cond.false22:
// CHECK1-NEXT:    [[TMP30:%.*]] = load float, ptr [[T_VAR15]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    br label [[COND_END23]]
// CHECK1:       cond.end23:
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C5]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[BF_LOAD8:%.*]] = load i8, ptr [[B7]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP2]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[A2]], align 8, !freeze_bits [[META3]]
// CHECK3-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C5]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[BF_LOAD8:%.*]] = load i8, ptr [[B7]], align 4, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    store ptr [[C6]], ptr [[_TMP8]], align 8
// CHECK3-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[TMP6]], align 4, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[TMP9]], align 4, !freeze_bits [[META3]]
// CHECK3-NEXT:    [[DIV:%.*]] = sdiv i32 [[TMP10]], 1
// CHECK3-NEXT:    store i32 [[DIV]], ptr [[TMP9]], align 4
...
// CHECK4-NEXT:    [[TMP0:%.*]] = load ptr, ptr getelementptr inbounds ([[STRUCT___BLOCK_LITERAL_GENERIC:%.*]], ptr @__block_literal_global, i32 0, i32 3), align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    store i32 [[FREEZE_POISON]], ptr [[G1]], align 4
...
// CHECK4-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C5]], align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[BF_LOAD8:%.*]] = load i8, ptr [[B7]], align 4, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
// CHECK4-NEXT:    store ptr [[TMP6]], ptr [[BLOCK_CAPTURED]], align 8
// CHECK4-NEXT:    [[BLOCK_CAPTURED9:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, ptr, ptr, ptr, i32 }>, ptr [[BLOCK]], i32 0, i32 8
// CHECK4-NEXT:    [[TMP7:%.*]] = load i32, ptr [[B4]], align 4
// CHECK4-NEXT:    store i32 [[TMP7]], ptr [[BLOCK_CAPTURED9]], align 8
// CHECK4-NEXT:    [[BLOCK_CAPTURED10:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, ptr, ptr, ptr, i32 }>, ptr [[BLOCK]], i32 0, i32 7
// CHECK4-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
