...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C6]], align 8
...
// CHECK1-NEXT:    [[B9:%.*]] = getelementptr inbounds [[STRUCT_SS]], ptr [[THIS1]], i32 0, i32 1
...
// CHECK3-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[C8]], align 8, !freeze_bits [[META3]]
// CHECK3-NEXT:    store ptr [[TMP1]], ptr [[C6]], align 8
// CHECK3-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[A2]], align 8
// CHECK3-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C6]], align 8
...
// CHECK3-NEXT:    [[B9:%.*]] = getelementptr inbounds [[STRUCT_SS]], ptr [[THIS1]], i32 0, i32 1
...
// CHECK4-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C6]], align 8
...
// CHECK4-NEXT:    [[B9:%.*]] = getelementptr inbounds [[STRUCT_SS]], ptr [[THIS1]], i32 0, i32 1
