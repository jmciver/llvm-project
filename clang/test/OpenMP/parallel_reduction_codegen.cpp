...
// CHECK1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK1-NEXT:    store ptr [[X]], ptr [[X_ADDR]], align 8
// CHECK1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i16, ptr [[TMP0]], i64 0
// CHECK1-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP23:%.*]] = load i16, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST2]], align 2, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i16 [[TMP23]] to i32
// CHECK1-NEXT:    [[TMP24:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP26:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST10]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP28:%.*]] = load i16, ptr [[_TMP13]], align 2, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV14:%.*]] = sext i16 [[TMP28]] to i32
// CHECK1-NEXT:    [[TMP29:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST10]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP12:%.*]] = load i16, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i16 [[TMP12]] to i32
// CHECK1-NEXT:    [[TMP13:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[VAR1_ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[T_VAR1_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP6:%.*]] = load float, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP14:%.*]] = load float, ptr [[TMP1]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load float, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load float, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP:%.*]] = fcmp olt float [[TMP17]], [[TMP18]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    [[TMP19:%.*]] = load float, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP20:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
...
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP21:%.*]] = load float, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    call void @__kmpc_end_critical(ptr @[[GLOB2]], i32 [[TMP12]], ptr @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[TMP24:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP27:%.*]] = load float, ptr [[TMP]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP28:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP20:%.*]] = fcmp olt float [[TMP27]], [[TMP28]]
// CHECK1-NEXT:    br i1 [[CMP20]], label [[COND_TRUE21:%.*]], label [[COND_FALSE22:%.*]]
// CHECK1:       cond.true21:
// CHECK1-NEXT:    [[TMP29:%.*]] = load float, ptr [[TMP]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END23]]
// CHECK1:       cond.false22:
// CHECK1-NEXT:    [[TMP30:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END23]]
// CHECK1:       cond.end23:
...
// CHECK1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[CF_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[_TMP3]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP8:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[DEC:%.*]] = add nsw i32 [[TMP8]], -1
// CHECK1-NEXT:    store i32 [[DEC]], ptr [[B4]], align 4
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP4]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP17]], [[TMP18]]
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[TMP4]], align 4
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP23:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP24:%.*]] = atomicrmw add ptr [[TMP4]], i32 [[TMP23]] monotonic, align 4
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP26:%.*]] = atomicrmw add ptr [[TMP2]], i32 [[TMP25]] monotonic, align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[TMP14]], align 8
// CHECK1-NEXT:    [[TMP16:%.*]] = load i32, ptr [[TMP7]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[TMP7]], align 4
// CHECK1-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP11]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP9]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP18]], [[TMP19]]
// CHECK1-NEXT:    store i32 [[ADD2]], ptr [[TMP11]], align 4
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP13]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP0:%.*]] = load volatile i32, ptr @g, align 128, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP0:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr @g, align 128, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP6:%.*]] = load i32, ptr [[T_VAR2]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[TMP0]], i64 0, i64 0
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[TMP1]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR2]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP5]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load i32, ptr [[T_VAR15]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP17]], [[TMP18]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP5]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[T_VAR15]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
...
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[T_VAR2]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    call void @__kmpc_end_critical(ptr @[[GLOB2]], i32 [[TMP12]], ptr @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[TMP24:%.*]] = load i32, ptr [[T_VAR15]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [4 x ptr], ptr [[TMP2]], i64 0, i64 3
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[TMP18]], align 8
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP7]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP5]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    call void @_ZN1SIiED1Ev(ptr noundef nonnull align 4 dereferenceable(4) [[REF_TMP]]) #[[ATTR5]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load i32, ptr [[TMP19]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load i32, ptr [[TMP17]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP23]], [[TMP24]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[TMP19]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[TMP17]], align 128, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP2]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP10:%.*]] = load i32, ptr [[A1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP11:%.*]] = load i32, ptr [[A1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load i32, ptr [[_TMP3]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[A1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK3-NEXT:    store ptr [[X]], ptr [[X_ADDR]], align 8
// CHECK3-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i16, ptr [[TMP0]], i64 0
// CHECK3-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load i16, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST2]], align 2, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CONV:%.*]] = sext i16 [[TMP23]] to i32
// CHECK3-NEXT:    [[TMP24:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP26:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST10]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP28:%.*]] = load i16, ptr [[_TMP13]], align 2, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CONV14:%.*]] = sext i16 [[TMP28]] to i32
// CHECK3-NEXT:    [[TMP29:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST10]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP12:%.*]] = load i16, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CONV:%.*]] = sext i16 [[TMP12]] to i32
// CHECK3-NEXT:    [[TMP13:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[D_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[C6]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP1]], ptr [[C5]], align 8
// CHECK3-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[A2]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[C5]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB2]], i32 4, ptr @.omp_outlined..1, ptr [[THIS1]], ptr [[TMP2]], ptr [[B4]], ptr [[TMP3]])
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP3]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    ]
// CHECK3:       .omp.reduction.case1:
// CHECK3-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP18]], [[TMP19]]
// CHECK3-NEXT:    store i32 [[ADD]], ptr [[TMP4]], align 4
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP20]], [[TMP21]]
// CHECK3-NEXT:    store i32 [[ADD7]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK3:       .omp.reduction.case2:
// CHECK3-NEXT:    [[TMP24:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP25:%.*]] = atomicrmw add ptr [[TMP4]], i32 [[TMP24]] monotonic, align 4
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP27:%.*]] = atomicrmw add ptr [[TMP2]], i32 [[TMP26]] monotonic, align 4
// CHECK3-NEXT:    [[TMP28:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP16:%.*]] = load i32, ptr [[TMP7]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
// CHECK3-NEXT:    store i32 [[ADD]], ptr [[TMP7]], align 4
// CHECK3-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP11]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP9]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP18]], [[TMP19]]
// CHECK3-NEXT:    store i32 [[ADD2]], ptr [[TMP11]], align 4
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP15]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP13]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    store ptr [[C5]], ptr [[_TMP6]], align 8
// CHECK3-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[_TMP3]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[TMP6]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP7]], 1
// CHECK3-NEXT:    store i32 [[INC]], ptr [[TMP6]], align 4
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[DEC:%.*]] = add nsw i32 [[TMP8]], -1
// CHECK3-NEXT:    store i32 [[DEC]], ptr [[B4]], align 4
// CHECK3-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[TMP9]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[DIV:%.*]] = sdiv i32 [[TMP10]], 1
// CHECK3-NEXT:    store i32 [[DIV]], ptr [[TMP9]], align 4
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    ]
// CHECK3:       .omp.reduction.case1:
// CHECK3-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP18:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[AND:%.*]] = and i32 [[TMP17]], [[TMP18]]
// CHECK3-NEXT:    store i32 [[AND]], ptr [[TMP4]], align 4
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[AND7:%.*]] = and i32 [[TMP19]], [[TMP20]]
// CHECK3-NEXT:    store i32 [[AND7]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK3:       .omp.reduction.case2:
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP24:%.*]] = atomicrmw and ptr [[TMP4]], i32 [[TMP23]] monotonic, align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP26:%.*]] = atomicrmw and ptr [[TMP2]], i32 [[TMP25]] monotonic, align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[G_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    ]
// CHECK3:       .omp.reduction.case1:
// CHECK3-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP0]], align 128, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[G1]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK3:       .omp.reduction.case2:
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[G1]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[TMP6]], align 8
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[TMP7]], align 128, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP5]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK4-NEXT:    store ptr [[X]], ptr [[X_ADDR]], align 8
// CHECK4-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i16, ptr [[TMP0]], i64 0
// CHECK4-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[X_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP23:%.*]] = load i16, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST2]], align 2, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[CONV:%.*]] = sext i16 [[TMP23]] to i32
// CHECK4-NEXT:    [[TMP24:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP26:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST10]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP28:%.*]] = load i16, ptr [[_TMP13]], align 2, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[CONV14:%.*]] = sext i16 [[TMP28]] to i32
// CHECK4-NEXT:    [[TMP29:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST10]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP12:%.*]] = load i16, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[CONV:%.*]] = sext i16 [[TMP12]] to i32
// CHECK4-NEXT:    [[TMP13:%.*]] = load i16, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 2, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[G_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr [[G1]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    ]
// CHECK4:       .omp.reduction.case1:
// CHECK4-NEXT:    [[TMP8:%.*]] = load i32, ptr [[TMP0]], align 128, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP9:%.*]] = load i32, ptr [[G1]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK4:       .omp.reduction.case2:
// CHECK4-NEXT:    [[TMP10:%.*]] = load i32, ptr [[G1]], align 128, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[TMP6]], align 8
// CHECK4-NEXT:    [[TMP8:%.*]] = load i32, ptr [[TMP7]], align 128, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP5]], align 128, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP8]], [[TMP9]]
...
// CHECK4-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[_TMP3]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP7:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    ]
// CHECK4:       .omp.reduction.case1:
// CHECK4-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP4]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP18:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP17]], [[TMP18]]
// CHECK4-NEXT:    store i32 [[ADD]], ptr [[TMP4]], align 4
// CHECK4-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP20:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
// CHECK4-NEXT:    store i32 [[ADD9]], ptr [[TMP2]], align 4
// CHECK4-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP22:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK4:       .omp.reduction.case2:
// CHECK4-NEXT:    [[TMP23:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP24:%.*]] = atomicrmw add ptr [[TMP4]], i32 [[TMP23]] monotonic, align 4
// CHECK4-NEXT:    [[TMP25:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP26:%.*]] = atomicrmw add ptr [[TMP2]], i32 [[TMP25]] monotonic, align 4
// CHECK4-NEXT:    [[TMP27:%.*]] = load i32, ptr [[C5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP8:%.*]] = load i32, ptr [[B4]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[DEC:%.*]] = add nsw i32 [[TMP8]], -1
// CHECK4-NEXT:    store i32 [[DEC]], ptr [[B4]], align 4
// CHECK4-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP16:%.*]] = load i32, ptr [[TMP7]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
// CHECK4-NEXT:    store i32 [[ADD]], ptr [[TMP7]], align 4
// CHECK4-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP11]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP19:%.*]] = load i32, ptr [[TMP9]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP18]], [[TMP19]]
// CHECK4-NEXT:    store i32 [[ADD2]], ptr [[TMP11]], align 4
// CHECK4-NEXT:    [[TMP20:%.*]] = load i32, ptr [[TMP15]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP21:%.*]] = load i32, ptr [[TMP13]], align 4, !noundef [[NOUNDEF3]]
