...
// CHECK9-NEXT:    [[TMP19:%.*]] = load i32, ptr [[N_ADDR]], align 4, !freeze_bits [[META9]]
// CHECK9-NEXT:    store i32 [[TMP19]], ptr [[N_CASTED]], align 4
// CHECK9-NEXT:    [[TMP20:%.*]] = load i64, ptr [[N_CASTED]], align 8, !freeze_bits [[META9]]
...
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32, ptr [[N_ADDR]], align 4, !freeze_bits [[META9]]
// CHECK9-NEXT:    store i32 [[TMP20]], ptr [[N_CASTED]], align 4
// CHECK9-NEXT:    [[TMP21:%.*]] = load i64, ptr [[N_CASTED]], align 8, !freeze_bits [[META9]]
// CHECK9-NEXT:    [[TMP22:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__ADDR]], align 4, !freeze_bits [[META9]]
// CHECK9-NEXT:    store i32 [[TMP22]], ptr [[DOTCAPTURE_EXPR__CASTED]], align 4
// CHECK9-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR__CASTED]], align 8, !freeze_bits [[META9]]
...
// CHECK11-NEXT:    [[TMP17:%.*]] = load i32, ptr [[N_ADDR]], align 4, !freeze_bits [[META10]]
// CHECK11-NEXT:    store i32 [[TMP17]], ptr [[N_CASTED]], align 4
// CHECK11-NEXT:    [[TMP18:%.*]] = load i32, ptr [[N_CASTED]], align 4, !freeze_bits [[META10]]
...
// CHECK11-NEXT:    [[TMP18:%.*]] = load i32, ptr [[N_ADDR]], align 4, !freeze_bits [[META10]]
// CHECK11-NEXT:    store i32 [[TMP18]], ptr [[N_CASTED]], align 4
// CHECK11-NEXT:    [[TMP19:%.*]] = load i32, ptr [[N_CASTED]], align 4, !freeze_bits [[META10]]
// CHECK11-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__ADDR]], align 4, !freeze_bits [[META10]]
// CHECK11-NEXT:    store i32 [[TMP20]], ptr [[DOTCAPTURE_EXPR__CASTED]], align 4
// CHECK11-NEXT:    [[TMP21:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__CASTED]], align 4, !freeze_bits [[META10]]
