...
// CHECK-NEXT:    [[DOTNOT26:%.*]] = icmp eq i32 [[TMP13]], 0
// CHECK-NEXT:    br i1 [[DOTNOT26]], label %[[OMP_IF_END21:.*]], label %[[OMP_IF_THEN2:.*]]
// CHECK:       [[OMP_IF_THEN2]]:
...
// CHECK-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[ARRAYIDX]], align 8, !tbaa [[TBAA17:![0-9]+]], !freeze_bits [[META19:![0-9]+]]
// CHECK-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds i8, ptr [[TMP16]], i64 [[IDXPROM]]
// CHECK-NEXT:    [[TMP17:%.*]] = load i8, ptr [[ARRAYIDX12]], align 1, !tbaa [[TBAA20:![0-9]+]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[CONV:%.*]] = sext i8 [[TMP17]] to i32
// CHECK-NEXT:    [[SUB16:%.*]] = sub i32 [[CONV]], [[TMP14]]
// CHECK-NEXT:    [[CONV19:%.*]] = zext i32 [[SUB16]] to i64
// CHECK-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV19]], [[IDXPROM]]
// CHECK-NEXT:    [[SUB20:%.*]] = add nsw i64 [[MUL]], -1
...
// CHECK-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[TMP18]], align 8, !tbaa [[TBAA21:![0-9]+]], !freeze_bits [[META19]]
// CHECK-NEXT:    store ptr [[ARGC_ADDR]], ptr [[TMP19]], align 8, !tbaa [[TBAA24:![0-9]+]]
// CHECK-NEXT:    [[AGG_CAPTURED3_SROA_2_0__SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP19]], i64 8
// CHECK-NEXT:    store ptr [[ARGV_ADDR]], ptr [[AGG_CAPTURED3_SROA_2_0__SROA_IDX]], align 8, !tbaa [[TBAA26:![0-9]+]]
...
// CHECK-NEXT:    store i64 [[SUB20]], ptr [[TMP23]], align 8, !tbaa [[TBAA15]]
...
// CHECK-NEXT:    [[DOTNOT27:%.*]] = icmp eq i32 [[TMP26]], 0
// CHECK-NEXT:    br i1 [[DOTNOT27]], label %[[OMP_IF_END25:.*]], label %[[OMP_IF_THEN22:.*]]
// CHECK:       [[OMP_IF_THEN22]]:
...
// CHECK-NEXT:    call void @__kmpc_end_taskgroup(ptr nonnull @[[GLOB1]], i32 [[TMP0]])
// CHECK-NEXT:    call void @__kmpc_end_master(ptr nonnull @[[GLOB1]], i32 [[TMP0]])
// CHECK-NEXT:    br label %[[OMP_IF_END25]]
// CHECK:       [[OMP_IF_END25]]:
...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[TMP2]], align 8, !tbaa [[TBAA29:![0-9]+]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
// CHECK-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP4]], align 8, !tbaa [[TBAA30:![0-9]+]], !freeze_bits [[META19]]
...
// CHECK-NEXT:    tail call void @__kmpc_taskgroup(ptr nonnull @[[GLOB1]], i32 [[TMP0]])
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TMP3]], align 4, !tbaa [[TBAA3]], !freeze_bits [[META19]]
...
// CHECK-NEXT:    store i32 [[TMP4]], ptr [[TMP6]], align 8, !tbaa [[TBAA20]]
...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[TMP2]], align 8, !tbaa [[TBAA29]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
// CHECK-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP4]], align 8, !tbaa [[TBAA30]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[SEXT:%.*]] = shl i64 [[TMP3]], 32
// CHECK-NEXT:    [[TMP6:%.*]] = ashr exact i64 [[SEXT]], 32
// CHECK-NEXT:    br label %[[OMP_INNER_FOR_COND_I:.*]]
// CHECK:       [[OMP_INNER_FOR_COND_I]]:
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP1]], align 8, !tbaa [[TBAA21]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 40
// CHECK-NEXT:    [[TMP4:%.*]] = load i64, ptr [[TMP3]], align 8, !tbaa [[TBAA29]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
// CHECK-NEXT:    [[TMP6:%.*]] = load i64, ptr [[TMP5]], align 8, !tbaa [[TBAA30]], !freeze_bits [[META19]]
// CHECK-NEXT:    tail call void @llvm.experimental.noalias.scope.decl(metadata [[META31:![0-9]+]])
// CHECK-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[TMP2]], align 8, !tbaa [[TBAA34:![0-9]+]], !alias.scope [[META31]], !nonnull [[META19]], !align [[META36:![0-9]+]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[TMP7]], align 4, !tbaa [[TBAA3]], !noalias [[META31]], !freeze_bits [[META19]]
...
// CHECK-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP9]], align 8, !tbaa [[TBAA37:![0-9]+]], !alias.scope [[META31]], !nonnull [[META19]], !align [[META38:![0-9]+]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[TMP10]], align 8, !tbaa [[TBAA7]], !noalias [[META31]], !freeze_bits [[META19]]
...
// CHECK-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[ARRAYIDX_I]], align 8, !tbaa [[TBAA17]], !noalias [[META31]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[ARRAYIDX7_I:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP12]], i64 [[IDXPROM_I]]
// CHECK-NEXT:    [[TMP13:%.*]] = load i8, ptr [[ARRAYIDX7_I]], align 1, !tbaa [[TBAA20]], !noalias [[META31]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[CONV_I:%.*]] = sext i8 [[TMP13]] to i32
// CHECK-NEXT:    [[CMP18_I:%.*]] = icmp slt i32 [[TMP8]], [[CONV_I]]
// CHECK-NEXT:    br i1 [[CMP18_I]], label %[[OMP_INNER_FOR_COND_I:.*]], [[DOTOMP_OUTLINED__5_EXIT]]
// CHECK:       [[OMP_INNER_FOR_COND_I]]:
// CHECK-NEXT:    [[DOTOMP_IV_0_I:%.*]] = phi i64 [ [[ADD54_I:%.*]], %[[OMP_INNER_FOR_COND_I]] ], [ [[TMP4]], %[[LAND_LHS_TRUE_I]] ]
// CHECK-NEXT:    [[CMP24_NOT_I:%.*]] = icmp ugt i64 [[DOTOMP_IV_0_I]], [[TMP6]]
// CHECK-NEXT:    [[ADD54_I]] = add nsw i64 [[DOTOMP_IV_0_I]], 1
// CHECK-NEXT:    br i1 [[CMP24_NOT_I]], [[DOTOMP_OUTLINED__5_EXIT]], label %[[OMP_INNER_FOR_COND_I]]
...
// CHECK-NEXT:    [[TMP5:%.*]] = load i64, ptr [[TMP4]], align 8, !tbaa [[TBAA30]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[SEXT:%.*]] = shl i64 [[TMP3]], 32
// CHECK-NEXT:    [[CONV2_I2:%.*]] = ashr exact i64 [[SEXT]], 32
// CHECK-NEXT:    [[CMP_NOT_I3:%.*]] = icmp ult i64 [[TMP5]], [[CONV2_I2]]
// CHECK-NEXT:    br i1 [[CMP_NOT_I3]], [[DOTOMP_OUTLINED__7_EXIT:label %.*]], label %[[OMP_INNER_FOR_BODY_I:.*]]
// CHECK:       [[OMP_INNER_FOR_BODY_I]]:
// CHECK-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ [[INDVARS_IV_NEXT:%.*]], %[[DOTCANCEL_CONTINUE_I:.*]] ], [ [[CONV2_I2]], %[[ENTRY]] ]
...
// CHECK-NEXT:    [[DOTNOT13_I:%.*]] = icmp ne i32 [[TMP7]], 0
// CHECK-NEXT:    [[INDVARS_IV_NEXT]] = add nsw i64 [[INDVARS_IV]], 1
// CHECK-NEXT:    [[CMP_NOT_I:%.*]] = icmp ult i64 [[TMP5]], [[INDVARS_IV_NEXT]]
// CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[DOTNOT13_I]], i1 true, i1 [[CMP_NOT_I]]
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[OMP_IF_END:.*]], label %[[OMP_IF_THEN:.*]]
// CHECK:       [[OMP_IF_THEN]]:
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[THIS]], align 4, !tbaa [[TBAA39:![0-9]+]], !freeze_bits [[META19]]
// CHECK-NEXT:    tail call void @__kmpc_taskgroup(ptr nonnull @[[GLOB1]], i32 [[TMP0]])
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[C_ADDR]], align 4, !tbaa [[TBAA3]]
// CHECK-NEXT:    [[SUB5:%.*]] = add nsw i32 [[TMP3]], -1
...
// CHECK-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[TMP4]], align 8, !tbaa [[TBAA21]], !freeze_bits [[META19]]
// CHECK-NEXT:    store ptr [[THIS]], ptr [[TMP5]], align 8, !tbaa [[TBAA41:![0-9]+]]
// CHECK-NEXT:    [[AGG_CAPTURED_SROA_2_0__SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP5]], i64 8
// CHECK-NEXT:    store ptr [[C_ADDR]], ptr [[AGG_CAPTURED_SROA_2_0__SROA_IDX]], align 8, !tbaa [[TBAA24]]
...
// CHECK-NEXT:    [[CONV:%.*]] = sext i32 [[SUB5]] to i64
...
// CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP7]], align 8, !tbaa [[TBAA46:![0-9]+]], !alias.scope [[META43]], !nonnull [[META19]], !align [[META36]], !freeze_bits [[META19]]
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP8]], align 4, !tbaa [[TBAA3]], !noalias [[META43]], !freeze_bits [[META19]]
...
// CHECK-NEXT:    [[CMP12_NOT_I:%.*]] = icmp ult i64 [[TMP6]], [[INDVARS_IV]]
// CHECK-NEXT:    [[INDVARS_IV_NEXT]] = add nsw i64 [[INDVARS_IV]], 1
// CHECK-NEXT:    br i1 [[CMP12_NOT_I]], [[DOTOMP_OUTLINED__9_EXIT]], label %[[OMP_INNER_FOR_COND_I]]
...
// CHECK: [[TBAA21]] = !{[[META22:![0-9]+]], [[META10]], i64 0}
// CHECK: [[META22]] = !{!"_ZTS24kmp_task_t_with_privates", [[META23:![0-9]+]], i64 0}
// CHECK: [[META23]] = !{!"_ZTS10kmp_task_t", [[META10]], i64 0, [[META10]], i64 8, [[META4]], i64 16, [[META5]], i64 24, [[META5]], i64 32, [[META16]], i64 40, [[META16]], i64 48, [[META16]], i64 56, [[META4]], i64 64, [[META10]], i64 72}
// CHECK: [[TBAA24]] = !{[[META25:![0-9]+]], [[META25]], i64 0}
// CHECK: [[META25]] = !{!"p1 int", [[META10]], i64 0}
// CHECK: [[TBAA26]] = !{[[META27:![0-9]+]], [[META27]], i64 0}
// CHECK: [[META27]] = !{!"p3 omnipotent char", [[META28:![0-9]+]], i64 0}
// CHECK: [[META28]] = !{!"any p3 pointer", [[META9]], i64 0}
// CHECK: [[TBAA29]] = !{[[META22]], [[META16]], i64 40}
// CHECK: [[TBAA30]] = !{[[META22]], [[META16]], i64 48}
...
// CHECK: [[TBAA34]] = !{[[META35:![0-9]+]], [[META25]], i64 0}
// CHECK: [[META35]] = !{!"_ZTSZ4mainE3$_3", [[META25]], i64 0, [[META27]], i64 8}
// CHECK: [[META36]] = !{i64 4}
// CHECK: [[TBAA37]] = !{[[META35]], [[META27]], i64 8}
// CHECK: [[META38]] = !{i64 8}
// CHECK: [[TBAA39]] = !{[[META40:![0-9]+]], [[META4]], i64 0}
// CHECK: [[META40]] = !{!"_ZTS1S", [[META4]], i64 0}
// CHECK: [[TBAA41]] = !{[[META42:![0-9]+]], [[META42]], i64 0}
...
// CHECK: [[TBAA46]] = !{[[META47:![0-9]+]], [[META25]], i64 8}
// CHECK: [[META47]] = !{!"_ZTSZN1SC1EiEUt_", [[META42]], i64 0, [[META25]], i64 8}
//.
