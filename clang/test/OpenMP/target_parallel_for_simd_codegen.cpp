...
// CHECK1-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META26]], !freeze_bits [[FREEZE_BITS10]]
...
// CHECK3-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 4, !noalias [[META27]], !freeze_bits [[FREEZE_BITS11]]
...
// CHECK5-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META26]], !freeze_bits [[FREEZE_BITS10]]
...
// CHECK5-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 8, !nontemporal [[META40]], !llvm.access.group [[ACC_GRP39]], !freeze_bits [[FREEZE_BITS10]]
// CHECK5-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK5-NEXT:    store double [[INC]], ptr [[A4]], align 8, !nontemporal [[META40]], !llvm.access.group [[ACC_GRP39]]
...
// CHECK7-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 4, !noalias [[META27]], !freeze_bits [[FREEZE_BITS11]]
...
// CHECK7-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 4, !nontemporal [[META41]], !llvm.access.group [[ACC_GRP40]], !freeze_bits [[FREEZE_BITS11]]
// CHECK7-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK7-NEXT:    store double [[INC]], ptr [[A4]], align 4, !nontemporal [[META41]], !llvm.access.group [[ACC_GRP40]]
...
// CHECK13-NEXT:    store double [[ADD3]], ptr [[A]], align 8, !nontemporal [[META20:![0-9]+]], !llvm.access.group [[ACC_GRP19]]
// CHECK13-NEXT:    [[A4:%.*]] = getelementptr inbounds [[STRUCT_S1]], ptr [[THIS1]], i32 0, i32 0
// CHECK13-NEXT:    [[TMP12:%.*]] = load double, ptr [[A4]], align 8, !nontemporal [[META20]], !llvm.access.group [[ACC_GRP19]], !freeze_bits [[FREEZE_BITS2]]
// CHECK13-NEXT:    [[INC:%.*]] = fadd double [[TMP12]], 1.000000e+00
// CHECK13-NEXT:    store double [[INC]], ptr [[A4]], align 8, !nontemporal [[META20]], !llvm.access.group [[ACC_GRP19]]
...
// CHECK15-NEXT:    store double [[ADD3]], ptr [[A]], align 4, !nontemporal [[META21:![0-9]+]], !llvm.access.group [[ACC_GRP20]]
// CHECK15-NEXT:    [[A4:%.*]] = getelementptr inbounds [[STRUCT_S1]], ptr [[THIS1]], i32 0, i32 0
// CHECK15-NEXT:    [[TMP11:%.*]] = load double, ptr [[A4]], align 4, !nontemporal [[META21]], !llvm.access.group [[ACC_GRP20]], !freeze_bits [[FREEZE_BITS3]]
// CHECK15-NEXT:    [[INC:%.*]] = fadd double [[TMP11]], 1.000000e+00
// CHECK15-NEXT:    store double [[INC]], ptr [[A4]], align 4, !nontemporal [[META21]], !llvm.access.group [[ACC_GRP20]]
...
// CHECK21-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 8, !nontemporal [[META28]], !llvm.access.group [[ACC_GRP27]], !freeze_bits [[FREEZE_BITS11]]
// CHECK21-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK21-NEXT:    store double [[INC]], ptr [[A4]], align 8, !nontemporal [[META28]], !llvm.access.group [[ACC_GRP27]]
...
// CHECK23-NEXT:    [[TMP14:%.*]] = load double, ptr [[A4]], align 4, !nontemporal [[META29]], !llvm.access.group [[ACC_GRP28]], !freeze_bits [[FREEZE_BITS12]]
// CHECK23-NEXT:    [[INC:%.*]] = fadd double [[TMP14]], 1.000000e+00
// CHECK23-NEXT:    store double [[INC]], ptr [[A4]], align 4, !nontemporal [[META29]], !llvm.access.group [[ACC_GRP28]]
