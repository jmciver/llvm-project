...
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[A2]], align 4, !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[CONV:%.*]] = sitofp i32 [[TMP6]] to float
// CHECK-NEXT:    [[ADD:%.*]] = fadd float [[TMP5]], [[CONV]]
// CHECK-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[P]], align 8, !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[A3:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[TMP7]], i32 0, i32 0
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[A3]], align 4, !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[CONV4:%.*]] = sitofp i32 [[TMP8]] to float
// CHECK-NEXT:    [[ADD5:%.*]] = fadd float [[ADD]], [[CONV4]]
// CHECK-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[A_ADDR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[A22]], align 4, !llvm.access.group [[ACC_GRP7]], !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[C_ADDR]], align 8, !llvm.access.group [[ACC_GRP7]], !noundef [[NOUNDEF3]]
...
// CHECK: !3 = !{}
// CHECK: !4 = distinct !{!4, !5, !6}
// CHECK: !5 = !{!"llvm.loop.vectorize.enable", i1 true}
// CHECK: !6 = !{!"llvm.loop.vectorize.width", i32 3}
// CHECK: !7 = distinct !{}
// CHECK: !8 = distinct !{!8, !9, !5}
// CHECK: !9 = !{!"llvm.loop.parallel_accesses", !7}
//.
