...
// CHECK1-NEXT:    store ptr [[G7]], ptr [[TMP15]], align 8
...
// CHECK1-NEXT:    store ptr [[SVAR12]], ptr [[TMP18]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR14]], ptr [[TMP19]], align 8
...
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, ptr [[G7]], align 8
// CHECK1-NEXT:    store volatile double [[TMP23]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP27:%.*]] = load float, ptr [[SFVAR14]], align 4
...
// CHECK3-NEXT:    store double 1.000000e+00, ptr [[G7]], align 8
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
// CHECK3-NEXT:    store volatile double 1.000000e+00, ptr [[TMP14]], align 4
// CHECK3-NEXT:    store i32 3, ptr [[SVAR12]], align 4
// CHECK3-NEXT:    store float 4.000000e+00, ptr [[SFVAR14]], align 4
// CHECK3-NEXT:    [[TMP15:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK3-NEXT:    store ptr [[G7]], ptr [[TMP15]], align 4
// CHECK3-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
...
// CHECK3-NEXT:    store ptr [[SVAR12]], ptr [[TMP18]], align 4
// CHECK3-NEXT:    [[TMP19:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR14]], ptr [[TMP19]], align 4
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load double, ptr [[G7]], align 8
// CHECK3-NEXT:    store volatile double [[TMP23]], ptr [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK3-NEXT:    store i32 [[TMP26]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = load float, ptr [[SFVAR14]], align 4
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX18]], ptr align 4 [[TMP17]], i64 4, i1 false)
...
// CHECK9-NEXT:    [[TMP25:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN20]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN20]], [[TMP25]]
...
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, ptr [[SVAR13]], align 4
...
// CHECK9-NEXT:    [[TMP28:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN22]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR7]], align 4
...
// CHECK9-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP12]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP16]], i64 4, i1 false)
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK9:       .omp.lastprivate.then:
// CHECK9-NEXT:    [[TMP23:%.*]] = load i32, ptr [[T_VAR7]], align 4
...
// CHECK9-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN18]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN18]], [[TMP24]]
...
// CHECK9-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP12]], align 8, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP26:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN20]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK11-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR7]], align 4
...
// CHECK11-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP12]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP17]], i32 4, i1 false)
...
// CHECK11-NEXT:    [[TMP25:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN19]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN19]], [[TMP25]]
...
// CHECK11-NEXT:    [[TMP27:%.*]] = load i32, ptr [[SVAR13]], align 4
...
// CHECK11-NEXT:    [[TMP28:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN21]], i32 2
// CHECK11-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK11:       arraydestroy.body:
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR7]], align 4
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP16]], i32 4, i1 false)
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN17]], i32 2
...
// CHECK11-NEXT:    [[TMP26:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN19]], i32 2
// CHECK11-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK11:       arraydestroy.body:
