...
// CHECK1-NEXT:    [[TMP54:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    store i32 [[TMP57]], ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP60:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP64:%.*]] = load ptr, ptr [[TMP]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP77:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP92:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[_TMP24]], align 1, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP99]] to i32
// CHECK1-NEXT:    [[TMP100:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP106:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP107:%.*]] = load i32, ptr [[TMP106]], align 4, !noundef [[NOUNDEF3]]
