...
// CHECK1-NEXT:    [[_TMP25:%.*]] = alloca i8, align 1
...
// CHECK1-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[ARRAYIDX3]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP32:%.*]] = load ptr, ptr [[ARRAYIDX7]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP36:%.*]] = load ptr, ptr [[ARRAYIDX10]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP54:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    store i32 [[TMP57]], ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP58]], [[TMP59]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP60:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP64:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP77:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST13:%.*]] = phi ptr [ [[ARRAYIDX2]], [[DOTOMP_REDUCTION_CASE1]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT17:%.*]], [[OMP_ARRAYCPY_BODY]] ]
// CHECK1-NEXT:    [[TMP92:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST13]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP92]] to i32
// CHECK1-NEXT:    [[TMP93:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV14:%.*]] = sext i8 [[TMP93]] to i32
// CHECK1-NEXT:    [[ADD15:%.*]] = add nsw i32 [[CONV]], [[CONV14]]
// CHECK1-NEXT:    [[CONV16:%.*]] = trunc i32 [[ADD15]] to i8
// CHECK1-NEXT:    store i8 [[CONV16]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST13]], align 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT17]] = getelementptr i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST13]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT]] = getelementptr i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE18:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT17]], [[TMP91]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY20:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP96]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_ISEMPTY20]], label [[OMP_ARRAYCPY_DONE33:%.*]], label [[OMP_ARRAYCPY_BODY21:%.*]]
// CHECK1:       omp.arraycpy.body21:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRCELEMENTPAST22:%.*]] = phi ptr [ [[VLA]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_SRC_ELEMENT31:%.*]], [[ATOMIC_EXIT:%.*]] ]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST23:%.*]] = phi ptr [ [[ARRAYIDX2]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT30:%.*]], [[ATOMIC_EXIT]] ]
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST22]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV24:%.*]] = sext i8 [[TMP97]] to i32
// CHECK1-NEXT:    [[ATOMIC_LOAD:%.*]] = load atomic i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST23]] monotonic, align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP98:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY21]] ], [ [[TMP103:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP98]], ptr [[_TMP25]], align 1
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[_TMP25]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV26:%.*]] = sext i8 [[TMP99]] to i32
// CHECK1-NEXT:    [[TMP100:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST22]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV27:%.*]] = sext i8 [[TMP100]] to i32
// CHECK1-NEXT:    [[ADD28:%.*]] = add nsw i32 [[CONV26]], [[CONV27]]
// CHECK1-NEXT:    [[CONV29:%.*]] = trunc i32 [[ADD28]] to i8
// CHECK1-NEXT:    store i8 [[CONV29]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP101:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP102:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST23]], i8 [[TMP98]], i8 [[TMP101]] monotonic monotonic, align 1
...
// CHECK1:       atomic_exit:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT30]] = getelementptr i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST23]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT31]] = getelementptr i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST22]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE32:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT30]], [[TMP96]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE32]], label [[OMP_ARRAYCPY_DONE33]], label [[OMP_ARRAYCPY_BODY21]]
...
// CHECK1-NEXT:    [[TMP107:%.*]] = load i32, ptr [[TMP106]], align 4, !freeze_bits [[META3]]
