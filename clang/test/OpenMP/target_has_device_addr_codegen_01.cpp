...
// CHECK-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META5:![0-9]+]]
...
// CHECK-NEXT:    [[TMP42:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !freeze_bits [[META5]]
// CHECK-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP42]])
// CHECK-NEXT:    [[TMP43:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[REF]], align 8, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[VLA_ADDR]], align 8, !freeze_bits [[META5]]
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[VLA_ADDR2]], align 8
// CHECK-NEXT:    store ptr [[TMP1]], ptr [[TMP]], align 8
// CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[TMP0]], align 4, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[TMP6]], align 4, !freeze_bits [[META5]]
// CHECK-NEXT:    [[INC3:%.*]] = fadd float [[TMP7]], 1.000000e+00
// CHECK-NEXT:    store float [[INC3]], ptr [[TMP6]], align 4
// CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META5]]
// CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX6]], align 4, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 8, !freeze_bits [[META5]]
// CHECK-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP1]], 1
// CHECK-NEXT:    store i32 [[INC]], ptr [[A]], align 8
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[TMP0]], i32 0, i32 1
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[PTR]], align 8, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[REF]], align 8, !freeze_bits [[META5]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[ARRAYIDX]], align 8, !freeze_bits [[META5]]
...
// SIMD-ONLY0-NEXT:    [[TMP7:%.*]] = load float, ptr [[TMP6]], align 4, !freeze_bits [[META2:![0-9]+]]
// SIMD-ONLY0-NEXT:    [[INC3:%.*]] = fadd float [[TMP7]], 1.000000e+00
// SIMD-ONLY0-NEXT:    store float [[INC3]], ptr [[TMP6]], align 4
// SIMD-ONLY0-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META2]]
...
// SIMD-ONLY0-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[REF]], align 8, !freeze_bits [[META2]]
