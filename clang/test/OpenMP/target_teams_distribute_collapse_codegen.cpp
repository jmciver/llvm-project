...
// CHECK9-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_4]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP22:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !noundef [[NOUNDEF5]]
// CHECK9-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_4]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP25:%.*]] = load i32, ptr [[I11]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, ptr [[J12]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP28:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !noundef [[NOUNDEF5]]
...
// CHECK11-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_4]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP22:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !noundef [[NOUNDEF6]]
// CHECK11-NEXT:    [[TMP23:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_4]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP25:%.*]] = load i32, ptr [[I11]], align 4, !noundef [[NOUNDEF6]]
// CHECK11-NEXT:    [[TMP26:%.*]] = mul nsw i32 [[TMP25]], [[TMP1]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[TMP2]], i32 [[TMP26]]
// CHECK11-NEXT:    [[TMP27:%.*]] = load i32, ptr [[J12]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP28:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !noundef [[NOUNDEF6]]
