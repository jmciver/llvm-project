...
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], ptr [[AGG_CAPTURED2]], i32 0, i32 0
...
// CHECK:       omp_loop.body:
// CHECK-NEXT:    call void @__captured_stmt.1(ptr [[I]], i32 [[OMP_LOOP_IV]], ptr [[AGG_CAPTURED2]]), !llvm.access.group [[ACC_GRP4:![0-9]+]]
...
// CHECK-NEXT:    [[A3:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[S]], i32 0, i32 0
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[A3]], align 4, !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META3]]
// CHECK-NEXT:    [[CONV:%.*]] = sitofp i32 [[TMP6]] to float
// CHECK-NEXT:    [[ADD:%.*]] = fadd float [[TMP5]], [[CONV]]
// CHECK-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[P]], align 8, !llvm.access.group [[ACC_GRP4]]
// CHECK-NEXT:    [[A4:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[TMP7]], i32 0, i32 0
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[A4]], align 4, !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META3]]
...
// CHECK-NEXT:    store float [[ADD6]], ptr [[ARRAYIDX8]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [[STRUCT_ANON_1]], ptr [[AGG_CAPTURED10]], i32 0, i32 0
// CHECK-NEXT:    store ptr [[J]], ptr [[TMP11]], align 8
// CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], ptr [[AGG_CAPTURED11]], i32 0, i32 0
...
// CHECK-NEXT:    call void @__captured_stmt.3(ptr [[J]], i32 [[OMP_LOOP_IV21]], ptr [[AGG_CAPTURED11]]), !llvm.access.group [[ACC_GRP9:![0-9]+]]
// CHECK-NEXT:    [[A24:%.*]] = getelementptr inbounds [[STRUCT_P]], ptr [[PP]], i32 0, i32 0
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[A24]], align 4, !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META3]]
...
// CHECK-NEXT:    store i32 [[TMP14]], ptr [[ARRAYIDX26]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK-NEXT:    br label [[OMP_LOOP_INC18]]
// CHECK:       omp_loop.inc18:
// CHECK-NEXT:    [[OMP_LOOP_NEXT23]] = add nuw i32 [[OMP_LOOP_IV21]], 1
// CHECK-NEXT:    br label [[OMP_LOOP_HEADER15]], !llvm.loop [[LOOP10:![0-9]+]]
