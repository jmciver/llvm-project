...
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double 1.000000e+00, ptr [[TMP14]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    store i32 3, ptr [[SVAR12]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    store float 4.000000e+00, ptr [[SFVAR14]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    store ptr [[SVAR12]], ptr [[TMP18]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR14]], ptr [[TMP19]], align 8, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    store i32 [[ADD18]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double 1.000000e+00, ptr [[TMP14]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    store i32 3, ptr [[SVAR12]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    store float 4.000000e+00, ptr [[SFVAR14]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR12]], ptr [[TMP18]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR14]], ptr [[TMP19]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    store i32 [[ADD18]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META5]]
