...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr [[G7]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[ADD15:%.*]] = fadd double [[TMP18]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD15]], ptr [[G7]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store volatile double [[ADD16]], ptr [[TMP19]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR10]], align 4
// CHECK1-NEXT:    [[ADD17:%.*]] = add nsw i32 [[TMP21]], 3
// CHECK1-NEXT:    store i32 [[ADD17]], ptr [[SVAR10]], align 4
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR12]], align 4, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store float [[CONV19]], ptr [[SFVAR12]], align 4
...
// CHECK1-NEXT:    store ptr [[SVAR10]], ptr [[TMP26]], align 8
// CHECK1-NEXT:    [[TMP27:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR12]], ptr [[TMP27]], align 8
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load double, ptr [[G7]], align 8, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[ADD15:%.*]] = fadd double [[TMP18]], 1.000000e+00
// CHECK3-NEXT:    store double [[ADD15]], ptr [[G7]], align 8
...
// CHECK3-NEXT:    store volatile double [[ADD16]], ptr [[TMP19]], align 4
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR10]], align 4
// CHECK3-NEXT:    [[ADD17:%.*]] = add nsw i32 [[TMP21]], 3
// CHECK3-NEXT:    store i32 [[ADD17]], ptr [[SVAR10]], align 4
// CHECK3-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR12]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store float [[CONV19]], ptr [[SFVAR12]], align 4
...
// CHECK3-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP9]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR10]], ptr [[TMP26]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR12]], ptr [[TMP27]], align 4
