...
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load volatile double, ptr [[TMP19]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[_TMP13]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP13]], align 8, !freeze_bits [[META5]]
// CHECK9-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I]], align 4
...
// CHECK11-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[_TMP13]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP13]], align 4, !freeze_bits [[META6]]
// CHECK11-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I]], align 4
