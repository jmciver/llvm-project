...
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load double, ptr [[TMP21]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP12]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP12]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP12]], align 8, !freeze_bits [[META5]]
...
// CHECK11-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP12]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP12]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP12]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP12]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
