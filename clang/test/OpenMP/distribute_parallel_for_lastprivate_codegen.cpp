...
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l68.omp_outlined.omp_outlined, i64 [[TMP14]], i64 [[TMP16]], ptr [[G7]], ptr [[TMP17]], ptr [[SVAR10]], ptr [[SFVAR12]])
...
// CHECK1-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store ptr [[SVAR10]], ptr [[TMP19]], align 8
// CHECK1-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR12]], ptr [[TMP20]], align 8
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP9]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l68.omp_outlined.omp_outlined, i32 [[TMP13]], i32 [[TMP14]], ptr [[G7]], ptr [[TMP15]], ptr [[SVAR10]], ptr [[SFVAR12]])
...
// CHECK3-NEXT:    [[TMP20:%.*]] = load double, ptr [[G7]], align 8, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP20]], ptr [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP9]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR10]], align 4
// CHECK3-NEXT:    store i32 [[TMP23]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR12]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR9]], ptr [[TMP19]], align 4
// CHECK3-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR11]], ptr [[TMP20]], align 4
