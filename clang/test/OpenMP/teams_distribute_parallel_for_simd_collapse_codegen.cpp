...
// CHECK9-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_COMB_LB]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK9-NEXT:    [[TMP22:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK9-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l86.omp_outlined.omp_outlined, i64 [[TMP21]], i64 [[TMP22]], ptr [[TMP0]], ptr [[TMP1]], i64 [[TMP2]], i64 [[TMP3]], ptr [[TMP4]]), !llvm.access.group [[ACC_GRP9]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP9]]
// CHECK9-NEXT:    [[TMP24:%.*]] = load i64, ptr [[DOTOMP_STRIDE]], align 8, !llvm.access.group [[ACC_GRP9]]
...
// CHECK9-NEXT:    [[TMP26:%.*]] = load i32, ptr [[TMP25]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[SUB26:%.*]] = sub nsw i32 [[TMP29]], 0
...
// CHECK9-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4
// CHECK9-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[TMP30]], 0
...
// CHECK9-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_7]], align 8
// CHECK9-NEXT:    [[CMP24:%.*]] = icmp sgt i64 [[TMP16]], [[TMP17]]
// CHECK9-NEXT:    br i1 [[CMP24]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK9:       cond.true:
// CHECK9-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_7]], align 8
// CHECK9-NEXT:    br label [[COND_END:%.*]]
// CHECK9:       cond.false:
...
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK9:       omp.inner.for.cond:
// CHECK9-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP13:![0-9]+]]
// CHECK9-NEXT:    [[TMP22:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[CMP25:%.*]] = icmp sle i64 [[TMP21]], [[TMP22]]
// CHECK9-NEXT:    br i1 [[CMP25]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK9:       omp.inner.for.body:
// CHECK9-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[SUB26:%.*]] = sub nsw i32 [[TMP24]], 0
// CHECK9-NEXT:    [[DIV27:%.*]] = sdiv i32 [[SUB26]], 1
// CHECK9-NEXT:    [[MUL28:%.*]] = mul nsw i32 1, [[DIV27]]
// CHECK9-NEXT:    [[CONV29:%.*]] = sext i32 [[MUL28]] to i64
// CHECK9-NEXT:    [[DIV30:%.*]] = sdiv i64 [[TMP23]], [[CONV29]]
...
// CHECK9-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[TMP26:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[SUB33:%.*]] = sub nsw i32 [[TMP27]], 0
// CHECK9-NEXT:    [[DIV34:%.*]] = sdiv i32 [[SUB33]], 1
// CHECK9-NEXT:    [[MUL35:%.*]] = mul nsw i32 1, [[DIV34]]
// CHECK9-NEXT:    [[CONV36:%.*]] = sext i32 [[MUL35]] to i64
// CHECK9-NEXT:    [[DIV37:%.*]] = sdiv i64 [[TMP26]], [[CONV36]]
// CHECK9-NEXT:    [[TMP28:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[SUB38:%.*]] = sub nsw i32 [[TMP28]], 0
...
// CHECK9-NEXT:    [[SUB43:%.*]] = sub nsw i64 [[TMP25]], [[MUL42]]
...
// CHECK9-NEXT:    [[TMP29:%.*]] = load i32, ptr [[I20]], align 4, !llvm.access.group [[ACC_GRP13]]
...
// CHECK9-NEXT:    [[TMP31:%.*]] = load i32, ptr [[J22]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[IDXPROM47:%.*]] = sext i32 [[TMP31]] to i64
...
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP13]]
// CHECK9-NEXT:    [[ADD49:%.*]] = add nsw i64 [[TMP32]], 1
...
// CHECK9-NEXT:    [[TMP34:%.*]] = load i32, ptr [[TMP33]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[SUB50:%.*]] = sub nsw i32 [[TMP37]], 0
...
// CHECK9-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4
// CHECK9-NEXT:    [[SUB54:%.*]] = sub nsw i32 [[TMP38]], 0
...
// CHECK9-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 3, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiLi10ELi2EEiT__l72.omp_outlined.omp_outlined, i64 [[TMP9]], i64 [[TMP11]], ptr [[TMP0]]), !llvm.access.group [[ACC_GRP18]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP20:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !llvm.access.group [[ACC_GRP10]]
...
// CHECK11-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_COMB_LB]], align 8, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[TMP22:%.*]] = trunc i64 [[TMP21]] to i32
// CHECK11-NEXT:    [[TMP23:%.*]] = load i64, ptr [[DOTOMP_COMB_UB]], align 8, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[TMP24:%.*]] = trunc i64 [[TMP23]] to i32
// CHECK11-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l86.omp_outlined.omp_outlined, i32 [[TMP22]], i32 [[TMP24]], ptr [[TMP0]], ptr [[TMP1]], i32 [[TMP2]], i32 [[TMP3]], ptr [[TMP4]]), !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[TMP26:%.*]] = load i64, ptr [[DOTOMP_STRIDE]], align 8, !llvm.access.group [[ACC_GRP10]]
...
// CHECK11-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP27]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[SUB26:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK11-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4
// CHECK11-NEXT:    [[SUB30:%.*]] = sub nsw i32 [[TMP32]], 0
...
// CHECK11-NEXT:    [[CONV18:%.*]] = zext i32 [[TMP12]] to i64
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTPREVIOUS_UB__ADDR]], align 4
// CHECK11-NEXT:    [[CONV19:%.*]] = zext i32 [[TMP13]] to i64
...
// CHECK11-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_7]], align 8
// CHECK11-NEXT:    [[CMP26:%.*]] = icmp sgt i64 [[TMP16]], [[TMP17]]
// CHECK11-NEXT:    br i1 [[CMP26]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK11:       cond.true:
// CHECK11-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTCAPTURE_EXPR_7]], align 8
// CHECK11-NEXT:    br label [[COND_END:%.*]]
// CHECK11:       cond.false:
...
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK11:       omp.inner.for.cond:
// CHECK11-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP14:![0-9]+]]
// CHECK11-NEXT:    [[TMP22:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[CMP27:%.*]] = icmp sle i64 [[TMP21]], [[TMP22]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[SUB28:%.*]] = sub nsw i32 [[TMP24]], 0
// CHECK11-NEXT:    [[DIV29:%.*]] = sdiv i32 [[SUB28]], 1
// CHECK11-NEXT:    [[MUL30:%.*]] = mul nsw i32 1, [[DIV29]]
// CHECK11-NEXT:    [[CONV31:%.*]] = sext i32 [[MUL30]] to i64
// CHECK11-NEXT:    [[DIV32:%.*]] = sdiv i64 [[TMP23]], [[CONV31]]
...
// CHECK11-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[TMP26:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[TMP27:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[SUB35:%.*]] = sub nsw i32 [[TMP27]], 0
// CHECK11-NEXT:    [[DIV36:%.*]] = sdiv i32 [[SUB35]], 1
// CHECK11-NEXT:    [[MUL37:%.*]] = mul nsw i32 1, [[DIV36]]
// CHECK11-NEXT:    [[CONV38:%.*]] = sext i32 [[MUL37]] to i64
// CHECK11-NEXT:    [[DIV39:%.*]] = sdiv i64 [[TMP26]], [[CONV38]]
// CHECK11-NEXT:    [[TMP28:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[SUB40:%.*]] = sub nsw i32 [[TMP28]], 0
...
// CHECK11-NEXT:    [[SUB45:%.*]] = sub nsw i64 [[TMP25]], [[MUL44]]
...
// CHECK11-NEXT:    [[TMP29:%.*]] = load i32, ptr [[I22]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[TMP30:%.*]] = mul nsw i32 [[TMP29]], [[TMP3]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[TMP4]], i32 [[TMP30]]
// CHECK11-NEXT:    [[TMP31:%.*]] = load i32, ptr [[J24]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[ARRAYIDX49:%.*]] = getelementptr inbounds i32, ptr [[ARRAYIDX]], i32 [[TMP31]]
// CHECK11-NEXT:    store i32 0, ptr [[ARRAYIDX49]], align 4, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !llvm.access.group [[ACC_GRP14]]
// CHECK11-NEXT:    [[ADD50:%.*]] = add nsw i64 [[TMP32]], 1
...
// CHECK11-NEXT:    [[TMP34:%.*]] = load i32, ptr [[TMP33]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[SUB51:%.*]] = sub nsw i32 [[TMP37]], 0
...
// CHECK11-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_5]], align 4
// CHECK11-NEXT:    [[SUB55:%.*]] = sub nsw i32 [[TMP38]], 0
...
// CHECK11-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 3, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiLi10ELi2EEiT__l72.omp_outlined.omp_outlined, i32 [[TMP8]], i32 [[TMP9]], ptr [[TMP0]]), !llvm.access.group [[ACC_GRP19]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
