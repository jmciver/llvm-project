...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    [[ADD15:%.*]] = fadd double [[TMP18]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD15]], ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP9]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load volatile double, ptr [[TMP19]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    [[ADD16:%.*]] = fadd double [[TMP20]], 1.000000e+00
// CHECK1-NEXT:    store volatile double [[ADD16]], ptr [[TMP19]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR10]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[ADD17:%.*]] = add nsw i32 [[TMP21]], 3
// CHECK1-NEXT:    store i32 [[ADD17]], ptr [[SVAR10]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR12]], align 4, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    [[CONV:%.*]] = fpext float [[TMP22]] to double
// CHECK1-NEXT:    [[ADD18:%.*]] = fadd double [[CONV]], 4.000000e+00
// CHECK1-NEXT:    [[CONV19:%.*]] = fptrunc double [[ADD18]] to float
// CHECK1-NEXT:    store float [[CONV19]], ptr [[SFVAR12]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP9]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store ptr [[SVAR10]], ptr [[TMP26]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[TMP27:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR12]], ptr [[TMP27]], align 8, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i32 [[TMP28]], 1
// CHECK1-NEXT:    store i32 [[ADD20]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load double, ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
// CHECK3-NEXT:    [[ADD15:%.*]] = fadd double [[TMP18]], 1.000000e+00
// CHECK3-NEXT:    store double [[ADD15]], ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[ADD16:%.*]] = fadd double [[TMP20]], 1.000000e+00
// CHECK3-NEXT:    store volatile double [[ADD16]], ptr [[TMP19]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR10]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    [[ADD17:%.*]] = add nsw i32 [[TMP21]], 3
// CHECK3-NEXT:    store i32 [[ADD17]], ptr [[SVAR10]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR12]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
// CHECK3-NEXT:    [[CONV:%.*]] = fpext float [[TMP22]] to double
// CHECK3-NEXT:    [[ADD18:%.*]] = fadd double [[CONV]], 4.000000e+00
// CHECK3-NEXT:    [[CONV19:%.*]] = fptrunc double [[ADD18]] to float
// CHECK3-NEXT:    store float [[CONV19]], ptr [[SFVAR12]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP9]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR10]], ptr [[TMP26]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    [[TMP27:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR12]], ptr [[TMP27]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[ADD20:%.*]] = add nsw i32 [[TMP28]], 1
// CHECK3-NEXT:    store i32 [[ADD20]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP2]], align 8, !llvm.access.group [[ACC_GRP3]], !freeze_bits [[META2]]
// CHECK13-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP3]]
// CHECK13-NEXT:    [[IDXPROM8:%.*]] = sext i32 [[TMP11]] to i64
// CHECK13-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR]], i64 0, i64 [[IDXPROM8]]
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP2]], align 8, !llvm.access.group [[ACC_GRP7]], !freeze_bits [[META2]]
// CHECK13-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK13-NEXT:    [[IDXPROM8:%.*]] = sext i32 [[TMP11]] to i64
// CHECK13-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR]], i64 0, i64 [[IDXPROM8]]
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP2]], align 4, !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META3]]
// CHECK15-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP4]]
// CHECK15-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR]], i32 0, i32 [[TMP11]]
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP2]], align 4, !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META3]]
// CHECK15-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK15-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR]], i32 0, i32 [[TMP11]]
