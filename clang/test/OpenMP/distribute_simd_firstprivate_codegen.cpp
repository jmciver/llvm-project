...
// CHECK1-NEXT:    [[TMP5:%.*]] = load volatile double, ptr [[TMP0]], align 8, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP7:%.*]] = load volatile double, ptr [[TMP6]], align 8, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[ADD18:%.*]] = fadd double [[TMP18]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD18]], ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META5]], !align [[META6]], !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load volatile double, ptr [[TMP19]], align 8, !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META5]]
// CHECK1-NEXT:    [[ADD19:%.*]] = fadd double [[TMP20]], 1.000000e+00
// CHECK1-NEXT:    store volatile double [[ADD19]], ptr [[TMP19]], align 8, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR12]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i32 [[TMP21]], 3
// CHECK1-NEXT:    store i32 [[ADD20]], ptr [[SVAR12]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR14]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[CONV:%.*]] = fpext float [[TMP22]] to double
// CHECK1-NEXT:    [[ADD21:%.*]] = fadd double [[CONV]], 4.000000e+00
// CHECK1-NEXT:    [[CONV22:%.*]] = fptrunc double [[ADD21]] to float
// CHECK1-NEXT:    store float [[CONV22]], ptr [[SFVAR14]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK1-NEXT:    store ptr [[G7]], ptr [[TMP23]], align 8, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META5]], !align [[META6]], !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META5]]
...
// CHECK1-NEXT:    store ptr [[SVAR12]], ptr [[TMP26]], align 8, !llvm.access.group [[ACC_GRP8]]
// CHECK1-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR14]], ptr [[TMP27]], align 8, !llvm.access.group [[ACC_GRP8]]
...
// CHECK1-NEXT:    [[ADD23:%.*]] = add nsw i32 [[TMP28]], 1
// CHECK1-NEXT:    store i32 [[ADD23]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK3-NEXT:    [[TMP5:%.*]] = load volatile double, ptr [[TMP0]], align 8, !freeze_bits [[META6]]
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load volatile double, ptr [[TMP6]], align 4, !freeze_bits [[META6]]
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load double, ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[ADD18:%.*]] = fadd double [[TMP18]], 1.000000e+00
// CHECK3-NEXT:    store double [[ADD18]], ptr [[G7]], align 8, !llvm.access.group [[ACC_GRP8]]
...
// CHECK3-NEXT:    [[ADD19:%.*]] = fadd double [[TMP20]], 1.000000e+00
// CHECK3-NEXT:    store volatile double [[ADD19]], ptr [[TMP19]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR12]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[ADD20:%.*]] = add nsw i32 [[TMP21]], 3
// CHECK3-NEXT:    store i32 [[ADD20]], ptr [[SVAR12]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR14]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[CONV:%.*]] = fpext float [[TMP22]] to double
// CHECK3-NEXT:    [[ADD21:%.*]] = fadd double [[CONV]], 4.000000e+00
// CHECK3-NEXT:    [[CONV22:%.*]] = fptrunc double [[ADD21]] to float
// CHECK3-NEXT:    store float [[CONV22]], ptr [[SFVAR14]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[TMP23:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK3-NEXT:    store ptr [[G7]], ptr [[TMP23]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[TMP24:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META6]], !align [[META7]], !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META6]]
...
// CHECK3-NEXT:    store ptr [[SVAR12]], ptr [[TMP26]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[TMP27:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR14]], ptr [[TMP27]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK3-NEXT:    [[ADD23:%.*]] = add nsw i32 [[TMP28]], 1
// CHECK3-NEXT:    store i32 [[ADD23]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK9-NEXT:    [[VAR12:%.*]] = alloca [[STRUCT_S:%.*]], align 4
// CHECK9-NEXT:    [[_TMP13:%.*]] = alloca ptr, align 8
// CHECK9-NEXT:    [[SVAR14:%.*]] = alloca i32, align 4
...
// CHECK9-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META7]]
// CHECK9-NEXT:    store i32 [[TMP6]], ptr [[T_VAR7]], align 4
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[VEC9]], ptr align 4 [[TMP1]], i64 8, i1 false)
...
// CHECK9-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP1]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[VAR12]], ptr align 4 [[TMP8]], i64 4, i1 false)
// CHECK9-NEXT:    store ptr [[VAR12]], ptr [[_TMP13]], align 8
// CHECK9-NEXT:    [[FREEZE_POISON15:%.*]] = freeze i32 poison
// CHECK9-NEXT:    store i32 [[FREEZE_POISON15]], ptr [[SVAR14]], align 4
// CHECK9-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP4]], align 4, !freeze_bits [[META7]]
// CHECK9-NEXT:    store i32 [[TMP9]], ptr [[SVAR14]], align 4
// CHECK9-NEXT:    [[FREEZE_POISON16:%.*]] = freeze i32 poison
// CHECK9-NEXT:    store i32 [[FREEZE_POISON16]], ptr [[I]], align 4
...
// CHECK9-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK9-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_COND_CLEANUP:%.*]]
...
// CHECK9-NEXT:    [[TMP18:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK9-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[_TMP13]], align 8, !nonnull [[META7]], !align [[META8]], !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META7]]
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK9-NEXT:    [[IDXPROM18:%.*]] = sext i32 [[TMP21]] to i64
// CHECK9-NEXT:    [[ARRAYIDX19:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR10]], i64 0, i64 [[IDXPROM18]]
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX19]], ptr align 4 [[TMP20]], i64 4, i1 false), !llvm.access.group [[ACC_GRP9]]
...
// CHECK9-NEXT:    store i32 [[ADD20]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK9-NEXT:    call void @_ZN1SIfED1Ev(ptr noundef nonnull align 4 dereferenceable(4) [[VAR12]]) #[[ATTR4]]
// CHECK9-NEXT:    [[ARRAY_BEGIN21:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR10]], i32 0, i32 0
...
// CHECK9-NEXT:    [[VAR12:%.*]] = alloca [[STRUCT_S_0:%.*]], align 4
// CHECK9-NEXT:    [[_TMP13:%.*]] = alloca ptr, align 8
// CHECK9-NEXT:    [[I:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK9-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK9-NEXT:    store i32 [[TMP5]], ptr [[T_VAR7]], align 4
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[VEC9]], ptr align 4 [[TMP1]], i64 8, i1 false)
...
// CHECK9-NEXT:    br i1 [[OMP_ARRAYCPY_DONE]], label [[OMP_ARRAYCPY_DONE11]], label [[OMP_ARRAYCPY_BODY]]
// CHECK9:       omp.arraycpy.done11:
// CHECK9-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[_TMP1]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[VAR12]], ptr align 4 [[TMP7]], i64 4, i1 false)
// CHECK9-NEXT:    store ptr [[VAR12]], ptr [[_TMP13]], align 8
...
// CHECK9-NEXT:    [[CMP15:%.*]] = icmp sle i32 [[TMP13]], [[TMP14]]
...
// CHECK9-NEXT:    [[TMP16:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP15]]
...
// CHECK9-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP13]], align 8, !nonnull [[META7]], !align [[META8]], !llvm.access.group [[ACC_GRP15]], !freeze_bits [[META7]]
// CHECK9-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[IDXPROM16:%.*]] = sext i32 [[TMP19]] to i64
// CHECK9-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR10]], i64 0, i64 [[IDXPROM16]]
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP18]], i64 4, i1 false), !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[ADD18:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK9-NEXT:    store i32 [[ADD18]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP15]]
...
// CHECK9-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK9:       .omp.final.done:
// CHECK9-NEXT:    call void @_ZN1SIiED1Ev(ptr noundef nonnull align 4 dereferenceable(4) [[VAR12]]) #[[ATTR4]]
// CHECK9-NEXT:    [[ARRAY_BEGIN19:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR10]], i32 0, i32 0
// CHECK9-NEXT:    [[TMP25:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN19]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK11-NEXT:    [[VAR12:%.*]] = alloca [[STRUCT_S:%.*]], align 4
// CHECK11-NEXT:    [[_TMP13:%.*]] = alloca ptr, align 4
// CHECK11-NEXT:    [[SVAR14:%.*]] = alloca i32, align 4
...
// CHECK11-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META8]]
// CHECK11-NEXT:    store i32 [[TMP6]], ptr [[T_VAR7]], align 4
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[VEC9]], ptr align 4 [[TMP1]], i32 8, i1 false)
...
// CHECK11-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP1]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[VAR12]], ptr align 4 [[TMP8]], i32 4, i1 false)
// CHECK11-NEXT:    store ptr [[VAR12]], ptr [[_TMP13]], align 4
// CHECK11-NEXT:    [[FREEZE_POISON15:%.*]] = freeze i32 poison
// CHECK11-NEXT:    store i32 [[FREEZE_POISON15]], ptr [[SVAR14]], align 4
// CHECK11-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP4]], align 4, !freeze_bits [[META8]]
// CHECK11-NEXT:    store i32 [[TMP9]], ptr [[SVAR14]], align 4
// CHECK11-NEXT:    [[FREEZE_POISON16:%.*]] = freeze i32 poison
// CHECK11-NEXT:    store i32 [[FREEZE_POISON16]], ptr [[I]], align 4
...
// CHECK11-NEXT:    [[CMP17:%.*]] = icmp sle i32 [[TMP15]], [[TMP16]]
// CHECK11-NEXT:    br i1 [[CMP17]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_COND_CLEANUP:%.*]]
...
// CHECK11-NEXT:    [[TMP18:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC9]], i32 0, i32 [[TMP19]]
// CHECK11-NEXT:    store i32 [[TMP18]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[_TMP13]], align 4, !nonnull [[META8]], !align [[META9]], !llvm.access.group [[ACC_GRP10]], !freeze_bits [[META8]]
// CHECK11-NEXT:    [[TMP21:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP10]]
// CHECK11-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR10]], i32 0, i32 [[TMP21]]
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX18]], ptr align 4 [[TMP20]], i32 4, i1 false), !llvm.access.group [[ACC_GRP10]]
...
// CHECK11-NEXT:    store i32 [[ADD19]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP10]]
...
// CHECK11-NEXT:    call void @_ZN1SIfED1Ev(ptr noundef nonnull align 4 dereferenceable(4) [[VAR12]]) #[[ATTR4]]
// CHECK11-NEXT:    [[ARRAY_BEGIN20:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR10]], i32 0, i32 0
...
// CHECK11-NEXT:    [[VAR12:%.*]] = alloca [[STRUCT_S_0:%.*]], align 4
// CHECK11-NEXT:    [[_TMP13:%.*]] = alloca ptr, align 4
// CHECK11-NEXT:    [[I:%.*]] = alloca i32, align 4
// CHECK11-NEXT:    store ptr [[DOTGLOBAL_TID_]], ptr [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK11-NEXT:    store ptr [[DOTBOUND_TID_]], ptr [[DOTBOUND_TID__ADDR]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP5]], ptr [[T_VAR7]], align 4
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[VEC9]], ptr align 4 [[TMP1]], i32 8, i1 false)
...
// CHECK11-NEXT:    br i1 [[OMP_ARRAYCPY_DONE]], label [[OMP_ARRAYCPY_DONE11]], label [[OMP_ARRAYCPY_BODY]]
// CHECK11:       omp.arraycpy.done11:
// CHECK11-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[_TMP1]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[VAR12]], ptr align 4 [[TMP7]], i32 4, i1 false)
// CHECK11-NEXT:    store ptr [[VAR12]], ptr [[_TMP13]], align 4
...
// CHECK11-NEXT:    [[TMP16:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP17:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC9]], i32 0, i32 [[TMP17]]
// CHECK11-NEXT:    store i32 [[TMP16]], ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP13]], align 4, !nonnull [[META8]], !align [[META9]], !llvm.access.group [[ACC_GRP16]], !freeze_bits [[META8]]
// CHECK11-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[ARRAYIDX16:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR10]], i32 0, i32 [[TMP19]]
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP18]], i32 4, i1 false), !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
...
// CHECK11-NEXT:    store i32 [[ADD17]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP16]]
...
// CHECK11-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK11:       .omp.final.done:
// CHECK11-NEXT:    call void @_ZN1SIiED1Ev(ptr noundef nonnull align 4 dereferenceable(4) [[VAR12]]) #[[ATTR4]]
// CHECK11-NEXT:    [[ARRAY_BEGIN18:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR10]], i32 0, i32 0
// CHECK11-NEXT:    [[TMP25:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN18]], i32 2
// CHECK11-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK11:       arraydestroy.body:
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP5]], align 8, !nonnull [[META2]], !align [[META3]], !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META2]]
// CHECK13-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP4]]
// CHECK13-NEXT:    [[IDXPROM11:%.*]] = sext i32 [[TMP11]] to i64
// CHECK13-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR]], i64 0, i64 [[IDXPROM11]]
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX12]], ptr align 4 [[TMP10]], i64 4, i1 false), !llvm.access.group [[ACC_GRP4]]
...
// CHECK13-NEXT:    store i32 [[ADD13]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK13-NEXT:    [[TMP14:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP3]], align 8, !nonnull [[META2]], !align [[META3]], !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META2]]
// CHECK13-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK13-NEXT:    [[IDXPROM9:%.*]] = sext i32 [[TMP11]] to i64
// CHECK13-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR]], i64 0, i64 [[IDXPROM9]]
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX10]], ptr align 4 [[TMP10]], i64 4, i1 false), !llvm.access.group [[ACC_GRP8]]
// CHECK13-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK13:       omp.body.continue:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK13:       omp.inner.for.inc:
// CHECK13-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK13-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP12]], 1
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP5]], align 4, !nonnull [[META3]], !align [[META4]], !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META3]]
// CHECK15-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK15-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR]], i32 0, i32 [[TMP11]]
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX11]], ptr align 4 [[TMP10]], i32 4, i1 false), !llvm.access.group [[ACC_GRP5]]
...
// CHECK15-NEXT:    store i32 [[ADD12]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK15-NEXT:    [[TMP14:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP3]], align 4, !nonnull [[META3]], !align [[META4]], !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META3]]
// CHECK15-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK15-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [2 x %struct.S.0], ptr [[S_ARR]], i32 0, i32 [[TMP11]]
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX9]], ptr align 4 [[TMP10]], i32 4, i1 false), !llvm.access.group [[ACC_GRP9]]
// CHECK15-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK15:       omp.body.continue:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK15:       omp.inner.for.inc:
// CHECK15-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP9]]
// CHECK15-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP12]], 1
