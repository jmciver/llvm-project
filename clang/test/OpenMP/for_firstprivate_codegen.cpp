...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP14]], align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[BLOCK_CAPTURED13:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, ptr, i32, i32 }>, ptr [[BLOCK]], i32 0, i32 5
// CHECK4-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META3]]
// CHECK4-NEXT:    store ptr [[TMP15]], ptr [[BLOCK_CAPTURED13]], align 8
// CHECK4-NEXT:    [[BLOCK_CAPTURED14:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, ptr, i32, i32 }>, ptr [[BLOCK]], i32 0, i32 7
