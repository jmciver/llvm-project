...
// CHECK1-NEXT:    [[TMP0:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK1-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP0:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP1:%.*]] = load i32, ptr @t_var, align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load i32, ptr @_ZZ4mainE5sivar, align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP6:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load i32, ptr [[T_VAR]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[SIVAR]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK1-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[F2:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[TMP0]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP1:%.*]] = load float, ptr [[F2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP9]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP0:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP1:%.*]] = load i32, ptr [[F2]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[A:%.*]] = getelementptr inbounds [[STRUCT_ST:%.*]], ptr [[T]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP2:%.*]] = load i32, ptr [[A]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK3-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 0
// CHECK3-NEXT:    [[TMP0:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store i32 [[TMP2]], ptr [[G]], align 4
// CHECK3-NEXT:    [[TMP3:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store i32 [[TMP3]], ptr [[G1]], align 4
// CHECK3-NEXT:    store ptr [[G1]], ptr [[_TMP2]], align 8
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TMP0]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store i32 [[TMP4]], ptr [[SIVAR3]], align 4
// CHECK3-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP2]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP0:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK4-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK4-NEXT:    [[TMP0:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 0
// CHECK4-NEXT:    [[TMP0:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP0:%.*]] = load i32, ptr @_ZZ4mainE5sivar, align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP2:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    store i32 [[TMP2]], ptr [[G]], align 4
// CHECK4-NEXT:    [[TMP3:%.*]] = load volatile i32, ptr @g, align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    store i32 [[TMP3]], ptr [[G1]], align 4
// CHECK4-NEXT:    store ptr [[G1]], ptr [[_TMP2]], align 8
// CHECK4-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TMP0]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP14:%.*]] = load volatile i32, ptr [[G]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP2]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP16:%.*]] = load i32, ptr [[SIVAR3]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF3]]
