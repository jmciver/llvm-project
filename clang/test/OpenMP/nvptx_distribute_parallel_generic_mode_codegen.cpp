...
// CHECK4-NEXT:    [[TMP6:%.*]] = load i32, ptr [[ARGC_ADDR]], align 4, !freeze_bits [[META7:![0-9]+]]
// CHECK4-NEXT:    store i32 [[TMP6]], ptr [[ARGC_CASTED]], align 4
// CHECK4-NEXT:    [[TMP7:%.*]] = load i64, ptr [[ARGC_CASTED]], align 8, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP4:%.*]] = load i32, ptr [[ARGC_ADDR]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP8]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP30:%.*]] = load i32, ptr [[TMP2]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TMP32]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP46:%.*]] = load i32, ptr [[TMP45]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP12:%.*]] = load i32, ptr [[TMP11]], align 4, !freeze_bits [[META7]]
...
// CHECK4-NEXT:    [[TMP23:%.*]] = load i32, ptr [[TMP22]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP6:%.*]] = load i32, ptr [[ARGC_ADDR]], align 4, !freeze_bits [[META7:![0-9]+]]
// CHECK5-NEXT:    store i32 [[TMP6]], ptr [[ARGC_CASTED]], align 4
// CHECK5-NEXT:    [[TMP7:%.*]] = load i32, ptr [[ARGC_CASTED]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP4:%.*]] = load i32, ptr [[ARGC_ADDR]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP8]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP2]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP31:%.*]] = load i32, ptr [[TMP30]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP44:%.*]] = load i32, ptr [[TMP43]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META7]]
...
// CHECK5-NEXT:    [[TMP12:%.*]] = load i32, ptr [[TMP11]], align 4, !freeze_bits [[META7]]
