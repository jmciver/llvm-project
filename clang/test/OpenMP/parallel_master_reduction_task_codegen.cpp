...
// CHECK1-NEXT:    [[TMP59:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP67:%.*]] = load ptr, ptr [[DOTTASK_RED_]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    store ptr [[TMP67]], ptr [[TMP66]], align 8
// CHECK1-NEXT:    [[TMP68:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !freeze_bits [[META3]]
...
// CHECK1:       omp_if.end:
// CHECK1-NEXT:    [[TMP71:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP81:%.*]] = load i32, ptr [[ARGC1]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP83:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP85:%.*]] = load i32, ptr [[ARGC1]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP88:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP90:%.*]] = load i8, ptr [[_TMP24]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP90]] to i32
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !freeze_bits [[META3]]
