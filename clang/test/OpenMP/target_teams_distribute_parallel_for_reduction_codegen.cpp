...
// CHECK5-NEXT:    [[TMP16:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META5]]
// CHECK5-NEXT:    [[TMP17:%.*]] = load i32, ptr [[SIVAR1]], align 4
// CHECK5-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
...
// CHECK5-NEXT:    [[TMP12:%.*]] = load i32, ptr [[SIVAR6]], align 4
// CHECK5-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP12]], [[TMP11]]
// CHECK5-NEXT:    store i32 [[ADD10]], ptr [[SIVAR6]], align 4
// CHECK5-NEXT:    [[TMP13:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK5-NEXT:    store ptr [[SIVAR6]], ptr [[TMP13]], align 8
...
// CHECK5-NEXT:    store ptr [[SIVAR6]], ptr [[TMP15]], align 8
...
// CHECK5-NEXT:    ]
// CHECK5:       .omp.reduction.case1:
// CHECK5-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META5]]
// CHECK5-NEXT:    [[TMP18:%.*]] = load i32, ptr [[SIVAR6]], align 4
// CHECK5-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP17]], [[TMP18]]
...
// CHECK5-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK5:       .omp.reduction.case2:
// CHECK5-NEXT:    [[TMP19:%.*]] = load i32, ptr [[SIVAR6]], align 4
