...
// CHECK1-NEXT:    [[TMP53:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP56:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    store i32 [[TMP56]], ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP63:%.*]] = load ptr, ptr [[TMP]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP76:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, ptr [[_TMP24]], align 1, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP98]] to i32
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !noundef [[NOUNDEF3]]
