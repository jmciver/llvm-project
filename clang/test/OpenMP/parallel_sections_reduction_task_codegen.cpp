...
// CHECK1-NEXT:    [[TMP53:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP56:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    store i32 [[TMP56]], ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP57]], [[TMP58]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP63:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP76:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST13]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP91]] to i32
// CHECK1-NEXT:    [[TMP92:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV14:%.*]] = sext i8 [[TMP92]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE18:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT17]], [[TMP90]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY20:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP95]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST22]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV24:%.*]] = sext i8 [[TMP96]] to i32
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP97:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY21]] ], [ [[TMP102:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP97]], ptr [[_TMP25]], align 1
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, ptr [[_TMP25]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV26:%.*]] = sext i8 [[TMP98]] to i32
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST22]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP101:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST23]], i8 [[TMP97]], i8 [[TMP100]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE32:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT30]], [[TMP95]]
