...
// CHECK1-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_UB]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP4]], align 8, !noundef [[NOUNDEF4]]
...
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load double, ptr [[G2]], align 8, !noundef [[NOUNDEF4]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SVAR5]], align 4, !noundef [[NOUNDEF4]]
// CHECK1-NEXT:    store i32 [[TMP25]], ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP26:%.*]] = load float, ptr [[SFVAR6]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK9-NEXT:    [[TMP13:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF5]]
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF5]]
// CHECK9-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP14]] to i64
// CHECK9-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC3]], i64 0, i64 [[IDXPROM]]
// CHECK9-NEXT:    store i32 [[TMP13]], ptr [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF5]]
...
// CHECK9:       .omp.lastprivate.then:
// CHECK9-NEXT:    [[TMP22:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP6]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF6]]
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF6]]
