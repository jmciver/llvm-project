...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP10]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
...
// CHECK1-NEXT:    store ptr [[G6]], ptr [[TMP14]], align 8
...
// CHECK1-NEXT:    store ptr [[SVAR11]], ptr [[TMP17]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR13]], ptr [[TMP18]], align 8
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load double, ptr [[G6]], align 8
// CHECK1-NEXT:    store volatile double [[TMP22]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SVAR11]], align 4
// CHECK1-NEXT:    store i32 [[TMP25]], ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP26:%.*]] = load float, ptr [[SFVAR13]], align 4
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP16]], i64 4, i1 false)
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK9-NEXT:    [[TMP13:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK9-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP15]], i64 4, i1 false)
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK9:       .omp.lastprivate.then:
// CHECK9-NEXT:    [[TMP22:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK9-NEXT:    [[TMP23:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN17]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN17]], [[TMP23]]
...
// CHECK9-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META7]]
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK11-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP16]], i32 4, i1 false)
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX14]], ptr align 4 [[TMP15]], i32 4, i1 false)
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP23:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN16]], i32 2
