...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double 1.000000e+00, ptr [[TMP13]], align 8
// CHECK1-NEXT:    store i32 3, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store float 4.000000e+00, ptr [[SFVAR11]], align 4
...
// CHECK1-NEXT:    store ptr [[SVAR9]], ptr [[TMP17]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR11]], ptr [[TMP18]], align 8
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP22]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store i32 [[TMP25]], ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP26:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META4]]
...
// CHECK9-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK11-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
