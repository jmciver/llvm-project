...
// CHECK1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK1-NEXT:    [[TMP1:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP4:![0-9]+]], !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP4]], !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP4]], !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load i32, ptr [[F]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP8:%.*]] = load float, ptr @.init, align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load float, ptr [[T_VAR3]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[DOTADDR1]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[DOTADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP4:%.*]] = load float, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load float, ptr [[F]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[F2:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[TMP3]], i32 0, i32 2
// CHECK1-NEXT:    [[TMP5:%.*]] = load float, ptr [[F2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load i32, ptr [[ARRAYIDX11]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP46:%.*]] = load i32, ptr [[ARRAYIDX28]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP62:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP63:%.*]] = load i32, ptr [[TMP62]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP65:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP66:%.*]] = load i32, ptr [[TMP65]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[DOTADDR1]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[DOTADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TMP2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, ptr [[ARRAYIDX16]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[THIS1]], i64 4
// CHECK1-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S_0:%.*]], ptr [[THIS1]], i32 0, i32 2
// CHECK1-NEXT:    [[TMP1:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV:%.*]] = fpext float [[TMP1]] to double
// CHECK1-NEXT:    [[TMP2:%.*]] = load volatile double, ptr @g, align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    [[TMP5:%.*]] = load i32, ptr @.init.32, align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK1-NEXT:    store i32 [[ADD]], ptr [[I]], align 4
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR3]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP1]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[THIS1]], i64 4
// CHECK1-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 2
// CHECK1-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP2:![0-9]+]], !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK3-NEXT:    [[TMP1:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP2]], !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP2]], !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[DOTADDR1]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[F]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[VAR]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP0]], ptr [[TMP]], align 8
// CHECK3-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[TMP]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP1]], ptr [[_TMP10]], align 8
// CHECK3-NEXT:    store i32 0, ptr [[I]], align 4
// CHECK3-NEXT:    br label [[FOR_COND:%.*]]
// CHECK3:       for.cond:
// CHECK3-NEXT:    [[TMP2:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP2]], 2
// CHECK3-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]]
// CHECK3:       for.body:
// CHECK3-NEXT:    [[TMP3:%.*]] = load float, ptr [[T_VAR]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CONV:%.*]] = fptosi float [[TMP3]] to i32
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP10]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[ARRAYIDX14]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.cond16:
// CHECK3-NEXT:    [[TMP12:%.*]] = load i32, ptr [[I15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load i32, ptr [[I15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[ARRAYIDX21]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[INC22:%.*]] = add nsw i32 [[TMP15]], 1
// CHECK3-NEXT:    store i32 [[INC22]], ptr [[ARRAYIDX21]], align 4
// CHECK3-NEXT:    br label [[FOR_INC23:%.*]]
// CHECK3:       for.inc23:
// CHECK3-NEXT:    [[TMP16:%.*]] = load i32, ptr [[I15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.cond27:
// CHECK3-NEXT:    [[TMP17:%.*]] = load i32, ptr [[I26]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, ptr [[I26]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, ptr [[ARRAYIDX32]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[INC33:%.*]] = add nsw i32 [[TMP20]], 1
// CHECK3-NEXT:    store i32 [[INC33]], ptr [[ARRAYIDX32]], align 4
// CHECK3-NEXT:    br label [[FOR_INC34:%.*]]
// CHECK3:       for.inc34:
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[I26]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.cond38:
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[I37]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.inc41:
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[I37]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.cond45:
// CHECK3-NEXT:    [[TMP24:%.*]] = load i32, ptr [[I44]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.inc48:
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, ptr [[I44]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.end50:
// CHECK3-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[VAR3]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP26]], ptr [[_TMP51]], align 8
// CHECK3-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[_TMP51]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP27]], ptr [[_TMP52]], align 8
// CHECK3-NEXT:    store i32 0, ptr [[I53]], align 4
// CHECK3-NEXT:    br label [[FOR_COND54:%.*]]
// CHECK3:       for.cond54:
// CHECK3-NEXT:    [[TMP28:%.*]] = load i32, ptr [[I53]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.inc57:
// CHECK3-NEXT:    [[TMP29:%.*]] = load i32, ptr [[I53]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.end59:
// CHECK3-NEXT:    [[TMP30:%.*]] = load ptr, ptr [[VAR3]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP30]], ptr [[_TMP60]], align 8
// CHECK3-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[_TMP60]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP31]], ptr [[_TMP61]], align 8
// CHECK3-NEXT:    store i32 0, ptr [[I62]], align 4
// CHECK3-NEXT:    br label [[FOR_COND63:%.*]]
// CHECK3:       for.cond63:
// CHECK3-NEXT:    [[TMP32:%.*]] = load i32, ptr [[I62]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.inc66:
// CHECK3-NEXT:    [[TMP33:%.*]] = load i32, ptr [[I62]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK3-NEXT:    [[TMP0:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]]
// CHECK3:       for.body:
// CHECK3-NEXT:    [[TMP3:%.*]] = load i32, ptr [[T_VAR]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP4:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP4]] to i64
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC]], i64 0, i64 [[IDXPROM]]
...
// CHECK3:       for.end:
// CHECK3-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[VAR]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.cond7:
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[I6]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CMP8:%.*]] = icmp slt i32 [[TMP10]], 2
// CHECK3-NEXT:    br i1 [[CMP8]], label [[FOR_BODY9:%.*]], label [[FOR_END17:%.*]]
// CHECK3:       for.body9:
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[T_VAR]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP12:%.*]] = load i32, ptr [[I6]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP5]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP14:%.*]] = load i32, ptr [[I6]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.inc15:
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[I6]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.end17:
// CHECK3-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[VAR]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP16]], ptr [[_TMP18]], align 8
// CHECK3-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP18]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    store ptr [[TMP17]], ptr [[_TMP19]], align 8
// CHECK3-NEXT:    store i32 0, ptr [[I20]], align 4
// CHECK3-NEXT:    br label [[FOR_COND21:%.*]]
// CHECK3:       for.cond21:
// CHECK3-NEXT:    [[TMP18:%.*]] = load i32, ptr [[I20]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CMP22:%.*]] = icmp slt i32 [[TMP18]], 2
// CHECK3-NEXT:    br i1 [[CMP22]], label [[FOR_BODY23:%.*]], label [[FOR_END31:%.*]]
// CHECK3:       for.body23:
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, ptr [[T_VAR]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, ptr [[I20]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP19]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[I20]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3:       for.inc29:
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[I20]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP1:%.*]] = load volatile double, ptr @g, align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[THIS1]], i64 4
// CHECK3-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S_0:%.*]], ptr [[THIS1]], i32 0, i32 2
// CHECK3-NEXT:    [[TMP1:%.*]] = load float, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CONV:%.*]] = fpext float [[TMP1]] to double
// CHECK3-NEXT:    [[TMP2:%.*]] = load volatile double, ptr @g, align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK3-NEXT:    [[TMP0:%.*]] = load i32, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[THIS1]], i64 4
// CHECK3-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[THIS1]], i32 0, i32 2
// CHECK3-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A_ADDR]], align 4, !noundef [[NOUNDEF3]]
