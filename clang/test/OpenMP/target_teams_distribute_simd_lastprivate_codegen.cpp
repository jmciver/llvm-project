...
// CHECK1-NEXT:    [[TMP0:%.*]] = load double, ptr [[G_ADDR]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    store double [[TMP0]], ptr [[G_CASTED]], align 8
// CHECK1-NEXT:    [[TMP1:%.*]] = load i64, ptr [[G_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP3:%.*]] = load volatile double, ptr [[TMP2]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    store double [[TMP3]], ptr [[G1_CASTED]], align 8
// CHECK1-NEXT:    [[TMP4:%.*]] = load i64, ptr [[G1_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP5:%.*]] = load i32, ptr [[SVAR_ADDR]], align 4, !freeze_bits [[META5]]
// CHECK1-NEXT:    store i32 [[TMP5]], ptr [[SVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP6:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP7:%.*]] = load float, ptr [[SFVAR_ADDR]], align 4, !freeze_bits [[META5]]
// CHECK1-NEXT:    store float [[TMP7]], ptr [[SFVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP8:%.*]] = load i64, ptr [[SFVAR_CASTED]], align 8, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    store double 1.000000e+00, ptr [[G6]], align 8, !llvm.access.group [[ACC_GRP7]]
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP10]], align 8, !nonnull [[META5]], !align [[META6]], !llvm.access.group [[ACC_GRP7]], !freeze_bits [[META5]]
// CHECK1-NEXT:    store volatile double 1.000000e+00, ptr [[TMP9]], align 8, !llvm.access.group [[ACC_GRP7]]
// CHECK1-NEXT:    store i32 3, ptr [[SVAR11]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK1-NEXT:    store float 4.000000e+00, ptr [[SFVAR13]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK1-NEXT:    [[TMP10:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK1-NEXT:    store ptr [[G6]], ptr [[TMP10]], align 8, !llvm.access.group [[ACC_GRP7]]
...
// CHECK1-NEXT:    store ptr [[SVAR11]], ptr [[TMP13]], align 8, !llvm.access.group [[ACC_GRP7]]
// CHECK1-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR13]], ptr [[TMP14]], align 8, !llvm.access.group [[ACC_GRP7]]
...
// CHECK1-NEXT:    store i32 [[ADD17]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP7]]
...
// CHECK1-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP10]], align 4, !nonnull [[META6]], !align [[META7]], !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META6]]
...
// CHECK3-NEXT:    store ptr [[G6]], ptr [[TMP12]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK3-NEXT:    store ptr [[SVAR11]], ptr [[TMP15]], align 4, !llvm.access.group [[ACC_GRP8]]
// CHECK3-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR13]], ptr [[TMP16]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK9-NEXT:    [[TMP39:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP3:%.*]] = load i32, ptr [[T_VAR_ADDR]], align 4, !freeze_bits [[META7]]
// CHECK9-NEXT:    store i32 [[TMP3]], ptr [[T_VAR_CASTED]], align 4
// CHECK9-NEXT:    [[TMP4:%.*]] = load i64, ptr [[T_VAR_CASTED]], align 8, !freeze_bits [[META7]]
// CHECK9-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[TMP]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK9-NEXT:    [[TMP6:%.*]] = load i32, ptr [[SVAR_ADDR]], align 4, !freeze_bits [[META7]]
// CHECK9-NEXT:    store i32 [[TMP6]], ptr [[SVAR_CASTED]], align 4
// CHECK9-NEXT:    [[TMP7:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP4]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR6]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META7]]
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP14]], i64 4, i1 false), !llvm.access.group [[ACC_GRP9]]
...
// CHECK9-NEXT:    [[TMP18:%.*]] = load i32, ptr [[TMP17]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP34:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR6]], align 4, !llvm.access.group [[ACC_GRP15]]
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !llvm.access.group [[ACC_GRP15]], !freeze_bits [[META7]]
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP14]], i64 4, i1 false), !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP39:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[TMP3:%.*]] = load i32, ptr [[T_VAR_ADDR]], align 4, !freeze_bits [[META8]]
// CHECK11-NEXT:    store i32 [[TMP3]], ptr [[T_VAR_CASTED]], align 4
// CHECK11-NEXT:    [[TMP4:%.*]] = load i32, ptr [[T_VAR_CASTED]], align 4, !freeze_bits [[META8]]
// CHECK11-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[TMP]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK11-NEXT:    [[TMP6:%.*]] = load i32, ptr [[SVAR_ADDR]], align 4, !freeze_bits [[META8]]
// CHECK11-NEXT:    store i32 [[TMP6]], ptr [[SVAR_CASTED]], align 4
// CHECK11-NEXT:    [[TMP7:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP4]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR6]], align 4, !llvm.access.group [[ACC_GRP10]]
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META8]], !align [[META9]], !llvm.access.group [[ACC_GRP10]], !freeze_bits [[META8]]
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP14]], i32 4, i1 false), !llvm.access.group [[ACC_GRP10]]
...
// CHECK11-NEXT:    [[TMP34:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze_bits [[META8]]
...
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR6]], align 4, !llvm.access.group [[ACC_GRP16]]
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META8]], !align [[META9]], !llvm.access.group [[ACC_GRP16]], !freeze_bits [[META8]]
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX14]], ptr align 4 [[TMP14]], i32 4, i1 false), !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
...
// CHECK13-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[TMP]], align 8, !nonnull [[META2]], !align [[META3]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP8:%.*]] = load i32, ptr [[T_VAR9]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP14]], align 8, !nonnull [[META2]], !align [[META3]], !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP10]], i64 4, i1 false), !llvm.access.group [[ACC_GRP4]]
...
// CHECK13-NEXT:    [[TMP8:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP8]]
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP12]], align 8, !nonnull [[META2]], !align [[META3]], !llvm.access.group [[ACC_GRP8]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX14]], ptr align 4 [[TMP10]], i64 4, i1 false), !llvm.access.group [[ACC_GRP8]]
// CHECK13-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK13:       omp.body.continue:
// CHECK13-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK13:       omp.inner.for.inc:
...
// CHECK15-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[TMP]], align 4, !nonnull [[META3]], !align [[META4]], !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP8:%.*]] = load i32, ptr [[T_VAR9]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP14]], align 4, !nonnull [[META3]], !align [[META4]], !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META3]]
...
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP10]], i32 4, i1 false), !llvm.access.group [[ACC_GRP5]]
...
// CHECK15-NEXT:    [[TMP8:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP9]]
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP12]], align 4, !nonnull [[META3]], !align [[META4]], !llvm.access.group [[ACC_GRP9]], !freeze_bits [[META3]]
...
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX13]], ptr align 4 [[TMP10]], i32 4, i1 false), !llvm.access.group [[ACC_GRP9]]
// CHECK15-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK15:       omp.body.continue:
// CHECK15-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK15:       omp.inner.for.inc:
