...
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC]], i64 0, i64 [[IDXPROM]]
// CHECK1-NEXT:    store i32 [[TMP8]], ptr [[ARRAYIDX]], align 4
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP7]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4
...
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC]], i32 0, i32 [[TMP9]]
// CHECK3-NEXT:    store i32 [[TMP8]], ptr [[ARRAYIDX]], align 4
// CHECK3-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP7]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4
...
// CHECK5-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
...
// CHECK5-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
...
// CHECK13-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4, !freeze_bits [[META6]]
...
// CHECK13-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC]], i64 0, i64 [[IDXPROM]]
// CHECK13-NEXT:    store i32 [[TMP8]], ptr [[ARRAYIDX]], align 4
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP7]], align 8, !freeze_bits [[META6]]
// CHECK13-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4
...
// CHECK15-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP14]], align 4, !freeze_bits [[META7]]
...
// CHECK15-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[VEC]], i32 0, i32 [[TMP9]]
// CHECK15-NEXT:    store i32 [[TMP8]], ptr [[ARRAYIDX]], align 4
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP7]], align 4, !freeze_bits [[META7]]
// CHECK15-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4
...
// CHECK15-NEXT:    [[TMP14:%.*]] = load i32, ptr [[TMP13]], align 4, !freeze_bits [[META7]]
...
// CHECK17-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META5]]
...
// CHECK17-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META5]]
