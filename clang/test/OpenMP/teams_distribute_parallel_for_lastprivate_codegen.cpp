...
// CHECK1-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i64 [[TMP13]], i64 [[TMP15]], ptr [[G6]], ptr [[TMP16]], ptr [[SVAR9]], ptr [[SFVAR11]])
...
// CHECK1-NEXT:    [[TMP21:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP21]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, ptr [[TMP22]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP23]], ptr [[TMP4]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store i32 [[TMP24]], ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP25:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i32 [[TMP12]], i32 [[TMP13]], ptr [[G6]], ptr [[TMP14]], ptr [[SVAR9]], ptr [[SFVAR11]])
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP19]], ptr [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP21:%.*]] = load double, ptr [[TMP20]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP21]], ptr [[TMP4]], align 4
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK3-NEXT:    store i32 [[TMP22]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP23:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK11-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
