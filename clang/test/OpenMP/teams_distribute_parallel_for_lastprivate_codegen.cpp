...
// CHECK1-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP10]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
// CHECK1-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i64 [[TMP13]], i64 [[TMP15]], ptr [[G6]], ptr [[TMP16]], ptr [[SVAR11]], ptr [[SFVAR13]])
...
// CHECK1-NEXT:    [[TMP21:%.*]] = load double, ptr [[G6]], align 8
// CHECK1-NEXT:    store volatile double [[TMP21]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, ptr [[TMP22]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    store volatile double [[TMP23]], ptr [[TMP4]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR11]], align 4
// CHECK1-NEXT:    store i32 [[TMP24]], ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP25:%.*]] = load float, ptr [[SFVAR13]], align 4
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP10]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i32 [[TMP12]], i32 [[TMP13]], ptr [[G6]], ptr [[TMP14]], ptr [[SVAR11]], ptr [[SFVAR13]])
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load double, ptr [[G6]], align 8
// CHECK3-NEXT:    store volatile double [[TMP19]], ptr [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP21:%.*]] = load double, ptr [[TMP20]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    store volatile double [[TMP21]], ptr [[TMP4]], align 4
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR11]], align 4
// CHECK3-NEXT:    store i32 [[TMP22]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP23:%.*]] = load float, ptr [[SFVAR13]], align 4
...
// CHECK9-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK9-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l106.omp_outlined.omp_outlined, i64 [[TMP14]], i64 [[TMP16]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP17]], ptr [[SVAR12]])
...
// CHECK9-NEXT:    [[TMP25:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN16]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN16]], [[TMP25]]
...
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, ptr [[SVAR12]], align 4
...
// CHECK9-NEXT:    [[TMP28:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN18]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK9-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK9-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiET_v_l49.omp_outlined.omp_outlined, i64 [[TMP13]], i64 [[TMP15]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP16]])
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK9-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN14]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN14]], [[TMP24]]
...
// CHECK9-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META7]]
...
// CHECK9-NEXT:    [[TMP26:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN16]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK11-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK11-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l106.omp_outlined.omp_outlined, i32 [[TMP13]], i32 [[TMP14]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP15]], ptr [[SVAR12]])
...
// CHECK11-NEXT:    [[TMP22:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK11-NEXT:    [[TMP23:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN16]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN16]], [[TMP23]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META8]]
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[TMP5]], ptr align 4 [[TMP24]], i32 4, i1 false)
// CHECK11-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SVAR12]], align 4
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK11-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiET_v_l49.omp_outlined.omp_outlined, i32 [[TMP12]], i32 [[TMP13]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP14]])
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4
...
// CHECK11:       .omp.lastprivate.then:
// CHECK11-NEXT:    [[TMP21:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK11-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN14]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN14]], [[TMP22]]
...
// CHECK11-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META8]]
