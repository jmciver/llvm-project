...
// CHECK1-NEXT:    [[TMP21:%.*]] = load double, ptr [[G7]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[SVAR10]], align 4
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP9]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR10]], align 4
