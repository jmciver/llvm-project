...
// CHECK1-NEXT:    [[TMP22:%.*]] = load i64, ptr [[G_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load volatile double, ptr [[TMP23]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store double [[TMP24]], ptr [[G1_CASTED]], align 8
// CHECK1-NEXT:    [[TMP25:%.*]] = load i64, ptr [[G1_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK1-NEXT:    store i32 [[TMP26]], ptr [[SVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP28:%.*]] = load float, ptr [[SFVAR14]], align 4
// CHECK1-NEXT:    store float [[TMP28]], ptr [[SFVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP29:%.*]] = load i64, ptr [[SFVAR_CASTED]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP20:%.*]] = load volatile double, ptr [[TMP19]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    store double [[TMP20]], ptr [[G1_CASTED]], align 4
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[G1_CASTED]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK3-NEXT:    store i32 [[TMP22]], ptr [[SVAR_CASTED]], align 4
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR14]], align 4
// CHECK3-NEXT:    store float [[TMP24]], ptr [[SFVAR_CASTED]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SFVAR_CASTED]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[TMP]], align 4, !freeze_bits [[META5]]
...
// CHECK8-NEXT:    [[TMP22:%.*]] = load i64, ptr [[T_VAR_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK8-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP13]], align 8, !freeze_bits [[META5]]
// CHECK8-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR14]], align 4
// CHECK8-NEXT:    store i32 [[TMP24]], ptr [[SVAR_CASTED]], align 4
// CHECK8-NEXT:    [[TMP25:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META5]]
...
// CHECK8-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR_ADDR]], align 4, !freeze_bits [[META5]]
...
// CHECK8-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK8-NEXT:    [[TMP20:%.*]] = load i64, ptr [[T_VAR_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK8-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP13]], align 8, !freeze_bits [[META5]]
...
// CHECK10-NEXT:    [[TMP20:%.*]] = load i32, ptr [[T_VAR_CASTED]], align 4, !freeze_bits [[META6]]
// CHECK10-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP13]], align 4, !freeze_bits [[META6]]
// CHECK10-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR14]], align 4
// CHECK10-NEXT:    store i32 [[TMP22]], ptr [[SVAR_CASTED]], align 4
// CHECK10-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META6]]
...
// CHECK10-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR_ADDR]], align 4, !freeze_bits [[META6]]
...
// CHECK10-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META6]]
...
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32, ptr [[T_VAR_CASTED]], align 4, !freeze_bits [[META6]]
// CHECK10-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP13]], align 4, !freeze_bits [[META6]]
