...
// CHECK1-NEXT:    [[TMP21:%.*]] = load double, ptr [[G7]], align 8
// CHECK1-NEXT:    store double [[TMP21]], ptr [[G_CASTED]], align 8
// CHECK1-NEXT:    [[TMP22:%.*]] = load i64, ptr [[G_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load volatile double, ptr [[TMP23]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    store double [[TMP24]], ptr [[G1_CASTED]], align 8
// CHECK1-NEXT:    [[TMP25:%.*]] = load i64, ptr [[G1_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK1-NEXT:    store i32 [[TMP26]], ptr [[SVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP28:%.*]] = load float, ptr [[SFVAR14]], align 4
// CHECK1-NEXT:    store float [[TMP28]], ptr [[SFVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP29:%.*]] = load i64, ptr [[SFVAR_CASTED]], align 8, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP11]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP20:%.*]] = load volatile double, ptr [[TMP19]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    store double [[TMP20]], ptr [[G1_CASTED]], align 4
// CHECK3-NEXT:    [[TMP21:%.*]] = load i32, ptr [[G1_CASTED]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK3-NEXT:    store i32 [[TMP22]], ptr [[SVAR_CASTED]], align 4
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR14]], align 4
// CHECK3-NEXT:    store float [[TMP24]], ptr [[SFVAR_CASTED]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SFVAR_CASTED]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i32 [[TMP17]], i32 [[TMP18]], ptr [[G7]], i32 [[TMP21]], i32 [[TMP23]], i32 [[TMP25]])
...
// CHECK3-NEXT:    store double 1.000000e+00, ptr [[G6]], align 8
// CHECK3-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[TMP]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
...
// CHECK3-NEXT:    store ptr [[G6]], ptr [[TMP13]], align 4
// CHECK3-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 1
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[TMP]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
...
// CHECK8-NEXT:    [[TMP21:%.*]] = load i32, ptr [[T_VAR7]], align 4
// CHECK8-NEXT:    store i32 [[TMP21]], ptr [[T_VAR_CASTED]], align 4
// CHECK8-NEXT:    [[TMP22:%.*]] = load i64, ptr [[T_VAR_CASTED]], align 8, !freeze_bits [[META7]]
// CHECK8-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP13]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK8-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR14]], align 4
// CHECK8-NEXT:    store i32 [[TMP24]], ptr [[SVAR_CASTED]], align 4
// CHECK8-NEXT:    [[TMP25:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META7]]
// CHECK8-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l139.omp_outlined.omp_outlined, i64 [[TMP18]], i64 [[TMP20]], ptr [[VEC9]], i64 [[TMP22]], ptr [[S_ARR10]], ptr [[TMP23]], i64 [[TMP25]])
...
// CHECK8-NEXT:    [[TMP30:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN18]], i64 2
// CHECK8-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK8:       arraydestroy.body:
...
// CHECK8-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR_ADDR]], align 4, !freeze_bits [[META7]]
...
// CHECK8-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
...
// CHECK8-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP17]], i64 4, i1 false)
...
// CHECK8-NEXT:    store i32 [[ADD16]], ptr [[DOTOMP_IV]], align 4
// CHECK8-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK8:       omp.inner.for.end:
// CHECK8-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK8:       omp.loop.exit:
...
// CHECK8-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN17]], i64 2
// CHECK8-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK8:       arraydestroy.body:
...
// CHECK8-NEXT:    [[TMP18:%.*]] = zext i32 [[TMP17]] to i64
// CHECK8-NEXT:    [[TMP19:%.*]] = load i32, ptr [[T_VAR7]], align 4
// CHECK8-NEXT:    store i32 [[TMP19]], ptr [[T_VAR_CASTED]], align 4
// CHECK8-NEXT:    [[TMP20:%.*]] = load i64, ptr [[T_VAR_CASTED]], align 8, !freeze_bits [[META7]]
// CHECK8-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP13]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
// CHECK8-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiET_v_l48.omp_outlined.omp_outlined, i64 [[TMP16]], i64 [[TMP18]], ptr [[VEC9]], i64 [[TMP20]], ptr [[S_ARR10]], ptr [[TMP21]])
// CHECK8-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK8:       omp.inner.for.inc:
...
// CHECK8-NEXT:    [[TMP26:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN16]], i64 2
// CHECK8-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK8:       arraydestroy.body:
...
// CHECK8-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN17]], i64 2
// CHECK8-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK8:       arraydestroy.body:
// CHECK8-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi ptr [ [[TMP22]], [[OMP_LOOP_EXIT]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ]
// CHECK8-NEXT:    [[ARRAYDESTROY_ELEMENT]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAYDESTROY_ELEMENTPAST]], i64 -1
...
// CHECK10-NEXT:    [[TMP19:%.*]] = load i32, ptr [[T_VAR7]], align 4
// CHECK10-NEXT:    store i32 [[TMP19]], ptr [[T_VAR_CASTED]], align 4
// CHECK10-NEXT:    [[TMP20:%.*]] = load i32, ptr [[T_VAR_CASTED]], align 4, !freeze_bits [[META8]]
// CHECK10-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP13]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK10-NEXT:    [[TMP22:%.*]] = load i32, ptr [[SVAR14]], align 4
// CHECK10-NEXT:    store i32 [[TMP22]], ptr [[SVAR_CASTED]], align 4
// CHECK10-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META8]]
// CHECK10-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l139.omp_outlined.omp_outlined, i32 [[TMP17]], i32 [[TMP18]], ptr [[VEC9]], i32 [[TMP20]], ptr [[S_ARR10]], ptr [[TMP21]], i32 [[TMP23]])
...
// CHECK10-NEXT:    [[TMP28:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN18]], i32 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK10-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR_ADDR]], align 4, !freeze_bits [[META8]]
...
// CHECK10-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP10]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
...
// CHECK10-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX13]], ptr align 4 [[TMP17]], i32 4, i1 false)
...
// CHECK10-NEXT:    store i32 [[ADD14]], ptr [[DOTOMP_IV]], align 4
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK10:       omp.inner.for.end:
// CHECK10-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK10:       omp.loop.exit:
...
// CHECK10-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN15]], i32 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK10-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4
// CHECK10-NEXT:    [[TMP17:%.*]] = load i32, ptr [[T_VAR7]], align 4
// CHECK10-NEXT:    store i32 [[TMP17]], ptr [[T_VAR_CASTED]], align 4
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32, ptr [[T_VAR_CASTED]], align 4, !freeze_bits [[META8]]
// CHECK10-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP13]], align 4, !nonnull [[META8]], !align [[META9]], !freeze_bits [[META8]]
// CHECK10-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiET_v_l48.omp_outlined.omp_outlined, i32 [[TMP15]], i32 [[TMP16]], ptr [[VEC9]], i32 [[TMP18]], ptr [[S_ARR10]], ptr [[TMP19]])
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
...
// CHECK10-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN16]], i32 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK10-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN15]], i32 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
// CHECK10-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi ptr [ [[TMP22]], [[OMP_LOOP_EXIT]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ]
// CHECK10-NEXT:    [[ARRAYDESTROY_ELEMENT]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAYDESTROY_ELEMENTPAST]], i32 -1
