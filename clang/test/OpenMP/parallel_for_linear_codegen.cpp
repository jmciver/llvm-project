...
// CHECK1-NEXT:    [[TMP17:%.*]] = load i64, ptr [[LVAR3]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load i64, ptr [[LVAR3]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP0]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    store ptr [[TMP2]], ptr [[DOTLINEAR_START]], align 8
// CHECK1-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    store ptr [[ADD_PTR]], ptr [[PVAR2]], align 8
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[DOTLINEAR_START1]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[LVAR3]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[PVAR2]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    store ptr [[TMP21]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP22:%.*]] = load i32, ptr [[LVAR3]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[G_ADDR]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTLINEAR_START]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP12:%.*]] = load i32, ptr [[G1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP17:%.*]] = load i32, ptr [[G1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[G_ADDR]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK4-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTLINEAR_START]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[MUL3:%.*]] = mul nsw i32 [[TMP11]], 5
// CHECK4-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP10]], [[MUL3]]
// CHECK4-NEXT:    store i32 [[ADD4]], ptr [[G1]], align 4
// CHECK4-NEXT:    [[TMP12:%.*]] = load i32, ptr [[G1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP13:%.*]] = load volatile i32, ptr [[G1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_IS_LAST]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP19:%.*]] = load i32, ptr [[G1]], align 4, !noundef [[NOUNDEF3]]
