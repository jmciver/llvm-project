...
// CHECK1-NEXT:    [[TMP5:%.*]] = load i8, ptr [[DOTCAPTURE_EXPR__ADDR]], align 1, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef i32 @_Z3fooPi(ptr noundef [[I11]]) #[[ATTR4:[0-9]+]]
// CHECK1-NEXT:    [[CALL15:%.*]] = call noundef i32 @_Z3fooPi(ptr noundef [[TMP0]]) #[[ATTR4]]
// CHECK1-NEXT:    [[ADD16:%.*]] = add nsw i32 [[CALL]], [[CALL15]]
// CHECK1-NEXT:    [[CALL17:%.*]] = call noundef i32 @_Z3fooPi(ptr noundef [[ARGC_ADDR]]) #[[ATTR4]]
// CHECK1-NEXT:    [[ADD18:%.*]] = add nsw i32 [[ADD16]], [[CALL17]]
// CHECK1-NEXT:    store i32 [[ADD18]], ptr [[TMP0]], align 4
...
// CHECK2-NEXT:    [[TMP5:%.*]] = load i8, ptr [[DOTCAPTURE_EXPR__ADDR]], align 1, !freeze_bits [[META5]]
...
// CHECK2-NEXT:    [[CMP14:%.*]] = icmp sle i32 [[TMP12]], [[TMP13]]
...
// CHECK2-NEXT:    [[CALL:%.*]] = call noundef i32 @_Z3fooPi(ptr noundef [[I11]]) #[[ATTR4:[0-9]+]]
// CHECK2-NEXT:    [[CALL15:%.*]] = call noundef i32 @_Z3fooPi(ptr noundef [[TMP0]]) #[[ATTR4]]
// CHECK2-NEXT:    [[ADD16:%.*]] = add nsw i32 [[CALL]], [[CALL15]]
// CHECK2-NEXT:    [[CALL17:%.*]] = call noundef i32 @_Z3fooPi(ptr noundef [[ARGC_ADDR]]) #[[ATTR4]]
// CHECK2-NEXT:    [[ADD18:%.*]] = add nsw i32 [[ADD16]], [[CALL17]]
// CHECK2-NEXT:    store i32 [[ADD18]], ptr [[TMP0]], align 4
...
// CHECK2-NEXT:    [[TMP17:%.*]] = load i32, ptr [[TMP16]], align 4, !freeze_bits [[META5]]
