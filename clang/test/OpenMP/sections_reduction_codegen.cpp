...
// CHECK1-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP16:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP23:%.*]] = load float, ptr [[TMP0]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load float, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP26:%.*]] = load float, ptr [[TMP3]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP27:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP14:%.*]] = fcmp olt float [[TMP26]], [[TMP27]]
// CHECK1-NEXT:    br i1 [[CMP14]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    [[TMP28:%.*]] = load float, ptr [[TMP3]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP29:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
...
// CHECK1-NEXT:    [[TMP30:%.*]] = load float, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    call void @__kmpc_end_critical(ptr @[[GLOB3]], i32 [[TMP7]], ptr @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[TMP33:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP36:%.*]] = load float, ptr [[TMP]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP37:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP24:%.*]] = fcmp olt float [[TMP36]], [[TMP37]]
// CHECK1-NEXT:    br i1 [[CMP24]], label [[COND_TRUE25:%.*]], label [[COND_FALSE26:%.*]]
// CHECK1:       cond.true25:
// CHECK1-NEXT:    [[TMP38:%.*]] = load float, ptr [[TMP]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END27]]
// CHECK1:       cond.false26:
// CHECK1-NEXT:    [[TMP39:%.*]] = load float, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END27]]
// CHECK1:       cond.end27:
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.sections.case:
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], ptr [[TMP4]], i64 0, i64 0
...
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP22:%.*]] = load i32, ptr [[TMP0]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[TMP3]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CMP11:%.*]] = icmp slt i32 [[TMP25]], [[TMP26]]
// CHECK1-NEXT:    br i1 [[CMP11]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    [[TMP27:%.*]] = load i32, ptr [[TMP3]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
...
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    call void @__kmpc_end_critical(ptr @[[GLOB3]], i32 [[TMP7]], ptr @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[TMP32:%.*]] = load i32, ptr [[T_VAR15]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP2:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP5:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP6]], [[TMP7]]
// CHECK3-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK3:       omp.inner.for.body:
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load double, ptr @g, align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP14:%.*]] = load double, ptr [[G]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP15:%.*]] = load double, ptr [[G]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK3-NEXT:    [[TMP8:%.*]] = load double, ptr [[TMP7]], align 8, !noundef [[NOUNDEF3]]
// CHECK3-NEXT:    [[TMP9:%.*]] = load double, ptr [[TMP5]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP2:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP5:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_LB_]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    store i32 [[TMP5]], ptr [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK4:       omp.inner.for.cond:
// CHECK4-NEXT:    [[TMP6:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_UB_]], align 4, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP6]], [[TMP7]]
// CHECK4-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK4:       omp.inner.for.body:
// CHECK4-NEXT:    [[TMP8:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP9:%.*]] = load volatile double, ptr [[G]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_SECTIONS_IV_]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP15:%.*]] = load double, ptr @g, align 8, !noundef [[NOUNDEF3]]
// CHECK4-NEXT:    [[TMP16:%.*]] = load double, ptr [[G]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP17:%.*]] = load double, ptr [[G]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK4-NEXT:    [[TMP9:%.*]] = load double, ptr [[TMP5]], align 8, !noundef [[NOUNDEF3]]
