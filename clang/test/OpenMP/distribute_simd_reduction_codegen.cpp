...
// CHECK1-NEXT:    store i32 0, ptr [[SIVAR5]], align 4
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load i32, ptr [[SIVAR5]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK1-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP10]], [[TMP9]]
// CHECK1-NEXT:    store i32 [[ADD9]], ptr [[SIVAR5]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[SIVAR5]], align 4
...
// CHECK1-NEXT:    store i32 1, ptr [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[T_VAR5]], align 4
// CHECK1-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP2:%.*]] = load i32, ptr [[TMP1]], align 4, !freeze_bits [[META5]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load i32, ptr [[T_VAR5]], align 4, !llvm.access.group [[ACC_GRP12]]
// CHECK1-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP10]], [[TMP9]]
// CHECK1-NEXT:    store i32 [[ADD9]], ptr [[T_VAR5]], align 4, !llvm.access.group [[ACC_GRP12]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1:       .omp.final.done:
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR5]], align 4
// CHECK1-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP14]], [[TMP15]]
// CHECK1-NEXT:    store i32 [[ADD11]], ptr [[TMP0]], align 4
// CHECK1-NEXT:    ret void
//
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[SIVAR5]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK3-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP10]], [[TMP9]]
// CHECK3-NEXT:    store i32 [[ADD9]], ptr [[SIVAR5]], align 4, !llvm.access.group [[ACC_GRP7]]
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[SIVAR5]], align 4
...
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, ptr [[T_VAR5]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK3-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP10]], [[TMP9]]
// CHECK3-NEXT:    store i32 [[ADD9]], ptr [[T_VAR5]], align 4, !llvm.access.group [[ACC_GRP13]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK3:       .omp.final.done:
// CHECK3-NEXT:    [[TMP14:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META6]]
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[T_VAR5]], align 4
// CHECK3-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP14]], [[TMP15]]
// CHECK3-NEXT:    store i32 [[ADD11]], ptr [[TMP0]], align 4
// CHECK3-NEXT:    ret void
//
...
// CHECK9-NEXT:    [[SIVAR5:%.*]] = alloca i32, align 4
// CHECK9-NEXT:    [[FREEZE_POISON6:%.*]] = freeze i32 poison
// CHECK9-NEXT:    store i32 [[FREEZE_POISON6]], ptr [[SIVAR5]], align 4
...
// CHECK9-NEXT:    store i32 0, ptr [[SIVAR5]], align 4
...
// CHECK9-NEXT:    [[TMP10:%.*]] = load i32, ptr [[SIVAR5]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK9-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP10]], [[TMP9]]
// CHECK9-NEXT:    store i32 [[ADD9]], ptr [[SIVAR5]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK9-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK9-NEXT:    store ptr [[SIVAR5]], ptr [[TMP11]], align 8, !llvm.access.group [[ACC_GRP5]]
...
// CHECK9-NEXT:    [[TMP15:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META4]]
// CHECK9-NEXT:    [[TMP16:%.*]] = load i32, ptr [[SIVAR5]], align 4
