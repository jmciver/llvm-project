...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[ARRAYIDX]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP3]], i64 0
// CHECK1-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP5:%.*]] = sext i32 [[TMP4]] to i64
// CHECK1-NEXT:    [[LB_ADD_LEN:%.*]] = add nsw i64 -1, [[TMP5]]
// CHECK1-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[TMP1]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds nuw ptr, ptr [[TMP6]], i64 9
// CHECK1-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[ARRAYIDX8]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP7]], i64 [[LB_ADD_LEN]]
// CHECK1-NEXT:    [[TMP8:%.*]] = ptrtoint ptr [[ARRAYIDX9]] to i64
// CHECK1-NEXT:    [[TMP9:%.*]] = ptrtoint ptr [[ARRAYIDX7]] to i64
...
// CHECK1-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[TMP1]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP16]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP18:%.*]] = ptrtoint ptr [[TMP17]] to i64
// CHECK1-NEXT:    [[TMP19:%.*]] = ptrtoint ptr [[ARRAYIDX7]] to i64
...
// CHECK1-NEXT:    store ptr [[TMP22]], ptr [[_TMP11]], align 8
...
// CHECK1-NEXT:    store ptr [[ARGC5]], ptr [[TMP23]], align 8
...
// CHECK1-NEXT:    [[DOTRD_INPUT_GEP_12:%.*]] = getelementptr inbounds nuw [2 x %struct.kmp_taskred_input_t], ptr [[DOTRD_INPUT_]], i64 0, i64 1
// CHECK1-NEXT:    [[TMP30:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[TMP1]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr inbounds nuw ptr, ptr [[TMP31]], i64 0
// CHECK1-NEXT:    [[TMP32:%.*]] = load ptr, ptr [[ARRAYIDX13]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX14:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP32]], i64 0
// CHECK1-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP34:%.*]] = sext i32 [[TMP33]] to i64
// CHECK1-NEXT:    [[LB_ADD_LEN15:%.*]] = add nsw i64 -1, [[TMP34]]
// CHECK1-NEXT:    [[TMP35:%.*]] = load ptr, ptr [[TMP1]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX16:%.*]] = getelementptr inbounds nuw ptr, ptr [[TMP35]], i64 9
// CHECK1-NEXT:    [[TMP36:%.*]] = load ptr, ptr [[ARRAYIDX16]], align 8, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP36]], i64 [[LB_ADD_LEN15]]
// CHECK1-NEXT:    store ptr [[VLA]], ptr [[TMP30]], align 8
// CHECK1-NEXT:    [[TMP37:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 1
// CHECK1-NEXT:    store ptr [[ARRAYIDX14]], ptr [[TMP37]], align 8
// CHECK1-NEXT:    [[TMP38:%.*]] = ptrtoint ptr [[ARRAYIDX17]] to i64
// CHECK1-NEXT:    [[TMP39:%.*]] = ptrtoint ptr [[ARRAYIDX14]] to i64
...
// CHECK1-NEXT:    [[TMP44:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 2
// CHECK1-NEXT:    store i64 [[TMP43]], ptr [[TMP44]], align 8
// CHECK1-NEXT:    [[TMP45:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 3
// CHECK1-NEXT:    store ptr @.red_init..1, ptr [[TMP45]], align 8
// CHECK1-NEXT:    [[TMP46:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 4
// CHECK1-NEXT:    store ptr null, ptr [[TMP46]], align 8
// CHECK1-NEXT:    [[TMP47:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 5
// CHECK1-NEXT:    store ptr @.red_comb..2, ptr [[TMP47]], align 8
// CHECK1-NEXT:    [[TMP48:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASKRED_INPUT_T]], ptr [[DOTRD_INPUT_GEP_12]], i32 0, i32 6
// CHECK1-NEXT:    store i32 1, ptr [[TMP48]], align 8
// CHECK1-NEXT:    [[TMP49:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP50:%.*]] = load i32, ptr [[TMP49]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP53:%.*]] = load i32, ptr [[TMP52]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[CMP20:%.*]] = icmp sle i64 [[TMP57]], [[TMP58]]
...
// CHECK1-NEXT:    [[TMP69:%.*]] = load ptr, ptr [[TMP68]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP74:%.*]] = load i32, ptr [[TMP73]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i64 [[TMP76]], 1
...
// CHECK1-NEXT:    [[TMP78:%.*]] = load i32, ptr [[TMP77]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP80:%.*]] = load i32, ptr [[TMP79]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    store ptr [[ARGC5]], ptr [[TMP81]], align 8
...
// CHECK1-NEXT:    [[TMP86:%.*]] = load i32, ptr [[TMP85]], align 4, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP88:%.*]] = load i32, ptr [[TMP0]], align 4, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP89:%.*]] = load i32, ptr [[ARGC5]], align 4
// CHECK1-NEXT:    [[ADD22:%.*]] = add nsw i32 [[TMP88]], [[TMP89]]
// CHECK1-NEXT:    store i32 [[ADD22]], ptr [[TMP0]], align 4
// CHECK1-NEXT:    [[TMP90:%.*]] = getelementptr i8, ptr [[ARRAYIDX7]], i64 [[TMP12]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAYIDX7]], [[TMP90]]
...
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST23]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP91]] to i32
// CHECK1-NEXT:    [[TMP92:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV24:%.*]] = sext i8 [[TMP92]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE28:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT27]], [[TMP90]]
...
// CHECK1-NEXT:    [[TMP93:%.*]] = load i32, ptr [[ARGC5]], align 4
// CHECK1-NEXT:    [[TMP94:%.*]] = atomicrmw add ptr [[TMP0]], i32 [[TMP93]] monotonic, align 4
// CHECK1-NEXT:    [[TMP95:%.*]] = getelementptr i8, ptr [[ARRAYIDX7]], i64 [[TMP12]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY30:%.*]] = icmp eq ptr [[ARRAYIDX7]], [[TMP95]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST32]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV34:%.*]] = sext i8 [[TMP96]] to i32
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP97:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY31]] ], [ [[TMP102:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP97]], ptr [[_TMP35]], align 1
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, ptr [[_TMP35]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV36:%.*]] = sext i8 [[TMP98]] to i32
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST32]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV37:%.*]] = sext i8 [[TMP99]] to i32
...
// CHECK1-NEXT:    [[TMP100:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP101:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST33]], i8 [[TMP97]], i8 [[TMP100]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[DOTFIRSTPRIV_PTR_ADDR_I]], align 8, !noalias [[META15]], !freeze_bits [[META3]]
