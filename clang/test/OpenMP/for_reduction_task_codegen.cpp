...
// CHECK1-NEXT:    [[CMP19:%.*]] = icmp sle i64 [[TMP57]], [[TMP58]]
...
// CHECK1-NEXT:    [[TMP72:%.*]] = load ptr, ptr [[DOTTASK_RED_]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i64 [[TMP76]], 1
...
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP88]], [[TMP89]]
...
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST22]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE27:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT26]], [[TMP90]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY29:%.*]] = icmp eq ptr [[ARRAYIDX7]], [[TMP95]]
...
// CHECK1-NEXT:    [[TMP96:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST31]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV33:%.*]] = sext i8 [[TMP96]] to i32
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP97:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY30]] ], [ [[TMP102:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP97]], ptr [[_TMP34]], align 1
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, ptr [[_TMP34]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV35:%.*]] = sext i8 [[TMP98]] to i32
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST31]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP101:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST32]], i8 [[TMP97]], i8 [[TMP100]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE41:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT39]], [[TMP95]]
