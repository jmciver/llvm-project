...
// CHECK-32-NEXT:    [[TMP1:%.*]] = load i32, ptr [[MYALLOC]], align 4, !noundef [[NOUNDEF4:![0-9]+]]
...
// CHECK-32-NEXT:    [[TMP2:%.*]] = load i32, ptr [[MYALLOC]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK-32-NEXT:    [[TMP3:%.*]] = load i32, ptr [[MYALLOC]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK-32-NEXT:    [[TMP4:%.*]] = load i32, ptr [[MYALLOC]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK-32-NEXT:    [[TMP5:%.*]] = load i32, ptr [[MYALLOC]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK-32-NEXT:    [[TMP6:%.*]] = load i32, ptr [[MYALLOC]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK-32-NEXT:    [[TMP1:%.*]] = load double, ptr [[ARRAYIDX]], align 8, !noundef [[NOUNDEF4]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr [[MYALLOC]], align 8, !noundef [[NOUNDEF3:![0-9]+]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[MYALLOC]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[MYALLOC]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load double, ptr [[ARRAYIDX]], align 16, !noundef [[NOUNDEF3]]
