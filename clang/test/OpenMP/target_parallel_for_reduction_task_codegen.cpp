...
// CHECK1-NEXT:    [[TMP53:%.*]] = load i64, ptr [[DOTOMP_UB]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP55:%.*]] = load i64, ptr [[DOTOMP_LB]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP62:%.*]] = load ptr, ptr [[_TMP5]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP68:%.*]] = load ptr, ptr [[TMP67]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP71:%.*]] = load ptr, ptr [[DOTTASK_RED_]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    store ptr [[TMP71]], ptr [[TMP70]], align 8
// CHECK1-NEXT:    [[TMP72:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP73:%.*]] = load i32, ptr [[TMP72]], align 4, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP74:%.*]] = call i32 @__kmpc_omp_task(ptr @[[GLOB1]], i32 [[TMP73]], ptr [[TMP65]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP75:%.*]] = load i64, ptr [[DOTOMP_IV]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP76:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP77:%.*]] = load i32, ptr [[TMP76]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP84:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP85:%.*]] = load i32, ptr [[TMP84]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP87:%.*]] = load i32, ptr [[TMP0]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP90:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST16]], align 1, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP90]] to i32
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP92:%.*]] = load i32, ptr [[ARGC1]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP95:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST25]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, ptr [[_TMP28]], align 1, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[TMP97]] to i32
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST25]], align 1, !noundef [[NOUNDEF3]]
