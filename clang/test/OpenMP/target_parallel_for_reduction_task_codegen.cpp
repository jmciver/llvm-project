...
// CHECK1-NEXT:    [[TMP71:%.*]] = load ptr, ptr [[DOTTASK_RED_]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i64 [[TMP75]], 1
...
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP87]], [[TMP88]]
...
// CHECK1-NEXT:    [[TMP90:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST22]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP90]] to i32
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV23:%.*]] = sext i8 [[TMP91]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE27:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT26]], [[TMP89]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY29:%.*]] = icmp eq ptr [[ARRAYIDX7]], [[TMP94]]
...
// CHECK1-NEXT:    [[TMP95:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST31]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV33:%.*]] = sext i8 [[TMP95]] to i32
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP96:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY30]] ], [ [[TMP101:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP96]], ptr [[_TMP34]], align 1
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, ptr [[_TMP34]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV35:%.*]] = sext i8 [[TMP97]] to i32
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST31]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP100:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST32]], i8 [[TMP96]], i8 [[TMP99]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE41:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT39]], [[TMP94]]
