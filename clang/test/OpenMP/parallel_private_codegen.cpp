...
// CHECK1-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    store i32 [[FREEZE_POISON2]], ptr [[C]], align 4
// CHECK3-NEXT:    store ptr [[C]], ptr [[_TMP3]], align 8
// CHECK3-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META3]]
...
// CHECK3-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[BLOCK_CAPTURED2:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, i32, [92 x i8], i32 }>, ptr [[BLOCK]], i32 0, i32 5
...
// CHECK4-NEXT:    [[BLOCK_CAPTURED4:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, ptr, ptr, ptr, i32 }>, ptr [[BLOCK]], i32 0, i32 8
// CHECK4-NEXT:    [[TMP2:%.*]] = load i32, ptr [[B]], align 4
// CHECK4-NEXT:    store i32 [[TMP2]], ptr [[BLOCK_CAPTURED4]], align 8
// CHECK4-NEXT:    [[BLOCK_CAPTURED5:%.*]] = getelementptr inbounds <{ ptr, i32, i32, ptr, ptr, ptr, ptr, ptr, i32 }>, ptr [[BLOCK]], i32 0, i32 7
// CHECK4-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
...
// CHECK4-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[_TMP3]], align 8, !freeze_bits [[META3]]
