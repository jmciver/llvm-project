...
// CHECK1-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP10]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i64 [[TMP13]], i64 [[TMP15]], ptr [[G6]], ptr [[TMP16]], ptr [[SVAR11]], ptr [[SFVAR13]]), !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load double, ptr [[TMP24]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP4:%.*]] = load double, ptr [[TMP3]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l67.omp_outlined.omp_outlined, i32 [[TMP12]], i32 [[TMP13]], ptr [[G6]], ptr [[TMP14]], ptr [[SVAR11]], ptr [[SFVAR13]]), !llvm.access.group [[ACC_GRP6]]
...
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP6:![0-9]+]]
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK9-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_COMB_LB]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK9-NEXT:    [[TMP14:%.*]] = zext i32 [[TMP13]] to i64
// CHECK9-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK9-NEXT:    [[TMP16:%.*]] = zext i32 [[TMP15]] to i64
// CHECK9-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
// CHECK9-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l110.omp_outlined.omp_outlined, i64 [[TMP14]], i64 [[TMP16]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP17]], ptr [[SVAR12]]), !llvm.access.group [[ACC_GRP6]]
...
// CHECK9-NEXT:    [[TMP28:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP15]]
...
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_END:%.*]]
// CHECK9:       omp.inner.for.body:
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_COMB_LB]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[TMP13:%.*]] = zext i32 [[TMP12]] to i64
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[TMP15:%.*]] = zext i32 [[TMP14]] to i64
// CHECK9-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP11]], align 8, !llvm.access.group [[ACC_GRP15]], !freeze_bits [[META5]]
// CHECK9-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiET_v_l49.omp_outlined.omp_outlined, i64 [[TMP13]], i64 [[TMP15]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP16]]), !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP15]]
// CHECK9-NEXT:    [[TMP18:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4, !llvm.access.group [[ACC_GRP15]]
...
// CHECK9-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK11-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP7:![0-9]+]]
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP7]]
...
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_COMB_LB]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK11-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 4, !llvm.access.group [[ACC_GRP7]], !freeze_bits [[META6]]
// CHECK11-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 7, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l110.omp_outlined.omp_outlined, i32 [[TMP13]], i32 [[TMP14]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP15]], ptr [[SVAR12]]), !llvm.access.group [[ACC_GRP7]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP7]]
// CHECK11-NEXT:    [[TMP17:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4, !llvm.access.group [[ACC_GRP7]]
...
// CHECK11-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !freeze_bits [[META6]]
...
// CHECK11-NEXT:    [[TMP11:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP16]]
...
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_END:%.*]]
// CHECK11:       omp.inner.for.body:
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[DOTOMP_COMB_LB]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, ptr [[DOTOMP_COMB_UB]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 4, !llvm.access.group [[ACC_GRP16]], !freeze_bits [[META6]]
// CHECK11-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB3]], i32 6, ptr @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z5tmainIiET_v_l49.omp_outlined.omp_outlined, i32 [[TMP12]], i32 [[TMP13]], ptr [[VEC8]], ptr [[T_VAR6]], ptr [[S_ARR9]], ptr [[TMP14]]), !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP16]]
// CHECK11-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_STRIDE]], align 4, !llvm.access.group [[ACC_GRP16]]
...
// CHECK13-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[TMP]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP4]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP9:%.*]] = load i32, ptr [[T_VAR10]], align 4, !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP15]], align 8, !llvm.access.group [[ACC_GRP3]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX18]], ptr align 4 [[TMP11]], i64 4, i1 false), !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    store i32 [[ADD19]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP3]]
...
// CHECK15-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[TMP]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[_TMP4]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP9:%.*]] = load i32, ptr [[T_VAR10]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP15]], align 4, !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META3]]
...
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP11]], i32 4, i1 false), !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    store i32 [[ADD18]], ptr [[DOTOMP_IV]], align 4, !llvm.access.group [[ACC_GRP4]]
