...
// CHECK1-NEXT:    store i64 [[FREEZE_POISON12]], ptr [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[_TMP13:%.*]] = alloca i64, align 8
...
// CHECK1-NEXT:    [[CMP19:%.*]] = icmp sle i64 [[TMP56]], [[TMP57]]
...
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i32 [[TMP74]], [[TMP75]]
// CHECK1-NEXT:    store i32 [[ADD20]], ptr [[TMP0]], align 4
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST21:%.*]] = phi ptr [ [[ARRAYIDX2]], [[DOTOMP_REDUCTION_CASE1]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT25:%.*]], [[OMP_ARRAYCPY_BODY]] ]
// CHECK1-NEXT:    [[TMP77:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST21]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP77]] to i32
// CHECK1-NEXT:    [[TMP78:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV22:%.*]] = sext i8 [[TMP78]] to i32
// CHECK1-NEXT:    [[ADD23:%.*]] = add nsw i32 [[CONV]], [[CONV22]]
// CHECK1-NEXT:    [[CONV24:%.*]] = trunc i32 [[ADD23]] to i8
// CHECK1-NEXT:    store i8 [[CONV24]], ptr [[OMP_ARRAYCPY_DESTELEMENTPAST21]], align 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT25]] = getelementptr i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST21]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT]] = getelementptr i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE26:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT25]], [[TMP76]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY28:%.*]] = icmp eq ptr [[ARRAYIDX2]], [[TMP81]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_ISEMPTY28]], label [[OMP_ARRAYCPY_DONE41:%.*]], label [[OMP_ARRAYCPY_BODY29:%.*]]
// CHECK1:       omp.arraycpy.body29:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRCELEMENTPAST30:%.*]] = phi ptr [ [[VLA]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_SRC_ELEMENT39:%.*]], [[ATOMIC_EXIT:%.*]] ]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST31:%.*]] = phi ptr [ [[ARRAYIDX2]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT38:%.*]], [[ATOMIC_EXIT]] ]
// CHECK1-NEXT:    [[TMP82:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST30]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV32:%.*]] = sext i8 [[TMP82]] to i32
// CHECK1-NEXT:    [[ATOMIC_LOAD:%.*]] = load atomic i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST31]] monotonic, align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP83:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY29]] ], [ [[TMP88:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP83]], ptr [[_TMP33]], align 1
// CHECK1-NEXT:    [[TMP84:%.*]] = load i8, ptr [[_TMP33]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV34:%.*]] = sext i8 [[TMP84]] to i32
// CHECK1-NEXT:    [[TMP85:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST30]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV35:%.*]] = sext i8 [[TMP85]] to i32
// CHECK1-NEXT:    [[ADD36:%.*]] = add nsw i32 [[CONV34]], [[CONV35]]
// CHECK1-NEXT:    [[CONV37:%.*]] = trunc i32 [[ADD36]] to i8
// CHECK1-NEXT:    store i8 [[CONV37]], ptr [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP86:%.*]] = load i8, ptr [[ATOMIC_TEMP]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[TMP87:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST31]], i8 [[TMP83]], i8 [[TMP86]] monotonic monotonic, align 1
...
// CHECK1:       atomic_exit:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT38]] = getelementptr i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST31]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT39]] = getelementptr i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST30]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE40:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT38]], [[TMP81]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE40]], label [[OMP_ARRAYCPY_DONE41]], label [[OMP_ARRAYCPY_BODY29]]
...
// CHECK1-NEXT:    [[CMP19:%.*]] = icmp sle i64 [[TMP58]], [[TMP59]]
...
// CHECK1-NEXT:    [[TMP73:%.*]] = load ptr, ptr [[DOTTASK_RED_]], align 8, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[ADD20:%.*]] = add nsw i64 [[TMP77]], 1
...
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP89]], [[TMP90]]
...
// CHECK1:       omp.arraycpy.body:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRCELEMENTPAST:%.*]] = phi ptr [ [[VLA]], [[DOTOMP_REDUCTION_CASE1]] ], [ [[OMP_ARRAYCPY_SRC_ELEMENT:%.*]], [[OMP_ARRAYCPY_BODY]] ]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST22:%.*]] = phi ptr [ [[ARRAYIDX7]], [[DOTOMP_REDUCTION_CASE1]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT26:%.*]], [[OMP_ARRAYCPY_BODY]] ]
// CHECK1-NEXT:    [[TMP92:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST22]], align 1, !freeze_bits [[META3]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT]] = getelementptr i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE27:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT26]], [[TMP91]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY29:%.*]] = icmp eq ptr [[ARRAYIDX7]], [[TMP96]]
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST32:%.*]] = phi ptr [ [[ARRAYIDX7]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT39:%.*]], [[ATOMIC_EXIT]] ]
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST31]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV33:%.*]] = sext i8 [[TMP97]] to i32
// CHECK1-NEXT:    [[ATOMIC_LOAD:%.*]] = load atomic i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST32]] monotonic, align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP98:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY30]] ], [ [[TMP103:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP98]], ptr [[_TMP34]], align 1
// CHECK1-NEXT:    [[TMP99:%.*]] = load i8, ptr [[_TMP34]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV35:%.*]] = sext i8 [[TMP99]] to i32
// CHECK1-NEXT:    [[TMP100:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST31]], align 1, !freeze_bits [[META3]]
// CHECK1-NEXT:    [[CONV36:%.*]] = sext i8 [[TMP100]] to i32
...
// CHECK1-NEXT:    [[TMP102:%.*]] = cmpxchg ptr [[OMP_ARRAYCPY_DESTELEMENTPAST32]], i8 [[TMP98]], i8 [[TMP101]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE41:%.*]] = icmp eq ptr [[OMP_ARRAYCPY_DEST_ELEMENT39]], [[TMP96]]
