...
// CHECK1-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META5]]
