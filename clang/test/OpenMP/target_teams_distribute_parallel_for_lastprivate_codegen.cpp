...
// CHECK1-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP13:%.*]] = load volatile double, ptr [[TMP12]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store double [[TMP13]], ptr [[G1_CASTED]], align 8
// CHECK1-NEXT:    [[TMP14:%.*]] = load i64, ptr [[G1_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store i32 [[TMP15]], ptr [[SVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP16:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP17:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META4]]
// CHECK1-NEXT:    store float [[TMP17]], ptr [[SFVAR_CASTED]], align 4
// CHECK1-NEXT:    [[TMP18:%.*]] = load i64, ptr [[SFVAR_CASTED]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store double [[TMP19]], ptr [[G_CASTED]], align 8
// CHECK1-NEXT:    [[TMP20:%.*]] = load i64, ptr [[G_CASTED]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP25:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP25]], ptr [[G_ADDR]], align 8
// CHECK1-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP27:%.*]] = load double, ptr [[TMP26]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP27]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store i32 [[TMP28]], ptr [[SVAR_ADDR]], align 4
// CHECK1-NEXT:    [[TMP29:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double 1.000000e+00, ptr [[TMP11]], align 8
// CHECK1-NEXT:    store i32 3, ptr [[SVAR10]], align 4
// CHECK1-NEXT:    store float 4.000000e+00, ptr [[SFVAR12]], align 4
...
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store ptr [[SVAR10]], ptr [[TMP15]], align 8
// CHECK1-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR12]], ptr [[TMP16]], align 8
...
// CHECK1:       .omp.lastprivate.then:
// CHECK1-NEXT:    [[TMP20:%.*]] = load double, ptr [[G7]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP20]], ptr [[G_ADDR]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP9]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR10]], align 4
// CHECK1-NEXT:    store i32 [[TMP23]], ptr [[SVAR_ADDR]], align 4
// CHECK1-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR12]], align 4, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP13:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK3-NEXT:    store i32 [[TMP13]], ptr [[SVAR_CASTED]], align 4
// CHECK3-NEXT:    [[TMP14:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP15:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    store float [[TMP15]], ptr [[SFVAR_CASTED]], align 4
// CHECK3-NEXT:    [[TMP16:%.*]] = load i32, ptr [[SFVAR_CASTED]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP21:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP21]], ptr [[TMP1]], align 8
// CHECK3-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    [[TMP23:%.*]] = load double, ptr [[TMP22]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP23]], ptr [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK3-NEXT:    store i32 [[TMP24]], ptr [[SVAR_ADDR]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double 1.000000e+00, ptr [[TMP13]], align 4
// CHECK3-NEXT:    store i32 3, ptr [[SVAR9]], align 4
// CHECK3-NEXT:    store float 4.000000e+00, ptr [[SFVAR11]], align 4
...
// CHECK3-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR9]], ptr [[TMP17]], align 4
// CHECK3-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR11]], ptr [[TMP18]], align 4
...
// CHECK3:       .omp.lastprivate.then:
// CHECK3-NEXT:    [[TMP22:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP22]], ptr [[TMP1]], align 8
// CHECK3-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK3-NEXT:    store i32 [[TMP25]], ptr [[SVAR_ADDR]], align 4
// CHECK3-NEXT:    [[TMP26:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META5]]
...
// CHECK5-NEXT:    [[TMP16:%.*]] = load i64, ptr [[T_VAR_CASTED]], align 8, !freeze_bits [[META5]]
// CHECK5-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
// CHECK5-NEXT:    [[TMP18:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK5-NEXT:    store i32 [[TMP18]], ptr [[SVAR_CASTED]], align 4
// CHECK5-NEXT:    [[TMP19:%.*]] = load i64, ptr [[SVAR_CASTED]], align 8, !freeze_bits [[META5]]
...
// CHECK5-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP12]], align 8, !freeze_bits [[META5]]
...
// CHECK5-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP12]], align 8, !freeze_bits [[META5]]
...
// CHECK5-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK7-NEXT:    [[TMP14:%.*]] = load i32, ptr [[T_VAR_CASTED]], align 4, !freeze_bits [[META6]]
// CHECK7-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
// CHECK7-NEXT:    [[TMP16:%.*]] = load i32, ptr [[SVAR12]], align 4
// CHECK7-NEXT:    store i32 [[TMP16]], ptr [[SVAR_CASTED]], align 4
// CHECK7-NEXT:    [[TMP17:%.*]] = load i32, ptr [[SVAR_CASTED]], align 4, !freeze_bits [[META6]]
...
// CHECK7-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK7-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
...
// CHECK7-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[_TMP11]], align 4, !freeze_bits [[META6]]
