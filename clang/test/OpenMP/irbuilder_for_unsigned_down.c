...
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[CONV:%.*]] = uitofp i32 [[TMP9]] to float
// CHECK-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[A_ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK:       cond.true:
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[DOTSTART]], align 4, !noundef [[NOUNDEF3]]
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[DOTSTOP]], align 4, !noundef [[NOUNDEF3]]
