...
// CHECK1-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK1-NEXT:    [[TMP12:%.*]] = load i32, ptr [[J]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF5]]
// CHECK3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [123 x [456 x i32]], ptr [[A]], i32 0, i32 [[TMP11]]
// CHECK3-NEXT:    [[TMP12:%.*]] = load i32, ptr [[J]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[J]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK11-NEXT:    [[TMP27:%.*]] = load i32, ptr [[I11]], align 4, !noundef [[NOUNDEF6]]
// CHECK11-NEXT:    [[TMP28:%.*]] = mul nsw i32 [[TMP27]], [[TMP3]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[TMP4]], i32 [[TMP28]]
// CHECK11-NEXT:    [[TMP29:%.*]] = load i32, ptr [[J12]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP9:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !noundef [[NOUNDEF6]]
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x [2 x i32]], ptr [[TMP0]], i32 0, i32 [[TMP11]]
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[J]], align 4, !noundef [[NOUNDEF6]]
