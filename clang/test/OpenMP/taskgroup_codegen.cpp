...
// CHECK1:       invoke.cont:
// CHECK1-NEXT:    call void @__kmpc_end_taskgroup(ptr @[[GLOB1]], i32 [[TMP0]])
// CHECK1-NEXT:    [[TMP1:%.*]] = load i8, ptr [[A]], align 1, !noundef [[NOUNDEF3:![0-9]+]]
...
// DEBUG1-NEXT:    [[TMP1:%.*]] = load i8, ptr [[A]], align 1, !dbg [[DBG18:![0-9]+]], !noundef [[NOUNDEF9:![0-9]+]]
...
// DEBUG1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !dbg [[DBG24:![0-9]+]], !noundef [[NOUNDEF9]]
// DEBUG1-NEXT:    [[TMP1:%.*]] = load i32, ptr [[TMP0]], align 4, !dbg [[DBG24]], !noundef [[NOUNDEF9]]
...
// CHECK2-NEXT:    [[TMP0:%.*]] = load i8, ptr [[A]], align 1, !noundef [[NOUNDEF3:![0-9]+]]
