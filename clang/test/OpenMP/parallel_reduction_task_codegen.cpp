...
// CHECK1-NEXT:    [[TMP54:%.*]] = load ptr, ptr [[TMP]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    store ptr [[TMP54]], ptr [[TMP53]], align 8
// CHECK1-NEXT:    [[TMP55:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[TMP56:%.*]] = load i32, ptr [[TMP55]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP60:%.*]] = load ptr, ptr [[TMP59]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP63:%.*]] = load ptr, ptr [[DOTTASK_RED_]], align 8, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP76:%.*]] = load i32, ptr [[TMP0]], align 4, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP79:%.*]] = load i8, ptr [[OMP_ARRAYCPY_DESTELEMENTPAST12]], align 1, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP79]] to i32
// CHECK1-NEXT:    [[TMP80:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP84:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !noundef [[NOUNDEF3]]
...
// CHECK1-NEXT:    [[TMP86:%.*]] = load i8, ptr [[_TMP24]], align 1, !noundef [[NOUNDEF3]]
// CHECK1-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP86]] to i32
// CHECK1-NEXT:    [[TMP87:%.*]] = load i8, ptr [[OMP_ARRAYCPY_SRCELEMENTPAST21]], align 1, !noundef [[NOUNDEF3]]
