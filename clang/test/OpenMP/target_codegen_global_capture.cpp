...
// CHECK1-NEXT:    [[TMP1:%.*]] = load i64, ptr [[B_CASTED]], align 8, !freeze_bits [[META6:![0-9]+]]
// CHECK1-NEXT:    [[TMP2:%.*]] = load double, ptr @Gb, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP2]], ptr [[GB_CASTED]], align 8
// CHECK1-NEXT:    [[TMP3:%.*]] = load i64, ptr [[GB_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP4:%.*]] = load float, ptr @_ZZ3foossssE2Sb, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP4]], ptr [[SB_CASTED]], align 4
// CHECK1-NEXT:    [[TMP5:%.*]] = load i64, ptr [[SB_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP6:%.*]] = load double, ptr @Gc, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP6]], ptr [[GC_CASTED]], align 8
// CHECK1-NEXT:    [[TMP7:%.*]] = load i64, ptr [[GC_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP8:%.*]] = load i16, ptr [[C_ADDR]], align 2
// CHECK1-NEXT:    store i16 [[TMP8]], ptr [[C_CASTED]], align 2
// CHECK1-NEXT:    [[TMP9:%.*]] = load i64, ptr [[C_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP10:%.*]] = load float, ptr @_ZZ3foossssE2Sc, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP10]], ptr [[SC_CASTED]], align 4
// CHECK1-NEXT:    [[TMP11:%.*]] = load i64, ptr [[SC_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP12:%.*]] = load i16, ptr [[D_ADDR]], align 2
// CHECK1-NEXT:    store i16 [[TMP12]], ptr [[D_CASTED]], align 2
// CHECK1-NEXT:    [[TMP13:%.*]] = load i64, ptr [[D_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP14:%.*]] = load double, ptr @Gd, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP14]], ptr [[GD_CASTED]], align 8
// CHECK1-NEXT:    [[TMP15:%.*]] = load i64, ptr [[GD_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP16:%.*]] = load float, ptr @_ZZ3foossssE2Sd, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP16]], ptr [[SD_CASTED]], align 4
// CHECK1-NEXT:    [[TMP17:%.*]] = load i64, ptr [[SD_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr @Ga, align 8, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP20:%.*]] = load float, ptr @_ZZ3foossssE2Sa, align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP69:%.*]] = load float, ptr @_ZZ3foossssE2Sa, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV11:%.*]] = fptosi float [[TMP69]] to i32
// CHECK1-NEXT:    [[ADD12:%.*]] = add nsw i32 [[ADD10]], [[CONV11]]
// CHECK1-NEXT:    [[TMP70:%.*]] = load float, ptr @_ZZ3foossssE2Sb, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV13:%.*]] = fptosi float [[TMP70]] to i32
// CHECK1-NEXT:    [[ADD14:%.*]] = add nsw i32 [[ADD12]], [[CONV13]]
// CHECK1-NEXT:    [[TMP71:%.*]] = load float, ptr @_ZZ3foossssE2Sc, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV15:%.*]] = fptosi float [[TMP71]] to i32
// CHECK1-NEXT:    [[ADD16:%.*]] = add nsw i32 [[ADD14]], [[CONV15]]
// CHECK1-NEXT:    [[TMP72:%.*]] = load float, ptr @_ZZ3foossssE2Sd, align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP1:%.*]] = load i16, ptr [[B_ADDR]], align 2, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP2:%.*]] = load double, ptr [[GB_ADDR]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[ADD2:%.*]] = fadd double [[TMP2]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD2]], ptr [[GB_ADDR]], align 8
// CHECK1-NEXT:    [[TMP3:%.*]] = load float, ptr [[SB_ADDR]], align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load double, ptr [[GC_ADDR]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CMP:%.*]] = fcmp ogt double [[TMP4]], 0.000000e+00
// CHECK1-NEXT:    br i1 [[CMP]], label [[LAND_LHS_TRUE:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK1:       land.lhs.true:
// CHECK1-NEXT:    [[TMP5:%.*]] = load i16, ptr [[C_ADDR]], align 2, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP6:%.*]] = load float, ptr [[SC_ADDR]], align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP3:%.*]] = load i16, ptr [[TMP0]], align 2, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i16 [[TMP3]] to i32
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV]], 1
// CHECK1-NEXT:    [[CONV1:%.*]] = trunc i32 [[ADD]] to i16
// CHECK1-NEXT:    store i16 [[CONV1]], ptr [[TMP0]], align 2
// CHECK1-NEXT:    [[TMP4:%.*]] = load double, ptr [[TMP1]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[ADD2:%.*]] = fadd double [[TMP4]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD2]], ptr [[TMP1]], align 8
// CHECK1-NEXT:    [[TMP5:%.*]] = load float, ptr [[TMP2]], align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load float, ptr @_ZZ3barssssE2Sa, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV6:%.*]] = fptosi float [[TMP4]] to i32
// CHECK1-NEXT:    [[ADD7:%.*]] = add nsw i32 [[ADD5]], [[CONV6]]
// CHECK1-NEXT:    [[TMP5:%.*]] = load float, ptr @_ZZ3barssssE2Sb, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV8:%.*]] = fptosi float [[TMP5]] to i32
// CHECK1-NEXT:    [[ADD9:%.*]] = add nsw i32 [[ADD7]], [[CONV8]]
// CHECK1-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ3barssssE2Sc, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV10:%.*]] = fptosi float [[TMP6]] to i32
// CHECK1-NEXT:    [[ADD11:%.*]] = add nsw i32 [[ADD9]], [[CONV10]]
// CHECK1-NEXT:    [[TMP7:%.*]] = load float, ptr @_ZZ3barssssE2Sd, align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[TMP4:%.*]] = load i16, ptr [[TMP1]], align 2, !freeze_bits [[META6]]
// CHECK1-NEXT:    store i16 [[TMP4]], ptr [[B_CASTED]], align 2
// CHECK1-NEXT:    [[TMP5:%.*]] = load i64, ptr [[B_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP6:%.*]] = load double, ptr @Gb, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP6]], ptr [[GB_CASTED]], align 8
// CHECK1-NEXT:    [[TMP7:%.*]] = load i64, ptr [[GB_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP8:%.*]] = load float, ptr @_ZZ3barssssE2Sb, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP8]], ptr [[SB_CASTED]], align 4
// CHECK1-NEXT:    [[TMP9:%.*]] = load i64, ptr [[SB_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP10:%.*]] = load double, ptr @Gc, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP10]], ptr [[GC_CASTED]], align 8
// CHECK1-NEXT:    [[TMP11:%.*]] = load i64, ptr [[GC_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP12:%.*]] = load i16, ptr [[TMP2]], align 2, !freeze_bits [[META6]]
// CHECK1-NEXT:    store i16 [[TMP12]], ptr [[C_CASTED]], align 2
// CHECK1-NEXT:    [[TMP13:%.*]] = load i64, ptr [[C_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP14:%.*]] = load float, ptr @_ZZ3barssssE2Sc, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP14]], ptr [[SC_CASTED]], align 4
// CHECK1-NEXT:    [[TMP15:%.*]] = load i64, ptr [[SC_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP16:%.*]] = load i16, ptr [[TMP3]], align 2, !freeze_bits [[META6]]
// CHECK1-NEXT:    store i16 [[TMP16]], ptr [[D_CASTED]], align 2
// CHECK1-NEXT:    [[TMP17:%.*]] = load i64, ptr [[D_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr @Gd, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP18]], ptr [[GD_CASTED]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load i64, ptr [[GD_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load float, ptr @_ZZ3barssssE2Sd, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP20]], ptr [[SD_CASTED]], align 4
// CHECK1-NEXT:    [[TMP21:%.*]] = load i64, ptr [[SD_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load double, ptr @Ga, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CMP:%.*]] = fcmp ogt double [[TMP22]], 0.000000e+00
// CHECK1-NEXT:    br i1 [[CMP]], label [[LAND_LHS_TRUE:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK1:       land.lhs.true:
// CHECK1-NEXT:    [[TMP23:%.*]] = load i16, ptr [[TMP0]], align 2, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV:%.*]] = sext i16 [[TMP23]] to i32
// CHECK1-NEXT:    [[CMP1:%.*]] = icmp sgt i32 [[CONV]], 0
// CHECK1-NEXT:    br i1 [[CMP1]], label [[LAND_LHS_TRUE2:%.*]], label [[OMP_IF_ELSE]]
// CHECK1:       land.lhs.true2:
// CHECK1-NEXT:    [[TMP24:%.*]] = load float, ptr @_ZZ3barssssE2Sa, align 4, !freeze_bits [[META6]]
...
// CHECK1-NEXT:    [[CONV4:%.*]] = sext i16 [[TMP3]] to i32
// CHECK1-NEXT:    [[ADD5:%.*]] = add nsw i32 [[ADD3]], [[CONV4]]
// CHECK1-NEXT:    [[TMP4:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sa, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV6:%.*]] = fptosi float [[TMP4]] to i32
// CHECK1-NEXT:    [[ADD7:%.*]] = add nsw i32 [[ADD5]], [[CONV6]]
// CHECK1-NEXT:    [[TMP5:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sb, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV8:%.*]] = fptosi float [[TMP5]] to i32
// CHECK1-NEXT:    [[ADD9:%.*]] = add nsw i32 [[ADD7]], [[CONV8]]
// CHECK1-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sc, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV10:%.*]] = fptosi float [[TMP6]] to i32
// CHECK1-NEXT:    [[ADD11:%.*]] = add nsw i32 [[ADD9]], [[CONV10]]
// CHECK1-NEXT:    [[TMP7:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sd, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV12:%.*]] = fptosi float [[TMP7]] to i32
// CHECK1-NEXT:    [[ADD13:%.*]] = add nsw i32 [[ADD11]], [[CONV12]]
// CHECK1-NEXT:    ret i32 [[ADD13]]
//
...
// CHECK1-NEXT:    store double [[TMP6]], ptr [[GB_CASTED]], align 8
// CHECK1-NEXT:    [[TMP7:%.*]] = load i64, ptr [[GB_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP8:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sb, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP8]], ptr [[SB_CASTED]], align 4
// CHECK1-NEXT:    [[TMP9:%.*]] = load i64, ptr [[SB_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP10:%.*]] = load double, ptr @Gc, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    store double [[TMP10]], ptr [[GC_CASTED]], align 8
...
// CHECK1-NEXT:    store i16 [[TMP12]], ptr [[C_CASTED]], align 2
// CHECK1-NEXT:    [[TMP13:%.*]] = load i64, ptr [[C_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP14:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sc, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP14]], ptr [[SC_CASTED]], align 4
// CHECK1-NEXT:    [[TMP15:%.*]] = load i64, ptr [[SC_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP16:%.*]] = load i16, ptr [[TMP3]], align 2, !freeze_bits [[META6]]
// CHECK1-NEXT:    store i16 [[TMP16]], ptr [[D_CASTED]], align 2
...
// CHECK1-NEXT:    store double [[TMP18]], ptr [[GD_CASTED]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load i64, ptr [[GD_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sd, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    store float [[TMP20]], ptr [[SD_CASTED]], align 4
// CHECK1-NEXT:    [[TMP21:%.*]] = load i64, ptr [[SD_CASTED]], align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load double, ptr @Ga, align 8, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CMP:%.*]] = fcmp ogt double [[TMP22]], 0.000000e+00
...
// CHECK1-NEXT:    br i1 [[CMP1]], label [[LAND_LHS_TRUE2:%.*]], label [[OMP_IF_ELSE]]
// CHECK1:       land.lhs.true2:
// CHECK1-NEXT:    [[TMP24:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sa, align 4, !freeze_bits [[META6]]
// CHECK1-NEXT:    [[CONV3:%.*]] = fpext float [[TMP24]] to double
// CHECK1-NEXT:    [[CMP4:%.*]] = fcmp ogt double [[CONV3]], 0.000000e+00
// CHECK1-NEXT:    br i1 [[CMP4]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE]]
// CHECK1:       omp_if.then:
...
// CHECK3-NEXT:    [[TMP1:%.*]] = load i32, ptr [[B_CASTED]], align 4, !freeze_bits [[META7:![0-9]+]]
// CHECK3-NEXT:    [[TMP2:%.*]] = load float, ptr @_ZZ3foossssE2Sb, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP2]], ptr [[SB_CASTED]], align 4
// CHECK3-NEXT:    [[TMP3:%.*]] = load i32, ptr [[SB_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP4:%.*]] = load i16, ptr [[C_ADDR]], align 2
// CHECK3-NEXT:    store i16 [[TMP4]], ptr [[C_CASTED]], align 2
// CHECK3-NEXT:    [[TMP5:%.*]] = load i32, ptr [[C_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ3foossssE2Sc, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP6]], ptr [[SC_CASTED]], align 4
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[SC_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP8:%.*]] = load i16, ptr [[D_ADDR]], align 2
// CHECK3-NEXT:    store i16 [[TMP8]], ptr [[D_CASTED]], align 2
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[D_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load float, ptr @_ZZ3foossssE2Sd, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP10]], ptr [[SD_CASTED]], align 4
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[SD_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP12:%.*]] = load double, ptr @Ga, align 8, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP14:%.*]] = load float, ptr @_ZZ3foossssE2Sa, align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP63:%.*]] = load float, ptr @_ZZ3foossssE2Sa, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV11:%.*]] = fptosi float [[TMP63]] to i32
// CHECK3-NEXT:    [[ADD12:%.*]] = add nsw i32 [[ADD10]], [[CONV11]]
// CHECK3-NEXT:    [[TMP64:%.*]] = load float, ptr @_ZZ3foossssE2Sb, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV13:%.*]] = fptosi float [[TMP64]] to i32
// CHECK3-NEXT:    [[ADD14:%.*]] = add nsw i32 [[ADD12]], [[CONV13]]
// CHECK3-NEXT:    [[TMP65:%.*]] = load float, ptr @_ZZ3foossssE2Sc, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV15:%.*]] = fptosi float [[TMP65]] to i32
// CHECK3-NEXT:    [[ADD16:%.*]] = add nsw i32 [[ADD14]], [[CONV15]]
// CHECK3-NEXT:    [[TMP66:%.*]] = load float, ptr @_ZZ3foossssE2Sd, align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP4:%.*]] = load double, ptr [[TMP1]], align 8, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP5:%.*]] = load double, ptr [[TMP2]], align 8, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP6:%.*]] = load double, ptr [[TMP3]], align 8, !freeze_bits [[META7]]
// CHECK3-NEXT:    store double [[TMP6]], ptr [[GD4]], align 8
// CHECK3-NEXT:    [[TMP7:%.*]] = load i16, ptr [[B_ADDR]], align 2, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP9:%.*]] = load float, ptr [[SB_ADDR]], align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    br i1 [[CMP]], label [[LAND_LHS_TRUE:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK3:       land.lhs.true:
// CHECK3-NEXT:    [[TMP11:%.*]] = load i16, ptr [[C_ADDR]], align 2, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP12:%.*]] = load float, ptr [[SC_ADDR]], align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP3:%.*]] = load i16, ptr [[TMP0]], align 2, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP5:%.*]] = load float, ptr [[TMP2]], align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP4:%.*]] = load float, ptr @_ZZ3barssssE2Sa, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV6:%.*]] = fptosi float [[TMP4]] to i32
// CHECK3-NEXT:    [[ADD7:%.*]] = add nsw i32 [[ADD5]], [[CONV6]]
// CHECK3-NEXT:    [[TMP5:%.*]] = load float, ptr @_ZZ3barssssE2Sb, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV8:%.*]] = fptosi float [[TMP5]] to i32
// CHECK3-NEXT:    [[ADD9:%.*]] = add nsw i32 [[ADD7]], [[CONV8]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ3barssssE2Sc, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV10:%.*]] = fptosi float [[TMP6]] to i32
// CHECK3-NEXT:    [[ADD11:%.*]] = add nsw i32 [[ADD9]], [[CONV10]]
// CHECK3-NEXT:    [[TMP7:%.*]] = load float, ptr @_ZZ3barssssE2Sd, align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[TMP4:%.*]] = load i16, ptr [[TMP1]], align 2, !freeze_bits [[META7]]
// CHECK3-NEXT:    store i16 [[TMP4]], ptr [[B_CASTED]], align 2
// CHECK3-NEXT:    [[TMP5:%.*]] = load i32, ptr [[B_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ3barssssE2Sb, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP6]], ptr [[SB_CASTED]], align 4
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[SB_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP8:%.*]] = load i16, ptr [[TMP2]], align 2, !freeze_bits [[META7]]
// CHECK3-NEXT:    store i16 [[TMP8]], ptr [[C_CASTED]], align 2
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[C_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load float, ptr @_ZZ3barssssE2Sc, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP10]], ptr [[SC_CASTED]], align 4
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[SC_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP12:%.*]] = load i16, ptr [[TMP3]], align 2, !freeze_bits [[META7]]
// CHECK3-NEXT:    store i16 [[TMP12]], ptr [[D_CASTED]], align 2
// CHECK3-NEXT:    [[TMP13:%.*]] = load i32, ptr [[D_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP14:%.*]] = load float, ptr @_ZZ3barssssE2Sd, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP14]], ptr [[SD_CASTED]], align 4
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[SD_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP16:%.*]] = load double, ptr @Ga, align 8, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CMP:%.*]] = fcmp ogt double [[TMP16]], 0.000000e+00
// CHECK3-NEXT:    br i1 [[CMP]], label [[LAND_LHS_TRUE:%.*]], label [[OMP_IF_ELSE:%.*]]
// CHECK3:       land.lhs.true:
// CHECK3-NEXT:    [[TMP17:%.*]] = load i16, ptr [[TMP0]], align 2, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV:%.*]] = sext i16 [[TMP17]] to i32
// CHECK3-NEXT:    [[CMP1:%.*]] = icmp sgt i32 [[CONV]], 0
// CHECK3-NEXT:    br i1 [[CMP1]], label [[LAND_LHS_TRUE2:%.*]], label [[OMP_IF_ELSE]]
// CHECK3:       land.lhs.true2:
// CHECK3-NEXT:    [[TMP18:%.*]] = load float, ptr @_ZZ3barssssE2Sa, align 4, !freeze_bits [[META7]]
...
// CHECK3-NEXT:    [[CONV4:%.*]] = sext i16 [[TMP3]] to i32
// CHECK3-NEXT:    [[ADD5:%.*]] = add nsw i32 [[ADD3]], [[CONV4]]
// CHECK3-NEXT:    [[TMP4:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sa, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV6:%.*]] = fptosi float [[TMP4]] to i32
// CHECK3-NEXT:    [[ADD7:%.*]] = add nsw i32 [[ADD5]], [[CONV6]]
// CHECK3-NEXT:    [[TMP5:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sb, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV8:%.*]] = fptosi float [[TMP5]] to i32
// CHECK3-NEXT:    [[ADD9:%.*]] = add nsw i32 [[ADD7]], [[CONV8]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sc, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV10:%.*]] = fptosi float [[TMP6]] to i32
// CHECK3-NEXT:    [[ADD11:%.*]] = add nsw i32 [[ADD9]], [[CONV10]]
// CHECK3-NEXT:    [[TMP7:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sd, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV12:%.*]] = fptosi float [[TMP7]] to i32
// CHECK3-NEXT:    [[ADD13:%.*]] = add nsw i32 [[ADD11]], [[CONV12]]
// CHECK3-NEXT:    ret i32 [[ADD13]]
//
...
// CHECK3-NEXT:    store i16 [[TMP4]], ptr [[B_CASTED]], align 2
// CHECK3-NEXT:    [[TMP5:%.*]] = load i32, ptr [[B_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP6:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sb, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP6]], ptr [[SB_CASTED]], align 4
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32, ptr [[SB_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP8:%.*]] = load i16, ptr [[TMP2]], align 2, !freeze_bits [[META7]]
// CHECK3-NEXT:    store i16 [[TMP8]], ptr [[C_CASTED]], align 2
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, ptr [[C_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP10:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sc, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP10]], ptr [[SC_CASTED]], align 4
// CHECK3-NEXT:    [[TMP11:%.*]] = load i32, ptr [[SC_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP12:%.*]] = load i16, ptr [[TMP3]], align 2, !freeze_bits [[META7]]
// CHECK3-NEXT:    store i16 [[TMP12]], ptr [[D_CASTED]], align 2
// CHECK3-NEXT:    [[TMP13:%.*]] = load i32, ptr [[D_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP14:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sd, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    store float [[TMP14]], ptr [[SD_CASTED]], align 4
// CHECK3-NEXT:    [[TMP15:%.*]] = load i32, ptr [[SD_CASTED]], align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[TMP16:%.*]] = load double, ptr @Ga, align 8, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CMP:%.*]] = fcmp ogt double [[TMP16]], 0.000000e+00
...
// CHECK3-NEXT:    br i1 [[CMP1]], label [[LAND_LHS_TRUE2:%.*]], label [[OMP_IF_ELSE]]
// CHECK3:       land.lhs.true2:
// CHECK3-NEXT:    [[TMP18:%.*]] = load float, ptr @_ZZ4tbarIsEiT_S0_S0_S0_E2Sa, align 4, !freeze_bits [[META7]]
// CHECK3-NEXT:    [[CONV3:%.*]] = fpext float [[TMP18]] to double
// CHECK3-NEXT:    [[CMP4:%.*]] = fcmp ogt double [[CONV3]], 0.000000e+00
// CHECK3-NEXT:    br i1 [[CMP4]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE]]
// CHECK3:       omp_if.then:
