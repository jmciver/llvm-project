...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4, !tbaa [[TBAA18:![0-9]+]], !alias.scope [[META15]], !noalias [[META19:![0-9]+]], !freeze_bits [[FREEZE_BITS21:![0-9]+]]
...
// CHECK-NEXT:    ]
// CHECK:       .untied.jmp..i:
// CHECK-NEXT:    store i32 1, ptr [[TMP2]], align 4, !tbaa [[TBAA18]], !alias.scope [[META15]], !noalias [[META19]]
// CHECK-NEXT:    [[TMP4:%.*]] = tail call i32 @__kmpc_omp_task(ptr nonnull @[[GLOB1]], i32 [[TMP0]], ptr [[TMP1]]), !noalias [[META15]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[TMP5]], align 8, !tbaa [[TBAA22:![0-9]+]], !noalias [[META15]], !freeze_bits [[FREEZE_BITS21]]
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP7]], align 4, !tbaa [[TBAA18]], !noalias [[META15]], !freeze_bits [[FREEZE_BITS21]]
// CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[TMP6]], align 4, !tbaa [[TBAA23:![0-9]+]], !noalias [[META15]], !freeze_bits [[FREEZE_BITS21]]
// CHECK-NEXT:    tail call void [[TMP8]](i32 noundef [[TMP9]], float noundef [[TMP10]]) #[[ATTR2:[0-9]+]], !noalias [[META15]]
// CHECK-NEXT:    br label [[DOTOMP_OUTLINED__EXIT]]
