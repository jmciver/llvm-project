...
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    store ptr [[SVAR9]], ptr [[TMP13]], align 8
// CHECK1-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR11]], ptr [[TMP14]], align 8
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP18]], ptr [[G_ADDR]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load double, ptr [[TMP19]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP20]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store i32 [[TMP21]], ptr [[SVAR_ADDR]], align 4
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    store ptr [[SVAR9]], ptr [[TMP15]], align 4
// CHECK3-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR11]], ptr [[TMP16]], align 4
...
// CHECK3-NEXT:    [[TMP20:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double [[TMP20]], ptr [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP8]], align 4, !freeze_bits [[META5]]
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK3-NEXT:    store i32 [[TMP23]], ptr [[SVAR_ADDR]], align 4
// CHECK3-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
...
// CHECK9-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META5]]
