...
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP4]], align 8, !noundef [[NOUNDEF4]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr [[G2]], align 8, !noundef [[NOUNDEF4]]
// CHECK1-NEXT:    store volatile double [[TMP18]], ptr [[G_ADDR]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP4]], align 8
// CHECK1-NEXT:    [[TMP20:%.*]] = load double, ptr [[TMP19]], align 8, !noundef [[NOUNDEF4]]
// CHECK1-NEXT:    store volatile double [[TMP20]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR5]], align 4, !noundef [[NOUNDEF4]]
// CHECK1-NEXT:    store i32 [[TMP21]], ptr [[SVAR_ADDR]], align 4
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR6]], align 4, !noundef [[NOUNDEF4]]
...
// CHECK3-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP4]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK3-NEXT:    [[TMP20:%.*]] = load double, ptr [[G2]], align 8, !noundef [[NOUNDEF5]]
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR5]], align 4, !noundef [[NOUNDEF5]]
// CHECK3-NEXT:    store i32 [[TMP23]], ptr [[SVAR_ADDR]], align 4
// CHECK3-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR6]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP6]], align 8, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP16:%.*]] = load i32, ptr [[DOTOMP_IV]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK9-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR7]], align 4, !noundef [[NOUNDEF5]]
...
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR2]], align 4, !noundef [[NOUNDEF6]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR7]], align 4, !noundef [[NOUNDEF6]]
