...
// CHECK1-NEXT:    store double 1.000000e+00, ptr [[G6]], align 8
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[_TMP10]], align 8, !nonnull [[META5]], !align [[META6]], !freeze_bits [[META5]]
// CHECK1-NEXT:    store volatile double 1.000000e+00, ptr [[TMP9]], align 8
// CHECK1-NEXT:    store i32 3, ptr [[SVAR11]], align 4
// CHECK1-NEXT:    store float 4.000000e+00, ptr [[SFVAR13]], align 4
// CHECK1-NEXT:    [[TMP10:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 0
// CHECK1-NEXT:    store ptr [[G6]], ptr [[TMP10]], align 8
...
// CHECK1-NEXT:    store ptr [[SVAR11]], ptr [[TMP13]], align 8
// CHECK1-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR13]], ptr [[TMP14]], align 8
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double, ptr [[G6]], align 8
// CHECK1-NEXT:    store volatile double [[TMP18]], ptr [[G_ADDR]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[_TMP10]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load double, ptr [[TMP19]], align 8, !freeze_bits [[META5]]
// CHECK1-NEXT:    store volatile double [[TMP20]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, ptr [[SVAR11]], align 4
// CHECK1-NEXT:    store i32 [[TMP21]], ptr [[SVAR_ADDR]], align 4
// CHECK1-NEXT:    [[TMP22:%.*]] = load float, ptr [[SFVAR13]], align 4
...
// CHECK3-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[_TMP10]], align 4, !nonnull [[META6]], !align [[META7]], !freeze_bits [[META6]]
...
// CHECK3-NEXT:    store ptr [[G6]], ptr [[TMP12]], align 4
...
// CHECK3-NEXT:    store ptr [[SVAR11]], ptr [[TMP15]], align 4
// CHECK3-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR13]], ptr [[TMP16]], align 4
...
// CHECK3-NEXT:    [[TMP20:%.*]] = load double, ptr [[G6]], align 8
// CHECK3-NEXT:    store volatile double [[TMP20]], ptr [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[_TMP10]], align 4, !freeze_bits [[META6]]
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load i32, ptr [[SVAR11]], align 4
// CHECK3-NEXT:    store i32 [[TMP23]], ptr [[SVAR_ADDR]], align 4
// CHECK3-NEXT:    [[TMP24:%.*]] = load float, ptr [[SFVAR13]], align 4
...
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[_TMP11]], align 8, !nonnull [[META7]], !align [[META8]], !freeze_bits [[META7]]
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX17]], ptr align 4 [[TMP14]], i64 4, i1 false)
...
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK9-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN19]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN19]], [[TMP22]]
...
// CHECK9-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[_TMP11]], align 8, !freeze_bits [[META7]]
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[TMP3]], ptr align 4 [[TMP23]], i64 4, i1 false)
// CHECK9-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR12]], align 4
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP14]], i64 4, i1 false)
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK9-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN17]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN17]], [[TMP22]]
...
// CHECK9-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN19]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, ptr [[T_VAR6]], align 4
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX16]], ptr align 4 [[TMP14]], i32 4, i1 false)
...
// CHECK11-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN18]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN18]], [[TMP22]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = load i32, ptr [[SVAR12]], align 4
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX14]], ptr align 4 [[TMP14]], i32 4, i1 false)
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN16]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq ptr [[ARRAY_BEGIN16]], [[TMP22]]
...
// CHECK11-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAY_BEGIN18]], i32 2
// CHECK11-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK11:       arraydestroy.body:
