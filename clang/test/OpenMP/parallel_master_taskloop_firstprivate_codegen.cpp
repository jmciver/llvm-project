...
// CHECK-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[CONV5_I:%.*]] = sext i32 [[TMP32]] to i64
// CHECK-NEXT:    [[TMP33:%.*]] = load i64, i64* [[DOTUB__ADDR_I]], align 8, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    store i32 [[TMP34]], i32* [[I_I]], align 4, !noalias !15
// CHECK-NEXT:    [[TMP35:%.*]] = load i32, i32* [[TMP27]], align 4, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[ADD7_I:%.*]] = add nsw i32 [[TMP38]], 1
// CHECK-NEXT:    store i32 [[ADD7_I]], i32* [[DOTOMP_IV_I]], align 4, !noalias !15
// CHECK-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// CHECK-NEXT:    store i32 [[TMP2]], i32* [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias !29
// CHECK-NEXT:    store i32* [[TMP5]], i32** [[DOTPART_ID__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store i8* [[TMP10]], i8** [[DOTPRIVATES__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store void (i8*, ...)* bitcast (void (%struct..kmp_privates.t.3*, i32**, [2 x i32]**, [2 x %struct.S.0]**, %struct.S.0**)* @.omp_task_privates_map..2 to void (i8*, ...)*), void (i8*, ...)** [[DOTCOPY_FN__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store i8* [[TMP11]], i8** [[DOTTASK_T__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store i64 [[TMP13]], i64* [[DOTLB__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store i64 [[TMP15]], i64* [[DOTUB__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store i64 [[TMP17]], i64* [[DOTST__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store i32 [[TMP19]], i32* [[DOTLITER__ADDR_I]], align 4, !noalias !29
// CHECK-NEXT:    store i8* [[TMP21]], i8** [[DOTREDUCTIONS__ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    store %struct.anon.1* [[TMP8]], %struct.anon.1** [[__CONTEXT_ADDR_I]], align 8, !noalias !29
// CHECK-NEXT:    [[TMP22:%.*]] = load %struct.anon.1*, %struct.anon.1** [[__CONTEXT_ADDR_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[TMP23:%.*]] = load void (i8*, ...)*, void (i8*, ...)** [[DOTCOPY_FN__ADDR_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[TMP24:%.*]] = load i8*, i8** [[DOTPRIVATES__ADDR_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK-NEXT:    [[TMP26:%.*]] = load i32*, i32** [[DOTFIRSTPRIV_PTR_ADDR_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[TMP27:%.*]] = load [2 x i32]*, [2 x i32]** [[DOTFIRSTPRIV_PTR_ADDR1_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[TMP28:%.*]] = load [2 x %struct.S.0]*, [2 x %struct.S.0]** [[DOTFIRSTPRIV_PTR_ADDR2_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[TMP29:%.*]] = load %struct.S.0*, %struct.S.0** [[DOTFIRSTPRIV_PTR_ADDR3_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[TMP30:%.*]] = load i64, i64* [[DOTLB__ADDR_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[CONV_I:%.*]] = trunc i64 [[TMP30]] to i32
// CHECK-NEXT:    store i32 [[CONV_I]], i32* [[DOTOMP_IV_I]], align 4, !noalias !29
// CHECK-NEXT:    br label [[OMP_INNER_FOR_COND_I:%.*]]
// CHECK:       omp.inner.for.cond.i:
// CHECK-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[CONV4_I:%.*]] = sext i32 [[TMP31]] to i64
// CHECK-NEXT:    [[TMP32:%.*]] = load i64, i64* [[DOTUB__ADDR_I]], align 8, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK:       omp.inner.for.body.i:
// CHECK-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    store i32 [[TMP33]], i32* [[I_I]], align 4, !noalias !29
// CHECK-NEXT:    [[TMP34:%.*]] = load i32, i32* [[TMP26]], align 128, !freeze_bits [[FREEZE_BITS3]]
...
// CHECK-NEXT:    [[TMP37:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !29, !freeze_bits [[FREEZE_BITS3]]
// CHECK-NEXT:    [[ADD6_I:%.*]] = add nsw i32 [[TMP37]], 1
// CHECK-NEXT:    store i32 [[ADD6_I]], i32* [[DOTOMP_IV_I]], align 4, !noalias !29
// CHECK-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// LAMBDA-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// LAMBDA-NEXT:    [[CONV2_I:%.*]] = sext i32 [[TMP29]] to i64
// LAMBDA-NEXT:    [[TMP30:%.*]] = load i64, i64* [[DOTUB__ADDR_I]], align 8, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
...
// LAMBDA-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// LAMBDA-NEXT:    store i32 [[TMP31]], i32* [[I_I]], align 4, !noalias !15
...
// LAMBDA-NEXT:    store double* [[TMP26]], double** [[TMP32]], align 8, !noalias !15
// LAMBDA-NEXT:    [[TMP33:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], %class.anon.0* [[REF_TMP_I]], i32 0, i32 1
// LAMBDA-NEXT:    store i32* [[TMP27]], i32** [[TMP33]], align 8, !noalias !15
// LAMBDA-NEXT:    call void @"_ZZZ4mainENK3$_0clEvENKUlvE_clEv"(%class.anon.0* noundef nonnull align 8 dereferenceable(16) [[REF_TMP_I]])
// LAMBDA-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// LAMBDA-NEXT:    [[ADD3_I:%.*]] = add nsw i32 [[TMP34]], 1
// LAMBDA-NEXT:    store i32 [[ADD3_I]], i32* [[DOTOMP_IV_I]], align 4, !noalias !15
// LAMBDA-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// BLOCKS-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// BLOCKS-NEXT:    [[CONV2_I:%.*]] = sext i32 [[TMP29]] to i64
// BLOCKS-NEXT:    [[TMP30:%.*]] = load i64, i64* [[DOTUB__ADDR_I]], align 8, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
...
// BLOCKS-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// BLOCKS-NEXT:    store i32 [[TMP31]], i32* [[I_I]], align 4, !noalias !15
...
// BLOCKS-NEXT:    store i8* bitcast (i8** @_NSConcreteStackBlock to i8*), i8** [[BLOCK_ISA_I]], align 8, !noalias !15
...
// BLOCKS-NEXT:    store i32 1073741824, i32* [[BLOCK_FLAGS_I]], align 8, !noalias !15
...
// BLOCKS-NEXT:    store i32 0, i32* [[BLOCK_RESERVED_I]], align 4, !noalias !15
...
// BLOCKS-NEXT:    store i8* bitcast (void (i8*)* @_block_invoke to i8*), i8** [[BLOCK_INVOKE_I]], align 8, !noalias !15
...
// BLOCKS-NEXT:    store %struct.__block_descriptor* bitcast ({ i64, i64, i8*, i8* }* @__block_descriptor_tmp.1 to %struct.__block_descriptor*), %struct.__block_descriptor** [[BLOCK_DESCRIPTOR_I]], align 8, !noalias !15
...
// BLOCKS-NEXT:    [[TMP32:%.*]] = load volatile double, double* [[TMP26]], align 8, !freeze_bits [[FREEZE_BITS3]]
// BLOCKS-NEXT:    store volatile double [[TMP32]], double* [[BLOCK_CAPTURED_I]], align 8, !noalias !15
...
// BLOCKS-NEXT:    [[TMP33:%.*]] = load i32, i32* [[TMP27]], align 4, !freeze_bits [[FREEZE_BITS3]]
// BLOCKS-NEXT:    store i32 [[TMP33]], i32* [[BLOCK_CAPTURED3_I]], align 8, !noalias !15
...
// BLOCKS-NEXT:    [[TMP37:%.*]] = load i8*, i8** [[TMP35]], align 8, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// BLOCKS-NEXT:    [[TMP38:%.*]] = bitcast i8* [[TMP37]] to void (i8*)*
// BLOCKS-NEXT:    call void [[TMP38]](i8* noundef [[TMP36]]) #[[ATTR4]]
// BLOCKS-NEXT:    [[TMP39:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// BLOCKS-NEXT:    [[ADD4_I:%.*]] = add nsw i32 [[TMP39]], 1
// BLOCKS-NEXT:    store i32 [[ADD4_I]], i32* [[DOTOMP_IV_I]], align 4, !noalias !15
// BLOCKS-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// ARRAY-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// ARRAY-NEXT:    [[CONV2_I:%.*]] = sext i32 [[TMP31]] to i64
// ARRAY-NEXT:    [[TMP32:%.*]] = load i64, i64* [[DOTUB__ADDR_I]], align 8, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
...
// ARRAY-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// ARRAY-NEXT:    store i32 [[TMP33]], i32* [[I_I]], align 4, !noalias !15
// ARRAY-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_IV_I]], align 4, !noalias !15, !freeze_bits [[FREEZE_BITS3]]
// ARRAY-NEXT:    [[ADD3_I:%.*]] = add nsw i32 [[TMP34]], 1
// ARRAY-NEXT:    store i32 [[ADD3_I]], i32* [[DOTOMP_IV_I]], align 4, !noalias !15
// ARRAY-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// SIMD-ONLY0:       for.cond:
// SIMD-ONLY0-NEXT:    [[TMP1:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2:![0-9]+]]
// SIMD-ONLY0-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP1]], 10
// SIMD-ONLY0-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]]
// SIMD-ONLY0:       for.body:
// SIMD-ONLY0-NEXT:    [[TMP2:%.*]] = load i32, i32* [[T_VAR]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY0:       for.inc:
// SIMD-ONLY0-NEXT:    [[TMP5:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY0-NEXT:    [[TMP7:%.*]] = load i32, i32* [[RETVAL]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY0-NEXT:    br label [[FOR_COND:%.*]]
// SIMD-ONLY0:       for.cond:
// SIMD-ONLY0-NEXT:    [[TMP1:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
// SIMD-ONLY0-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP1]], 10
// SIMD-ONLY0-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]]
// SIMD-ONLY0:       for.body:
// SIMD-ONLY0-NEXT:    [[TMP2:%.*]] = load i32, i32* [[T_VAR]], align 128, !freeze_bits [[FREEZE_BITS2]]
// SIMD-ONLY0-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i64 0, i64 0
// SIMD-ONLY0-NEXT:    store i32 [[TMP2]], i32* [[ARRAYIDX]], align 4
...
// SIMD-ONLY1:       for.cond:
// SIMD-ONLY1-NEXT:    [[TMP1:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2:![0-9]+]]
// SIMD-ONLY1-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP1]], 10
// SIMD-ONLY1-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]]
// SIMD-ONLY1:       for.body:
// SIMD-ONLY1-NEXT:    [[TMP2:%.*]] = load i32, i32* [[T_VAR]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY1:       for.inc:
// SIMD-ONLY1-NEXT:    [[TMP5:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY1-NEXT:    [[TMP7:%.*]] = load i32, i32* [[RETVAL]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY1-NEXT:    br label [[FOR_COND:%.*]]
// SIMD-ONLY1:       for.cond:
// SIMD-ONLY1-NEXT:    [[TMP1:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
// SIMD-ONLY1-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP1]], 10
// SIMD-ONLY1-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]]
// SIMD-ONLY1:       for.body:
// SIMD-ONLY1-NEXT:    [[TMP2:%.*]] = load i32, i32* [[T_VAR]], align 128, !freeze_bits [[FREEZE_BITS2]]
// SIMD-ONLY1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i64 0, i64 0
// SIMD-ONLY1-NEXT:    store i32 [[TMP2]], i32* [[ARRAYIDX]], align 4
...
// SIMD-ONLY3:       for.cond:
// SIMD-ONLY3-NEXT:    [[TMP0:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY3-NEXT:    [[TMP1:%.*]] = load volatile double, double* @g, align 8, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY3-NEXT:    [[TMP2:%.*]] = load i32, i32* @_ZZ4mainE5sivar, align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY3-NEXT:    [[TMP6:%.*]] = load i8*, i8** [[TMP4]], align 8, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY3:       for.inc:
// SIMD-ONLY3-NEXT:    [[TMP8:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY4:       for.cond:
// SIMD-ONLY4-NEXT:    [[TMP2:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
...
// SIMD-ONLY4:       for.inc:
// SIMD-ONLY4-NEXT:    [[TMP3:%.*]] = load i32, i32* [[I]], align 4, !freeze_bits [[FREEZE_BITS2]]
