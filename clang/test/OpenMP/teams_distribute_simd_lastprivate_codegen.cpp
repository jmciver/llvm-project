...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP8]], align 8, !llvm.access.group [[ACC_GRP5]], !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double 1.000000e+00, ptr [[TMP13]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    store i32 3, ptr [[SVAR9]], align 4, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    store float 4.000000e+00, ptr [[SFVAR11]], align 4, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    store ptr [[SVAR9]], ptr [[TMP17]], align 8, !llvm.access.group [[ACC_GRP5]]
// CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK1-NEXT:    store ptr [[SFVAR11]], ptr [[TMP18]], align 8, !llvm.access.group [[ACC_GRP5]]
...
// CHECK1-NEXT:    [[TMP24:%.*]] = load double, ptr [[G6]], align 8, !freeze_bits [[META4]]
// CHECK1-NEXT:    store volatile double [[TMP24]], ptr [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[_TMP8]], align 8, !freeze_bits [[META4]]
...
// CHECK1-NEXT:    [[TMP27:%.*]] = load i32, ptr [[SVAR9]], align 4
// CHECK1-NEXT:    store i32 [[TMP27]], ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP28:%.*]] = load float, ptr [[SFVAR11]], align 4, !freeze_bits [[META4]]
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[_TMP8]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
// CHECK3-NEXT:    store volatile double 1.000000e+00, ptr [[TMP13]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    store i32 3, ptr [[SVAR9]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    store float 4.000000e+00, ptr [[SFVAR11]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK3-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[_TMP8]], align 4, !llvm.access.group [[ACC_GRP6]], !freeze_bits [[META5]]
...
// CHECK3-NEXT:    store ptr [[SVAR9]], ptr [[TMP17]], align 4, !llvm.access.group [[ACC_GRP6]]
// CHECK3-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], ptr [[REF_TMP]], i32 0, i32 3
// CHECK3-NEXT:    store ptr [[SFVAR11]], ptr [[TMP18]], align 4, !llvm.access.group [[ACC_GRP6]]
...
// CHECK13-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[_TMP1]], align 8, !freeze_bits [[META2]]
...
// CHECK13-NEXT:    [[TMP8:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP12]], align 8, !llvm.access.group [[ACC_GRP3]], !freeze_bits [[META2]]
...
// CHECK13-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[ARRAYIDX15]], ptr align 4 [[TMP10]], i64 4, i1 false), !llvm.access.group [[ACC_GRP3]]
...
// CHECK13-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN17]], i64 2
...
// CHECK13-NEXT:    [[TMP17:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN19]], i64 2
...
// CHECK13-NEXT:    [[ARRAYDESTROY_ELEMENTPAST25:%.*]] = phi ptr [ [[TMP18]], [[ARRAYDESTROY_DONE20]] ], [ [[ARRAYDESTROY_ELEMENT26:%.*]], [[ARRAYDESTROY_BODY24]] ]
...
// CHECK15-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[_TMP1]], align 4, !freeze_bits [[META3]]
...
// CHECK15-NEXT:    [[TMP8:%.*]] = load i32, ptr [[T_VAR7]], align 4, !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[_TMP12]], align 4, !llvm.access.group [[ACC_GRP4]], !freeze_bits [[META3]]
// CHECK15-NEXT:    [[TMP11:%.*]] = load i32, ptr [[I]], align 4, !llvm.access.group [[ACC_GRP4]]
// CHECK15-NEXT:    [[ARRAYIDX14:%.*]] = getelementptr inbounds [2 x %struct.S], ptr [[S_ARR10]], i32 0, i32 [[TMP11]]
// CHECK15-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[ARRAYIDX14]], ptr align 4 [[TMP10]], i32 4, i1 false), !llvm.access.group [[ACC_GRP4]]
...
// CHECK15-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN16]], i32 2
...
// CHECK15-NEXT:    [[TMP17:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN18]], i32 2
...
// CHECK15-NEXT:    [[ARRAYDESTROY_ELEMENTPAST24:%.*]] = phi ptr [ [[TMP18]], [[ARRAYDESTROY_DONE19]] ], [ [[ARRAYDESTROY_ELEMENT25:%.*]], [[ARRAYDESTROY_BODY23]] ]
