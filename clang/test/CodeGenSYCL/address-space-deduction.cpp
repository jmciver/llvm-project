...
// CHECK-NEXT:    store i8 [[FREEZE_POISON1]], ptr [[IS_I_PTR]], align 1
// CHECK-NEXT:    [[VAR23:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[FREEZE_POISON2:%.*]] = freeze i32 poison
// CHECK-NEXT:    store i32 [[FREEZE_POISON2]], ptr [[VAR23]], align 4
...
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[PPTR_ASCAST]], align 8, !freeze_bits [[META2:![0-9]+]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[PPTR_ASCAST]], align 8, !freeze_bits [[META2]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[CP_ASCAST]], align 8, !freeze_bits [[META2]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[CPP_ASCAST]], align 8, !freeze_bits [[META2]]
// CHECK-NEXT:    store i8 43, ptr addrspace(4) [[TMP3]], align 1
// CHECK-NEXT:    [[ARRAYDECAY3:%.*]] = getelementptr inbounds [42 x i32], ptr addrspace(4) [[ARR_ASCAST]], i64 0, i64 0
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, ptr addrspace(4) [[ARRAYDECAY3]], i64 10
// CHECK-NEXT:    store ptr addrspace(4) [[ADD_PTR]], ptr addrspace(4) [[APTR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[APTR_ASCAST]], align 8, !freeze_bits [[META2]]
// CHECK-NEXT:    [[ARRAYDECAY4:%.*]] = getelementptr inbounds [42 x i32], ptr addrspace(4) [[ARR_ASCAST]], i64 0, i64 0
// CHECK-NEXT:    [[ADD_PTR5:%.*]] = getelementptr inbounds i32, ptr addrspace(4) [[ARRAYDECAY4]], i64 168
// CHECK-NEXT:    [[CMP6:%.*]] = icmp ult ptr addrspace(4) [[TMP4]], [[ADD_PTR5]]
// CHECK-NEXT:    br i1 [[CMP6]], label [[IF_THEN:%.*]], label [[IF_END:%.*]]
// CHECK:       if.then:
// CHECK-NEXT:    [[TMP5:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[APTR_ASCAST]], align 8, !freeze_bits [[META2]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[STR_ASCAST]], align 8, !freeze_bits [[META2]]
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr addrspace(4) [[TMP6]], i64 0
// CHECK-NEXT:    [[TMP7:%.*]] = load i8, ptr addrspace(4) [[ARRAYIDX]], align 1, !freeze_bits [[META2]]
...
// CHECK-NEXT:    [[CMP7:%.*]] = icmp sgt i32 [[TMP8]], 2
// CHECK-NEXT:    br i1 [[CMP7]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK:       cond.true:
// CHECK-NEXT:    [[TMP9:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[STR_ASCAST]], align 8, !freeze_bits [[META2]]
...
// CHECK-NEXT:    [[CMP8:%.*]] = icmp sgt i32 [[TMP10]], 2
// CHECK-NEXT:    [[TMP11:%.*]] = zext i1 [[CMP8]] to i64
// CHECK-NEXT:    [[COND9:%.*]] = select i1 [[CMP8]], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.2 to ptr addrspace(4)), ptr addrspace(4) null
// CHECK-NEXT:    store ptr addrspace(4) [[COND9]], ptr addrspace(4) [[SELECT_NULL_ASCAST]], align 8
// CHECK-NEXT:    [[TMP12:%.*]] = load ptr addrspace(4), ptr addrspace(4) [[STR_ASCAST]], align 8, !freeze_bits [[META2]]
