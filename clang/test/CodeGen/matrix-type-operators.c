...
void add_matrix_matrix_double(dx5x5_t a, dx5x5_t b, dx5x5_t c) {
  ...
  // NOOPT:       [[B:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF:![0-9]+]]{{$}}
  // NOOPT-NEXT:  [[C:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF:![0-9]+]]{{$}}
  // OPT-NEXT:    [[C:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_assign_matrix_double(dx5x5_t a, dx5x5_t b) {
  ...
  // NOOPT:       [[B:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_matrix_matrix_float(fx2x3_t a, fx2x3_t b, fx2x3_t c) {
  ...
  // NOOPT:       [[B:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[C:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[C:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_assign_matrix_float(fx2x3_t a, fx2x3_t b) {
  ...
  // NOOPT:       [[B:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[A:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[A:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_matrix_scalar_double_float(dx5x5_t a, float vf) {
  ...
  // NOOPT:       [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_scalar_double_float(dx5x5_t a, float vf) {
  ...
  // NOOPT:  [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:    [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EXT:%.*]] = fpext float [[SCALAR]] to double
  // NOOPT-NEXT:  [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EMBED:%.*]] = insertelement <25 x double> poison, double [[SCALAR_EXT]], i32 0
  // CHECK-NEXT:  [[SCALAR_EMBED1:%.*]] = shufflevector <25 x double> [[SCALAR_EMBED]], <25 x double> poison, <25 x i32> zeroinitializer
  // CHECK-NEXT:  [[RES:%.*]] = fadd <25 x double> [[MATRIX]], [[SCALAR_EMBED1]]
  // CHECK-NEXT:  store <25 x double> [[RES]], <25 x double>* {{.*}}, align 8
...
void add_matrix_scalar_double_double(dx5x5_t a, double vd) {
  ...
  // NOOPT:       [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[SCALAR:%.*]] = load double, double* %vd.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[SCALAR:%.*]] = load double, double* %vd.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_scalar_double_double(dx5x5_t a, double vd) {
  ...
  // NOOPT:       [[SCALAR:%.*]] = load double, double* %vd.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[SCALAR:%.*]] = load double, double* %vd.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[MATRIX:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EMBED:%.*]] = insertelement <25 x double> poison, double [[SCALAR]], i32 0
  // CHECK-NEXT:  [[SCALAR_EMBED1:%.*]] = shufflevector <25 x double> [[SCALAR_EMBED]], <25 x double> poison, <25 x i32> zeroinitializer
  // CHECK-NEXT:  [[RES:%.*]] = fadd <25 x double> [[MATRIX]], [[SCALAR_EMBED1]]
...
void add_matrix_scalar_float_float(fx2x3_t b, float vf) {
  ...
  // NOOPT:       [[MATRIX:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[MATRIX:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_scalar_float_float(fx2x3_t b, float vf) {
  ...
  // NOOPT:       [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[MATRIX:%.*]] = load <6 x float>, <6 x float>* %0, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[SCALAR:%.*]] = load float, float* %vf.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[MATRIX:%.*]] = load <6 x float>, <6 x float>* %0, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EMBED:%.*]] = insertelement <6 x float> poison, float [[SCALAR]], i32 0
  // CHECK-NEXT:  [[SCALAR_EMBED1:%.*]] = shufflevector <6 x float> [[SCALAR_EMBED]], <6 x float> poison, <6 x i32> zeroinitializer
  // CHECK-NEXT:  [[RES:%.*]] = fadd <6 x float> [[MATRIX]], [[SCALAR_EMBED1]]
  // CHECK-NEXT:  store <6 x float> [[RES]], <6 x float>* {{.*}}, align 4
...
void add_compound_matrix_scalar_float_double(fx2x3_t b, double vd) {
  ...
  // OPT:         [[SCALAR:%.*]] = load double, double* %vd.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_TRUNC:%.*]] = fptrunc double [[SCALAR]] to float
  // NOOPT-NEXT:  [[MATRIX:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[MATRIX:%.*]] = load <6 x float>, <6 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EMBED:%.*]] = insertelement <6 x float> poison, float [[SCALAR_TRUNC]], i32 0
  // CHECK-NEXT:  [[SCALAR_EMBED1:%.*]] = shufflevector <6 x float> [[SCALAR_EMBED]], <6 x float> poison, <6 x i32> zeroinitializer
  // CHECK-NEXT:  [[RES:%.*]] = fadd <6 x float> [[MATRIX]], [[SCALAR_EMBED1]]
  // CHECK-NEXT:  store <6 x float> [[RES]], <6 x float>* {{.*}}, align 4
...
void add_matrix_matrix_int(ix9x3_t a, ix9x3_t b, ix9x3_t c) {
  ...
  // NOOPT:       [[B:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[C:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[C:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_matrix_int(ix9x3_t a, ix9x3_t b) {
  ...
  // NOOPT:       [[B:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[A:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[A:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_matrix_matrix_unsigned_long_long(ullx4x2_t a, ullx4x2_t b, ullx4x2_t c) {
  ...
  // NOOPT:       [[B:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[C:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[C:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_matrix_unsigned_long_long(ullx4x2_t a, ullx4x2_t b) {
  ...
  // NOOPT:       [[B:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:  [[A:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[B:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[A:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_matrix_scalar_int_short(ix9x3_t a, short vs) {
  ...
  // NOOPT:        [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:   [[SCALAR:%.*]] = load i16, i16* %vs.addr, align 2, !noundef [[NOUNDEF]]{{$}}
  // OPT:          [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:     [[SCALAR:%.*]] = load i16, i16* %vs.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_scalar_int_short(ix9x3_t a, short vs) {
  ...
  // NOOPT:       [[SCALAR:%.*]] = load i16, i16* %vs.addr, align 2, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[SCALAR:%.*]] = load i16, i16* %vs.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EXT:%.*]] = sext i16 [[SCALAR]] to i32
  // NOOPT-NEXT:  [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* %0, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* %0, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EMBED:%.*]] = insertelement <27 x i32> poison, i32 [[SCALAR_EXT:%.*]], i32 0
  // CHECK-NEXT:  [[SCALAR_EMBED1:%.*]] = shufflevector <27 x i32> [[SCALAR_EMBED]], <27 x i32> poison, <27 x i32> zeroinitializer
  // CHECK-NEXT:  [[RES:%.*]] = add <27 x i32> [[MATRIX]], [[SCALAR_EMBED1]]
  // CHECK-NEXT:  store <27 x i32> [[RES]], <27 x i32>* [[MAT_ADDR]], align 4
...
void add_matrix_scalar_int_long_int(ix9x3_t a, long int vli) {
  ...
  // NOOPT:        [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:   [[SCALAR:%.*]] = load i64, i64* %vli.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:          [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:     [[SCALAR:%.*]] = load i64, i64* %vli.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_scalar_int_long_int(ix9x3_t a, long int vli) {
  ...
  // NOOPT:       [[SCALAR:%.*]] = load i64, i64* %vli.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:         [[SCALAR:%.*]] = load i64, i64* %vli.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_matrix_scalar_int_unsigned_long_long(ix9x3_t a, unsigned long long int vulli) {
  ...
  // NOOPT:        [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:   [[SCALAR:%.*]] = load i64, i64* %vulli.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:          [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:     [[SCALAR:%.*]] = load i64, i64* %vulli.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:   [[SCALAR_TRUNC:%.*]] = trunc i64 [[SCALAR]] to i32
  // CHECK-NEXT:   [[SCALAR_EMBED:%.*]] = insertelement <27 x i32> poison, i32 [[SCALAR_TRUNC]], i32 0
  // CHECK-NEXT:   [[SCALAR_EMBED1:%.*]] = shufflevector <27 x i32> [[SCALAR_EMBED]], <27 x i32> poison, <27 x i32> zeroinitializer
  // CHECK-NEXT:   [[RES:%.*]] = add <27 x i32> [[MATRIX]], [[SCALAR_EMBED1]]
...
void add_compound_matrix_scalar_int_unsigned_long_long(ix9x3_t a, unsigned long long int vulli) {
  ...
  // NOOPT:        [[SCALAR:%.*]] = load i64, i64* %vulli.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:          [[SCALAR:%.*]] = load i64, i64* %vulli.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:   [[SCALAR_TRUNC:%.*]] = trunc i64 [[SCALAR]] to i32
  // NOOPT-NEXT:   [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MATRIX_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:     [[MATRIX:%.*]] = load <27 x i32>, <27 x i32>* [[MATRIX_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:   [[SCALAR_EMBED:%.*]] = insertelement <27 x i32> poison, i32 [[SCALAR_TRUNC]], i32 0
  // CHECK-NEXT:   [[SCALAR_EMBED1:%.*]] = shufflevector <27 x i32> [[SCALAR_EMBED]], <27 x i32> poison, <27 x i32> zeroinitializer
  // CHECK-NEXT:   [[RES:%.*]] = add <27 x i32> [[MATRIX]], [[SCALAR_EMBED1]]
  // CHECK-NEXT:   store <27 x i32> [[RES]], <27 x i32>* [[MAT_ADDR]], align 4
...
void add_matrix_scalar_long_long_int_short(ullx4x2_t b, short vs) {
  ...
  // NOOPT-NEXT:    [[MATRIX:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[MATRIX:%.*]] = load <8 x i64>, <8 x i64>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void add_compound_matrix_scalar_long_long_int_short(ullx4x2_t b, short vs) {
  ...
  // OPT:         [[SCALAR:%.*]] = load i16, i16* %vs.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EXT:%.*]] = sext i16 [[SCALAR]] to i64
  // NOOPT-NEXT:  [[MATRIX:%.*]] = load <8 x i64>, <8 x i64>* %0, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[MATRIX:%.*]] = load <8 x i64>, <8 x i64>* %0, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[SCALAR_EMBED:%.*]] = insertelement <8 x i64> poison, i64 [[SCALAR_EXT]], i32 0
  // CHECK-NEXT:  [[SCALAR_EMBED1:%.*]] = shufflevector <8 x i64> [[SCALAR_EMBED]], <8 x i64> poison, <8 x i32> zeroinitializer
...
void multiply_compound_matrix_matrix_double(dx5x5_t b, dx5x5_t c) {
  ...
  // NOOPT:        [[C:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:   [[B:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:          [[C:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:     [[B:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:   [[RES:%.*]] = call <25 x double> @llvm.matrix.multiply.v25f64.v25f64.v25f64(<25 x double> [[B]], <25 x double> [[C]], i32 5, i32 5, i32 5)
  // CHECK-NEXT:   store <25 x double> [[RES]], <25 x double>* {{.*}}, align 8
  // CHECK-NEXT:   ret void
  b *= c;
...
// NOOPT:         [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[S:%.*]] = load float, float* %s.addr, align 4, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[S:%.*]] = load float, float* %s.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
// NOOPT:         [[S:%.*]] = load float, float* %s.addr, align 4, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[S:%.*]] = load float, float* %s.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// CHECK-NEXT:    [[S_EXT:%.*]] = fpext float [[S]] to double
// NOOPT-NEXT:    [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// CHECK-NEXT:    [[VECINSERT:%.*]] = insertelement <25 x double> poison, double [[S_EXT]], i32 0
...
// NOOPT:         [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[S:%.*]] = load double, double* %s.addr, align 8, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[S:%.*]] = load double, double* %s.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
// NOOPT:         [[S:%.*]] = load double, double* %s.addr, align 8, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[S:%.*]] = load double, double* %s.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[A:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// CHECK-NEXT:    [[VECINSERT:%.*]] = insertelement <25 x double> poison, double [[S]], i32 0
// CHECK-NEXT:    [[VECSPLAT:%.*]] = shufflevector <25 x double> [[VECINSERT]], <25 x double> poison, <25 x i32> zeroinitializer
// CHECK-NEXT:    [[RES:%.*]] = fmul <25 x double> [[A]], [[VECSPLAT]]
...
// NOOPT-NEXT:    [[MAT:%.*]] = load <6 x float>, <6 x float>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[MAT:%.*]] = load <6 x float>, <6 x float>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
// NOOPT:         [[S:%.*]] = load i16, i16* %s.addr, align 2, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[S:%.*]] = load i16, i16* %s.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// CHECK-NEXT:    [[S_EXT:%.*]] = sext i16 [[S]] to i32
// NOOPT-NEXT:    [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
// NOOPT:         [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[S:%.*]] = load i64, i64* %s.addr, align 8, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[S:%.*]] = load i64, i64* %s.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void multiply_compound_int_matrix_scalar_ull(ix9x3_t b, unsigned long long s) {
  ...
  // NOOPT:         [[S:%.*]] = load i64, i64* %s.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[S:%.*]] = load i64, i64* %s.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[S_TRUNC:%.*]] = trunc i64 [[S]] to i32
  // NOOPT-NEXT:    [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[VECINSERT:%.*]] = insertelement <27 x i32> poison, i32 [[S_TRUNC]], i32 0
...
// NOOPT:         [[MAT:%.*]] = load <6 x float>, <6 x float>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[S:%.*]] = load double, double* %s.addr, align 8, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[MAT:%.*]] = load <6 x float>, <6 x float>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[S:%.*]] = load double, double* %s.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// CHECK-NEXT:    [[S_TRUNC:%.*]] = fptrunc double [[S]] to float
// CHECK-NEXT:    [[VECINSERT:%.*]] = insertelement <6 x float> poison, float [[S_TRUNC]], i32 0
// CHECK-NEXT:    [[VECSPLAT:%.*]] = shufflevector <6 x float> [[VECINSERT]], <6 x float> poison, <6 x i32> zeroinitializer
...
// NOOPT:         [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[S:%.*]] = load i16, i16* %s.addr, align 2, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[MAT:%.*]] = load <27 x i32>, <27 x i32>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[S:%.*]] = load i16, i16* %s.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// CHECK-NEXT:    [[S_EXT:%.*]] = sext i16 [[S]] to i32
// CHECK-NEXT:    [[VECINSERT:%.*]] = insertelement <27 x i32> poison, i32 [[S_EXT]], i32 0
// CHECK-NEXT:    [[VECSPLAT:%.*]] = shufflevector <27 x i32> [[VECINSERT]], <27 x i32> poison, <27 x i32> zeroinitializer
...
// NOOPT:         [[MAT:%.*]] = load <8 x i64>, <8 x i64>* [[MAT_ADDR:%.*]], align 8, !noundef [[NOUNDEF]]{{$}}
// NOOPT-NEXT:    [[S:%.*]] = load i64, i64* %s.addr, align 8, !noundef [[NOUNDEF]]{{$}}
// OPT:           [[MAT:%.*]] = load <8 x i64>, <8 x i64>* [[MAT_ADDR:%.*]], align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
// OPT-NEXT:      [[S:%.*]] = load i64, i64* %s.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void insert_float_matrix_idx_i_u_float(fx2x3_t b, float e, int j, unsigned k) {
  ...
  // NOOPT:         [[E:%.*]] = load float, float* %e.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:    [[J:%.*]] = load i32, i32* %j.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[E:%.*]] = load float, float* %e.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[J:%.*]] = load i32, i32* %j.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[J_EXT:%.*]] = sext i32 [[J]] to i64
  // NOOPT-NEXT:    [[K:%.*]] = load i32, i32* %k.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[K:%.*]] = load i32, i32* %k.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void insert_float_matrix_idx_s_ull_float(fx2x3_t b, float e, short j, unsigned long long k) {
  ...
  // NOOPT:         [[E:%.*]] = load float, float* %e.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:    [[J:%.*]] = load i16, i16* %j.addr, align 2, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[E:%.*]] = load float, float* %e.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[J:%.*]] = load i16, i16* %j.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[J_EXT:%.*]] = sext i16 [[J]] to i64
  // NOOPT-NEXT:    [[K:%.*]] = load i64, i64* %k.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[K:%.*]] = load i64, i64* %k.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void insert_int_idx_expr(ix9x3_t a, int i) {
  ...
  // NOOPT:         [[I1:%.*]] = load i32, i32* %i.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:    [[I2:%.*]] = load i32, i32* %i.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[I1:%.*]] = load i32, i32* %i.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[I2:%.*]] = load i32, i32* %i.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void insert_float_into_int_matrix(ix9x3_t *a, int i) {
  ...
  // NOOPT:         [[I:%.*]] = load i32, i32* %i.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[I:%.*]] = load i32, i32* %i.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
double extract_double(dx5x5_t a) {
  ...
  // NOOPT:         [[MAT:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[MAT:%.*]] = load <25 x double>, <25 x double>* {{.*}}, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
double extract_float(fx3x3_t b) {
  ...
  // NOOPT:         [[MAT:%.*]] = load <9 x float>, <9 x float>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[MAT:%.*]] = load <9 x float>, <9 x float>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
int extract_int(ix9x3_t c, unsigned long j) {
  ...
  // NOOPT:         [[J1:%.*]] = load i64, i64* %j.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // NOOPT-NEXT:    [[J2:%.*]] = load i64, i64* %j.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[J1:%.*]] = load i64, i64* %j.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[J2:%.*]] = load i64, i64* %j.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[IDX1:%.*]] = mul i64 [[J2]], 9
  // CHECK-NEXT:    [[IDX2:%.*]] = add i64 [[IDX1]], [[J1]]
  // NOOPT-NEXT:    [[MAT:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[CMP:%.*]] = icmp ult i64 [[IDX2]], 27
  // OPT-NEXT:      call void @llvm.assume(i1 [[CMP]])
  // OPT-NEXT:      [[MAT:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
double test_extract_matrix_pointer1(dx3x2_t **ptr, unsigned j) {
  ...
  // NOOPT:         [[J:%.*]] = load i32, i32* %j.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[J:%.*]] = load i32, i32* %j.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[J_EXT:%.*]] = zext i32 [[J]] to i64
  // CHECK-NEXT:    [[IDX:%.*]] = add i64 3, [[J_EXT]]
  // NOOPT-NEXT:    [[PTR:%.*]] = load [6 x double]**, [6 x double]*** %ptr.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[CMP:%.*]] = icmp ult i64 [[IDX]], 6
  // OPT-NEXT:      call void @llvm.assume(i1 [[CMP]])
  // OPT-NEXT:      [[PTR:%.*]] = load [6 x double]**, [6 x double]*** %ptr.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[PTR_IDX:%.*]] = getelementptr inbounds [6 x double]*, [6 x double]** [[PTR]], i64 1
  // NOOPT-NEXT:    [[PTR2:%.*]] = load [6 x double]*, [6 x double]** [[PTR_IDX]], align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[PTR2:%.*]] = load [6 x double]*, [6 x double]** [[PTR_IDX]], align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  ...
  // NOOPT-NEXT:    [[MAT:%.*]] = load <6 x double>, <6 x double>* [[MAT_ADDR]], align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[MAT:%.*]] = load <6 x double>, <6 x double>* [[MAT_ADDR]], align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
double test_extract_matrix_pointer2(dx3x2_t **ptr) {
  ...
  // CHECK-NEXT:  entry:
  // NOOPT:         [[PTR:%.*]] = load [6 x double]**, [6 x double]*** %ptr.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[PTR:%.*]] = load [6 x double]**, [6 x double]*** %ptr.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void insert_extract(dx5x5_t a, fx3x3_t b, unsigned long j, short k) {
  ...
  // NOOPT:         [[K:%.*]] = load i16, i16* %k.addr, align 2, !noundef [[NOUNDEF]]{{$}}
  // OPT:           [[K:%.*]] = load i16, i16* %k.addr, align 2, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[K_EXT:%.*]] = sext i16 [[K]] to i64
  // CHECK-NEXT:    [[IDX1:%.*]] = mul i64 [[K_EXT]], 3
  // CHECK-NEXT:    [[IDX2:%.*]] = add i64 [[IDX1]], 0
  // NOOPT-NEXT:    [[MAT:%.*]] = load <9 x float>, <9 x float>* [[MAT_ADDR:%.*]], align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[CMP:%.*]] = icmp ult i64 [[IDX2]], 9
  // OPT-NEXT:      call void @llvm.assume(i1 [[CMP]])
  // OPT-NEXT:      [[MAT:%.*]] = load <9 x float>, <9 x float>* [[MAT_ADDR:%.*]], align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:    [[MATEXT:%.*]] = extractelement <9 x float> [[MAT]], i64 [[IDX2]]
  // NOOPT-NEXT:    [[J:%.*]] = load i64, i64* %j.addr, align 8, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:      [[J:%.*]] = load i64, i64* %j.addr, align 8, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
...
void matrix_as_idx(ix9x3_t a, int i, int j, dx5x5_t b) {
  ...
  // NOOPT-NEXT:  [[J1:%.*]] = load i32, i32* %j.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[J1:%.*]] = load i32, i32* %j.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[J1_EXT:%.*]] = sext i32 [[J1]] to i64
  // CHECK-NEXT:  [[IDX1_1:%.*]] = mul i64 [[J1_EXT]], 9
  // CHECK-NEXT:  [[IDX1_2:%.*]] = add i64 [[IDX1_1]], [[I1_EXT]]
  // NOOPT-NEXT:  [[A:%.*]] = load <27 x i32>, <27 x i32>* %0, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[CMP:%.*]] = icmp ult i64 [[IDX1_2]], 27
  // OPT-NEXT:    call void @llvm.assume(i1 [[CMP]])
  // OPT-NEXT:    [[A:%.*]] = load <27 x i32>, <27 x i32>* %0, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  // CHECK-NEXT:  [[MI1:%.*]] = extractelement <27 x i32> [[A]], i64 [[IDX1_2]]
  // CHECK-NEXT:  [[MI1_EXT:%.*]] = sext i32 [[MI1]] to i64
  // NOOPT-NEXT:  [[J2:%.*]] = load i32, i32* %j.addr, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[J2:%.*]] = load i32, i32* %j.addr, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
  ...
  // NOOPT-NEXT:  [[A2:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !noundef [[NOUNDEF]]{{$}}
  // OPT-NEXT:    [[CMP:%.*]] = icmp ult i64 [[IDX2_2]], 27
  // OPT-NEXT:    call void @llvm.assume(i1 [[CMP]])
  // OPT-NEXT:    [[A2:%.*]] = load <27 x i32>, <27 x i32>* {{.*}}, align 4, !tbaa !{{[0-9]+}}, !noundef [[NOUNDEF]]{{$}}
