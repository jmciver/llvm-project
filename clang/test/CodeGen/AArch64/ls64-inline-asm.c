...
// CHECK-NEXT:    [[DOTFR34:%.*]] = freeze i32 [[TMP0]]
// CHECK-NEXT:    [[CONV:%.*]] = sext i32 [[DOTFR34]] to i64
// CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds nuw i8, ptr [[IN]], i64 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX1]], align 4, !tbaa [[TBAA4]]
// CHECK-NEXT:    [[DOTFR33:%.*]] = freeze i32 [[TMP1]]
// CHECK-NEXT:    [[CONV2:%.*]] = sext i32 [[DOTFR33]] to i64
...
// CHECK-NEXT:    [[DOTFR32:%.*]] = freeze i32 [[TMP2]]
// CHECK-NEXT:    [[CONV5:%.*]] = sext i32 [[DOTFR32]] to i64
...
// CHECK-NEXT:    [[DOTFR31:%.*]] = freeze i32 [[TMP3]]
// CHECK-NEXT:    [[CONV8:%.*]] = sext i32 [[DOTFR31]] to i64
...
// CHECK-NEXT:    [[DOTFR30:%.*]] = freeze i32 [[TMP4]]
// CHECK-NEXT:    [[CONV11:%.*]] = sext i32 [[DOTFR30]] to i64
...
// CHECK-NEXT:    [[DOTFR29:%.*]] = freeze i32 [[TMP5]]
// CHECK-NEXT:    [[CONV14:%.*]] = sext i32 [[DOTFR29]] to i64
...
// CHECK-NEXT:    [[DOTFR28:%.*]] = freeze i32 [[TMP6]]
// CHECK-NEXT:    [[CONV17:%.*]] = sext i32 [[DOTFR28]] to i64
...
// CHECK-NEXT:    [[DOTFR:%.*]] = freeze i32 [[TMP7]]
// CHECK-NEXT:    [[CONV20:%.*]] = sext i32 [[DOTFR]] to i64
