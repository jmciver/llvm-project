...
// CHECK:       z:
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[RET]], align 4, !freeze [[META3:![0-9]+]]
...
// CHECK-NEXT:    br label [[Z:%.*]]
// CHECK:       z:
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[RET]], align 4, !freeze [[META3]]
// CHECK-NEXT:    ret i32 [[TMP1]]
// CHECK:       z.split:
...
// CHECK-NEXT:    br label [[Z:%.*]]
// CHECK:       z:
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[RET]], align 4, !freeze [[META3]]
...
// CHECK-NEXT:    br label [[RETURN]]
// CHECK:       return:
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[RETVAL]], align 4, !freeze [[META3]]
// CHECK-NEXT:    ret i32 [[TMP1]]
//
int test3 (int out1) {
