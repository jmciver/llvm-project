...
// CHECK:    tail call void asm sideeffect "", "{$vr0}"(<16 x i8> poison) #[[ATTR1:[0-9]+]], !srcloc [[META2:![0-9]+]]
//
void test_vr0() {
...
// CHECK:    tail call void asm sideeffect "", "{$vr7}"(<16 x i8> poison) #[[ATTR1]], !srcloc [[META3:![0-9]+]]
//
void test_vr7() {
...
// CHECK:    tail call void asm sideeffect "", "{$vr15}"(<16 x i8> poison) #[[ATTR1]], !srcloc [[META4:![0-9]+]]
//
void test_vr15() {
...
// CHECK:    tail call void asm sideeffect "", "{$vr31}"(<16 x i8> poison) #[[ATTR1]], !srcloc [[META5:![0-9]+]]
//
void test_vr31() {
