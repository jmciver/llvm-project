...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr addrspace(4) @__oclc_ABI_version, align 4, !freeze [[META2:![0-9]+]]
...
// CHECK-NEXT:    [[TMP7:%.*]] = load i16, ptr addrspace(4) [[TMP6]], align 2, !range [[RNG3:![0-9]+]], !invariant.load [[META2]], !noundef [[META2]], !freeze [[META2]]
