...
// CHECK-NEXT:    store i32 [[FREEZE_POISON3]], ptr [[I]], align 4
...
// CHECK-NEXT:    [[FP_OFFSET_P:%.*]] = getelementptr inbounds nuw [[STRUCT___VA_LIST_TAG:%.*]], ptr [[ARRAYDECAY4]], i32 0, i32 1
...
// CHECK:       vaarg.in_reg:
// CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds nuw [[STRUCT___VA_LIST_TAG]], ptr [[ARRAYDECAY4]], i32 0, i32 3
...
// CHECK:       vaarg.in_mem:
// CHECK-NEXT:    [[OVERFLOW_ARG_AREA_P:%.*]] = getelementptr inbounds nuw [[STRUCT___VA_LIST_TAG]], ptr [[ARRAYDECAY4]], i32 0, i32 2
...
// CHECK-NEXT:    [[ARRAYDECAY5:%.*]] = getelementptr inbounds [1 x %struct.__va_list_tag], ptr [[AP]], i64 0, i64 0
// CHECK-NEXT:    call void @llvm.va_end.p0(ptr [[ARRAYDECAY5]])
...
// CHECK-NEXT:    [[A6:%.*]] = getelementptr inbounds nuw [[STRUCT_S]], ptr [[ARG]], i32 0, i32 0
// CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [3 x float], ptr [[A6]], i64 0, i64 2
// CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX7]], align 4, !freeze_bits [[META2]]
