...
// CHECK: load i8, ptr %{{.*}}, align 1, !tbaa [[TAG_char:![0-9]+]], !noundef [[TAG_NOUNDEF:![0-9]+]]
// PATH-LABEL: define{{.*}} signext i8 @_Z3g13
// PATH: load i8, ptr %{{.*}}, align 1, !tbaa [[TAG_five_b:![0-9]+]], !noundef [[TAG_NOUNDEF:![0-9]+]]
}
...
// PATH: load i8, ptr %{{.*}}, align 1, !tbaa [[TAG_six_b:![0-9]+]], !noundef [[TAG_NOUNDEF:![0-9]+]]
  return a->b;
}
