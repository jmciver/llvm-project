...
// CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !tbaa [[TBAA2:![0-9]+]], !freeze_bits [[META6:![0-9]+]]
// CHECK-NEXT:    [[CALL:%.*]] = tail call float @expf(float noundef [[TMP0]]) #[[ATTR9:[0-9]+]], !tbaa [[TBAA7:![0-9]+]]
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[NUM]], i64 40
// CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !tbaa [[TBAA2]], !freeze_bits [[META6]]
// CHECK-NEXT:    [[CALL:%.*]] = tail call float @expf(float noundef [[TMP0]]) #[[ATTR9]], !tbaa [[TBAA7]]
// CHECK-NEXT:    [[MUL:%.*]] = fmul float [[TMP0]], [[CALL]]
// CHECK-NEXT:    ret float [[MUL]]
//
...
// CHECK-LABEL: define dso_local noundef double @test_fabs(
...
// CHECK-NEXT:    [[TMP0:%.*]] = load double, ptr [[ARRAYIDX]], align 8, !tbaa [[TBAA9:![0-9]+]], !freeze_bits [[META6]]
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[NUM]], i64 80
// CHECK-NEXT:    [[TMP0:%.*]] = load double, ptr [[ARRAYIDX]], align 8, !tbaa [[TBAA9]], !freeze_bits [[META6]]
// CHECK-NEXT:    [[CALL:%.*]] = tail call double @remainder(double noundef [[TMP0]], double noundef [[A]]) #[[ATTR9]], !tbaa [[TBAA7]]
...
// CHECK-NEXT:    store float 0.000000e+00, ptr [[SIN]], align 4
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 4, ptr nonnull [[COS]]) #[[ATTR9]]
// CHECK-NEXT:    store float 0.000000e+00, ptr [[COS]], align 4
...
// CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !tbaa [[TBAA2]], !freeze_bits [[META6]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[ARRAYIDX]], align 4, !tbaa [[TBAA2]], !freeze_bits [[META6]]
...
// NONEWSTRUCTPATHTBAA: [[META6]] = !{}
// NONEWSTRUCTPATHTBAA: [[TBAA7]] = !{[[META8:![0-9]+]], [[META8]], i64 0}
// NONEWSTRUCTPATHTBAA: [[META8]] = !{!"int", [[META4]], i64 0}
// NONEWSTRUCTPATHTBAA: [[TBAA9]] = !{[[META10:![0-9]+]], [[META10]], i64 0}
// NONEWSTRUCTPATHTBAA: [[META10]] = !{!"double", [[META4]], i64 0}
//.
...
// NEWSTRUCTPATHTBAA: [[META6]] = !{}
// NEWSTRUCTPATHTBAA: [[TBAA7]] = !{[[META8:![0-9]+]], [[META8]], i64 0, i64 4}
// NEWSTRUCTPATHTBAA: [[META8]] = !{[[META4]], i64 4, !"int"}
// NEWSTRUCTPATHTBAA: [[TBAA9]] = !{[[META10:![0-9]+]], [[META10]], i64 0, i64 8}
// NEWSTRUCTPATHTBAA: [[META10]] = !{[[META4]], i64 8, !"double"}
//.
