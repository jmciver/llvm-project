...
// CHECK-LIFETIME-NEXT:    [[TMP0:%.*]] = load i32, ptr [[P_0_P_0_P_0_P_0_]], align 4, !dbg [[DBG20:![0-9]+]], !tbaa [[TBAA11]], !freeze_bits [[META8:![0-9]+]]
...
// CHECK-MSAN-NEXT:    store i64 0, ptr [[TMP5]], align 8, !dbg [[DBG15]]
// CHECK-MSAN-NEXT:    store ptr null, ptr [[P]], align 8, !dbg [[DBG15]]
...
// CHECK-MSAN-NEXT:    [[_MSLD:%.*]] = load i64, ptr [[TMP5]], align 8, !dbg [[DBG19]], !freeze_bits [[META8:![0-9]+]]
...
// CHECK-MSAN-NEXT:    [[_MSLD2:%.*]] = load i32, ptr [[TMP11]], align 4, !dbg [[DBG20]], !freeze_bits [[META8]]
...
// CHECK-MSAN-NEXT:    [[_MSCMP3_NOT:%.*]] = icmp eq i32 [[_MSLD2]], 0, !dbg [[DBG23:![0-9]+]]
// CHECK-MSAN-NEXT:    br i1 [[_MSCMP3_NOT]], label [[TMP13:%.*]], label [[TMP12:%.*]], !dbg [[DBG23]], !prof [[PROF21]]
// CHECK-MSAN:       12:
...
// CHECK-KMSAN-NEXT:    [[TMP3:%.*]] = call { ptr, ptr } @__msan_metadata_ptr_for_store_8(ptr nonnull [[P]]) #[[ATTR2]], !dbg [[DBG15]]
// CHECK-KMSAN-NEXT:    [[TMP4:%.*]] = extractvalue { ptr, ptr } [[TMP3]], 0, !dbg [[DBG15]]
// CHECK-KMSAN-NEXT:    store i64 0, ptr [[TMP4]], align 8, !dbg [[DBG15]]
// CHECK-KMSAN-NEXT:    store ptr null, ptr [[P]], align 8, !dbg [[DBG15]]
...
// CHECK-KMSAN-NEXT:    [[_MSLD:%.*]] = load i64, ptr [[TMP8]], align 8, !dbg [[DBG19]], !freeze_bits [[META8:![0-9]+]]
...
// CHECK-KMSAN-NEXT:    [[_MSLD2:%.*]] = load i32, ptr [[TMP15]], align 4, !dbg [[DBG20]], !freeze_bits [[META8]]
...
// CHECK-KMSAN-NEXT:    store i32 [[_MSLD2]], ptr [[RETVAL_SHADOW]], align 8, !dbg [[DBG23:![0-9]+]]
