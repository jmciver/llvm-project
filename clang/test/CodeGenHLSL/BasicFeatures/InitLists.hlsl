...
// CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr [[X]], align 1, !freeze_bits [[META3:![0-9]+]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[Y]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[Z]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[W]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[Z2]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[W4]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[X]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[Y]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[X8]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[Y10]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[X12]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[Y14]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[X16]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[Y18]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[LEGSTATE]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load <4 x i32>, ptr [[LEGSTATE1]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i32>, ptr [[LEGSTATE4]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load <4 x i32>, ptr [[LEGSTATE7]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TAILSTATE]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[HAIRCOUNT]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = load <4 x float>, ptr [[ARRAYIDX]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x float>, ptr [[ARRAYIDX11]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x float>, ptr [[ARRAYIDX15]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x float>, ptr [[ARRAYIDX19]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x float>, ptr [[ARRAYIDX23]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP11:%.*]] = load <4 x float>, ptr [[ARRAYIDX27]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x float>, ptr [[ARRAYIDX31]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP13:%.*]] = load <4 x float>, ptr [[ARRAYIDX35]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[LEGSTATE1:%.*]] = getelementptr inbounds nuw [[STRUCT_DOGGO]], ptr [[D1]], i32 0, i32 0
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[LEGSTATE1]], align 1, !freeze_bits [[META3]]
// CHECK-NEXT:    [[VECEXT:%.*]] = extractelement <4 x i32> [[TMP0]], i64 0
...
// CHECK-NEXT:    [[TMP1:%.*]] = load <4 x i32>, ptr [[LEGSTATE2]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i32>, ptr [[LEGSTATE5]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load <4 x i32>, ptr [[LEGSTATE8]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[TAILSTATE11]], align 1, !freeze_bits [[META3]]
// CHECK-NEXT:    store i32 [[TMP4]], ptr [[TAILSTATE]], align 1
...
// CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[HAIRCOUNT12]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x float>, ptr [[ARRAYIDX17]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x float>, ptr [[ARRAYIDX21]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x float>, ptr [[ARRAYIDX25]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x float>, ptr [[ARRAYIDX29]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP11:%.*]] = load <4 x float>, ptr [[ARRAYIDX33]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x float>, ptr [[ARRAYIDX37]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP13:%.*]] = load <4 x float>, ptr [[ARRAYIDX41]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[ARRAYIDX46]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[ARRAYIDX49]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr [[ARRAYIDX52]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP17:%.*]] = load i32, ptr [[ARRAYIDX55]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP18:%.*]] = load i32, ptr [[STATE]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP19:%.*]] = load i64, ptr [[COUNTER]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP20:%.*]] = load <4 x float>, ptr [[LEFTDIR]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP21:%.*]] = load <4 x float>, ptr [[LEFTDIR62]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP22:%.*]] = load <4 x float>, ptr [[LEFTDIR65]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP23:%.*]] = load <4 x float>, ptr [[LEFTDIR68]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP24:%.*]] = load <4 x float>, ptr [[RIGHTDIR]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP25:%.*]] = load <4 x float>, ptr [[RIGHTDIR74]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP26:%.*]] = load <4 x float>, ptr [[RIGHTDIR77]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP27:%.*]] = load <4 x float>, ptr [[RIGHTDIR80]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP28:%.*]] = load <4 x i32>, ptr [[LEGSTATE84]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP29:%.*]] = load <4 x i32>, ptr [[LEGSTATE87]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP30:%.*]] = load <4 x i32>, ptr [[LEGSTATE90]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP31:%.*]] = load <4 x i32>, ptr [[LEGSTATE93]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP32:%.*]] = load i32, ptr [[TAILSTATE97]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP33:%.*]] = load float, ptr [[HAIRCOUNT99]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP34:%.*]] = load <4 x float>, ptr [[ARRAYIDX101]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP35:%.*]] = load <4 x float>, ptr [[ARRAYIDX105]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP36:%.*]] = load <4 x float>, ptr [[ARRAYIDX109]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP37:%.*]] = load <4 x float>, ptr [[ARRAYIDX113]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP38:%.*]] = load <4 x float>, ptr [[ARRAYIDX118]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP39:%.*]] = load <4 x float>, ptr [[ARRAYIDX122]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP40:%.*]] = load <4 x float>, ptr [[ARRAYIDX126]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP41:%.*]] = load <4 x float>, ptr [[ARRAYIDX130]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP42:%.*]] = load i32, ptr [[ARRAYIDX136]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP43:%.*]] = load i32, ptr [[ARRAYIDX139]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP44:%.*]] = load i32, ptr [[ARRAYIDX142]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP45:%.*]] = load i32, ptr [[ARRAYIDX145]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP46:%.*]] = load i32, ptr [[STATE148]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP47:%.*]] = load i64, ptr [[COUNTER150]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP48:%.*]] = load <4 x float>, ptr [[LEFTDIR153]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP49:%.*]] = load <4 x float>, ptr [[LEFTDIR156]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP50:%.*]] = load <4 x float>, ptr [[LEFTDIR159]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP51:%.*]] = load <4 x float>, ptr [[LEFTDIR162]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP52:%.*]] = load <4 x float>, ptr [[RIGHTDIR166]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP53:%.*]] = load <4 x float>, ptr [[RIGHTDIR169]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP54:%.*]] = load <4 x float>, ptr [[RIGHTDIR172]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP55:%.*]] = load <4 x float>, ptr [[RIGHTDIR175]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP56:%.*]] = load <4 x i32>, ptr [[LEGSTATE180]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP57:%.*]] = load <4 x i32>, ptr [[LEGSTATE183]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP58:%.*]] = load <4 x i32>, ptr [[LEGSTATE186]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP59:%.*]] = load <4 x i32>, ptr [[LEGSTATE189]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP60:%.*]] = load i32, ptr [[TAILSTATE193]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP61:%.*]] = load float, ptr [[HAIRCOUNT195]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP62:%.*]] = load <4 x float>, ptr [[ARRAYIDX198]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP63:%.*]] = load <4 x float>, ptr [[ARRAYIDX202]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP64:%.*]] = load <4 x float>, ptr [[ARRAYIDX206]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP65:%.*]] = load <4 x float>, ptr [[ARRAYIDX210]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP66:%.*]] = load <4 x float>, ptr [[ARRAYIDX215]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP67:%.*]] = load <4 x float>, ptr [[ARRAYIDX219]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP68:%.*]] = load <4 x float>, ptr [[ARRAYIDX223]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP69:%.*]] = load <4 x float>, ptr [[ARRAYIDX227]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP70:%.*]] = load i32, ptr [[ARRAYIDX233]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP71:%.*]] = load i32, ptr [[ARRAYIDX236]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP72:%.*]] = load i32, ptr [[ARRAYIDX239]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP73:%.*]] = load i32, ptr [[ARRAYIDX242]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP74:%.*]] = load i32, ptr [[STATE245]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP75:%.*]] = load i64, ptr [[COUNTER247]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP76:%.*]] = load <4 x float>, ptr [[LEFTDIR250]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP77:%.*]] = load <4 x float>, ptr [[LEFTDIR253]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP78:%.*]] = load <4 x float>, ptr [[LEFTDIR256]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP79:%.*]] = load <4 x float>, ptr [[LEFTDIR259]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP80:%.*]] = load <4 x float>, ptr [[RIGHTDIR263]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP81:%.*]] = load <4 x float>, ptr [[RIGHTDIR266]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP82:%.*]] = load <4 x float>, ptr [[RIGHTDIR269]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP83:%.*]] = load <4 x float>, ptr [[RIGHTDIR272]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr [[X1]], align 1, !freeze_bits [[META3]]
// CHECK-NEXT:    store float [[TMP0]], ptr [[X]], align 1
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[Y2:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF1]], i32 0, i32 1
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[Y2]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[X3]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[Y4]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x float>, ptr [[REF_TMP]], align 16, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP5:%.*]] = load <4 x float>, ptr [[REF_TMP1]], align 16, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x float>, ptr [[REF_TMP4]], align 16, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP11:%.*]] = load <4 x float>, ptr [[REF_TMP7]], align 16, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[W1]], align 1, !freeze_bits [[META3]]
// CHECK-NEXT:    [[TMP3:%.*]] = trunc i32 [[TMP2]] to i8
// CHECK-NEXT:    store i8 [[TMP3]], ptr [[W]], align 1
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[Z:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOINTS]], ptr [[AGG_RESULT]], i32 0, i32 0
// CHECK-NEXT:    [[BF_LOAD:%.*]] = load i8, ptr [[SB]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[BF_LOAD2:%.*]] = load i8, ptr [[W1]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[BF_LOAD1:%.*]] = load i8, ptr [[W]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[X_ADDR]], align 4, !nonnull [[META3]], !align [[META4:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[TMP0]], align 4, !freeze_bits [[META3]]
// CHECK-NEXT:    store float [[TMP1]], ptr [[X1]], align 1
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[X_ADDR]], align 4, !nonnull [[META3]], !align [[META4]]
// CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[TMP2]], align 4, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[TMP4]], align 4, !freeze_bits [[META3]]
...
// CHECK-NEXT:    store float [[FREEZE_POISON]], ptr [[X]], align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[TMP]], align 4, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[X2]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[Y3]], align 1, !freeze_bits [[META3]]
...
// CHECK-NEXT:    [[FREEZE_POISON:%.*]] = freeze <2 x i32> poison
// CHECK-NEXT:    store <2 x i32> [[FREEZE_POISON]], ptr [[X]], align 8
