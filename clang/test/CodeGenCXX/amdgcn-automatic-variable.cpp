...
// CHECK-NEXT:    call void @_ZN1AC2Ev(ptr noundef nonnull align 4 dereferenceable(4) [[THIS1]]) #[[ATTR2:[0-9]+]]
// CHECK-NEXT:    ret void
//
A::A() : x(0) {}
...
// CHECK-NEXT:    call void @_Z5func1Pi(ptr noundef [[LV1_ASCAST]]) #[[ATTR2]]
...
// CHECK-NEXT:    store i64 [[FREEZE_POISON]], ptr [[VAR_ASCAST]], align 8
// CHECK-NEXT:    [[FREEZE_POISON1:%.*]] = freeze ptr poison
// CHECK-NEXT:    store ptr [[FREEZE_POISON1]], ptr [[ALLOCA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    store ptr [[VAR_ASCAST]], ptr [[ALLOCA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[FREEZE_POISON2:%.*]] = freeze ptr addrspace(5) poison
// CHECK-NEXT:    store ptr addrspace(5) [[FREEZE_POISON2]], ptr [[ALLOCA_ADDR_AS_PRIVATE_ASCAST]], align 4
