...
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[E_ADDR]], align 8, !tbaa [[TBAA14]], !nonnull [[META17:![0-9]+]], !align [[META18:![0-9]+]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[__RANGE1]], align 8, !tbaa [[TBAA14]], !nonnull [[META17]], !align [[META18]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[__RANGE1]], align 8, !tbaa [[TBAA14]], !nonnull [[META17]], !align [[META18]]
// CHECK-NEXT:    [[ARRAYDECAY3:%.*]] = getelementptr inbounds [4 x i32], ptr [[TMP2]], i64 0, i64 0
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, ptr [[ARRAYDECAY3]], i64 4
...
// CHECK-NEXT:    store i32 [[FREEZE_POISON4]], ptr [[I]], align 4
// CHECK-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[__BEGIN1]], align 8, !tbaa [[TBAA14]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4, !tbaa [[TBAA2]], !freeze_bits [[META17]]
...
// CHECK-NEXT:    [[FREEZE_POISON:%.*]] = freeze ptr poison
// CHECK-NEXT:    store ptr [[FREEZE_POISON]], ptr [[__RANGE1]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[E_ADDR]], align 8, !tbaa [[TBAA14]], !nonnull [[META17]], !align [[META18]]
// CHECK-NEXT:    store ptr [[TMP0]], ptr [[__RANGE1]], align 8, !tbaa [[TBAA14]]
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 8, ptr [[__BEGIN1]]) #[[ATTR3]]
// CHECK-NEXT:    [[FREEZE_POISON1:%.*]] = freeze ptr poison
// CHECK-NEXT:    store ptr [[FREEZE_POISON1]], ptr [[__BEGIN1]], align 8
