...
extern "C" const void *aArrayParameter(A aArray[]) {
  ...
  // CHECK-ADDRESSAUTH: %vtable = load ptr, ptr %0, align 8, !tbaa [[TBAA_VTABLE:![0-9]+]]
  ...
  // CHECK-BOTHAUTH: %vtable = load ptr, ptr [[VTABLE_ADDR]], align 8, !tbaa [[TBAA_VTABLE:![0-9]+]]
...
extern "C" const void *aArrayLocal() {
  ...
  // CHECK-ADDRESSAUTH: %vtable = load ptr, ptr %arraydecay, align 8, !tbaa [[TBAA_VTABLE]]
  ...
  // CHECK-BOTHAUTH: %vtable = load ptr, ptr %arraydecay, align 8, !tbaa [[TBAA_VTABLE:![0-9]+]]
