...
// CHECKS-NEXT:  [[ENTRY:.*:]]
// CHECKS-NEXT:    [[TMP0:%.*]] = load i16, ptr @sj, align 2, !dbg [[DBG16:![0-9]+]], !tbaa [[TBAA17:![0-9]+]], !freeze [[META21:![0-9]+]]
// CHECKS-NEXT:    [[CONV:%.*]] = zext i16 [[TMP0]] to i32, !dbg [[DBG16]]
// CHECKS-NEXT:    [[TMP1:%.*]] = load i16, ptr @sk, align 2, !dbg [[DBG22:![0-9]+]], !tbaa [[TBAA17]], !freeze [[META21]]
...
// CHECKU-NEXT:  [[ENTRY:.*:]]
// CHECKU-NEXT:    [[TMP0:%.*]] = load i16, ptr @sj, align 2, !dbg [[DBG16:![0-9]+]], !tbaa [[TBAA17:![0-9]+]], !freeze [[META21:![0-9]+]]
// CHECKU-NEXT:    [[TMP1:%.*]] = load i16, ptr @sk, align 2, !dbg [[DBG22:![0-9]+]], !tbaa [[TBAA17]], !freeze [[META21]]
