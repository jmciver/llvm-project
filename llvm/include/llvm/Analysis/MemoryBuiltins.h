...
bool loadHasFreeze(const LoadInst *const LI);
...
enum class InitializationCategory {
  ...
  ///   * malloc in the absence of !freeze
  ///
  ...
  /// will be poison.
  Constant,
  /// This enumerator will be returned when the load accompanied by !freeze and
  /// classification of the allocator such that memory is determined to be
...
LLVM_ABI std::pair<InitializationCategory, Constant *>
