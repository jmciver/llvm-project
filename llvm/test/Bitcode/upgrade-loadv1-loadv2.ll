...
; CHECK-NEXT: %v.ptr = load ptr, ptr %a.0.ptr, align 8, !nonnull [[NONNULL:![0-9]+]], !noundef [[NOUNDEF]], !freeze [[NOUNDEF]]
; CHECK-NEXT: %v = load i32, ptr %v.ptr, align 8, !freeze [[NOUNDEF]]
