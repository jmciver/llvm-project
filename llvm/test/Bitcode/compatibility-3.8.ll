...
define void @atomics(i32* %word) {
  ...
  ; CHECK: %ld.1 = load atomic i32, ptr %word monotonic, align 4, !freeze !7
  %ld.2 = load atomic volatile i32, i32* %word acquire, align 8
  ; CHECK: %ld.2 = load atomic volatile i32, ptr %word acquire, align 8, !freeze !7
  %ld.3 = load atomic volatile i32, i32* %word syncscope("singlethread") seq_cst, align 16
  ; CHECK: %ld.3 = load atomic volatile i32, ptr %word syncscope("singlethread") seq_cst, align 16, !freeze !7
...
define void @instructions.memops(i32** %base) {
  ...
  ; CHECK: load ptr, ptr %base, align 8, !invariant.load !8, !nontemporal !7, !nonnull !8, !dereferenceable !9, !dereferenceable_or_null !9, !freeze !7
  load volatile i32*, i32** %base, align 8, !invariant.load !7, !nontemporal !8, !nonnull !7, !dereferenceable !9, !dereferenceable_or_null !9
  ; CHECK: load volatile ptr, ptr %base, align 8, !invariant.load !8, !nontemporal !7, !nonnull !8, !dereferenceable !9, !dereferenceable_or_null !9, !freeze !7
