...
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0:![0-9]+]], !sandboxvec [[META1:![0-9]+]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META2:![0-9]+]]
...
; CHECK-NEXT:    [[VECL1:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META3:![0-9]+]]
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META3]]
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr float, ptr [[PTR]], i32 0
; CHECK-NEXT:    [[VECL1:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META4:![0-9]+]]
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META4]]
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr float, ptr [[PTR]], i32 0
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META5:![0-9]+]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META6:![0-9]+]]
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr float, ptr [[PTR]], i32 0
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META10:![0-9]+]]
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr float, ptr [[PTR]], i32 0
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META11:![0-9]+]]
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr <2 x float>, ptr [[PTR]], i32 0
; CHECK-NEXT:    [[VECL:%.*]] = load <4 x float>, ptr [[PTR0]], align 8, !freeze [[META0]], !sandboxvec [[META12:![0-9]+]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x float>, ptr [[PTR0]], align 4, !freeze [[META0]], !sandboxvec [[META13:![0-9]+]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <4 x float>, ptr [[PTR0]], align 8, !freeze [[META0]], !sandboxvec [[META14:![0-9]+]]
...
; CHECK-SAME: ptr [[PTR0:%.*]]) {
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x double>, ptr [[PTR0]], align 8, !freeze [[META0]], !sandboxvec [[META17:![0-9]+]]
; CHECK-NEXT:    [[VECL1:%.*]] = load <2 x double>, ptr [[PTR0]], align 8, !freeze [[META0]], !sandboxvec [[META17]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x i8>, ptr [[GEP0]], align 1, !freeze [[META0]], !sandboxvec [[META18:![0-9]+]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <2 x i8>, ptr [[PTR0]], align 1, !freeze [[META0]], !sandboxvec [[META19:![0-9]+]]
...
; CHECK-NEXT:    [[VECL:%.*]] = load <4 x i8>, ptr [[PTR0]], align 2, !freeze [[META0]], !sandboxvec [[META20:![0-9]+]]
