...
; CHECK-NEXT:    [[P1_VAL:%.*]] = load i32, ptr [[P1]], align 4, !freeze_bits [[META0:![0-9]+]]
; CHECK-NEXT:    [[P2_VAL:%.*]] = load i32, ptr [[P2]], align 4, !range [[RNG1:![0-9]+]], !noundef [[META0]], !freeze_bits [[META0]]
; CHECK-NEXT:    [[P3_VAL:%.*]] = load ptr, ptr [[P3]], align 8, !freeze_bits [[META0]]
; CHECK-NEXT:    [[P4_VAL:%.*]] = load ptr, ptr [[P4]], align 8, !nonnull [[META0]], !noundef [[META0]], !freeze_bits [[META0]]
; CHECK-NEXT:    [[P5_VAL:%.*]] = load ptr, ptr [[P5]], align 8, !dereferenceable [[META2:![0-9]+]], !freeze_bits [[META0]]
; CHECK-NEXT:    [[P6_VAL:%.*]] = load ptr, ptr [[P6]], align 8, !dereferenceable_or_null [[META2]], !freeze_bits [[META0]]
; CHECK-NEXT:    [[P7_VAL:%.*]] = load ptr, ptr [[P7]], align 8, !freeze_bits [[META0]]
; CHECK-NEXT:    [[P8_VAL:%.*]] = load ptr, ptr [[P8]], align 8, !align [[META3:![0-9]+]], !noundef [[META0]], !freeze_bits [[META0]]
; CHECK-NEXT:    [[P9_VAL:%.*]] = load ptr, ptr [[P9]], align 8, !noundef [[META0]], !freeze_bits [[META0]]
; CHECK-NEXT:    [[P10_VAL:%.*]] = load ptr, ptr [[P10]], align 8, !nontemporal [[META4:![0-9]+]], !freeze_bits [[META0]]
...
; CHECK-NEXT:    [[P_VAL:%.*]] = load ptr, ptr [[P]], align 8, !freeze_bits [[META0]]
