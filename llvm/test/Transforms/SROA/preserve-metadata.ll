...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[BUF_0_COPYLOAD:%.*]] = load ptr, ptr [[ARG:%.*]], align 8, !freeze_bits [[META0]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = freeze i128 poison
; CHECK-NEXT:    [[TMP3:%.*]] = freeze i64 poison
; CHECK-NEXT:    [[A_SROA_2_0_INSERT_EXT:%.*]] = zext i64 [[TMP3]] to i128
; CHECK-NEXT:    [[A_SROA_2_0_INSERT_SHIFT:%.*]] = shl i128 [[A_SROA_2_0_INSERT_EXT]], 64
; CHECK-NEXT:    [[A_SROA_2_0_INSERT_MASK:%.*]] = and i128 [[TMP2]], 18446744073709551615
; CHECK-NEXT:    [[A_SROA_2_0_INSERT_INSERT:%.*]] = or i128 [[A_SROA_2_0_INSERT_MASK]], [[A_SROA_2_0_INSERT_SHIFT]]
; CHECK-NEXT:    [[TMP4:%.*]] = freeze i128 [[A_SROA_2_0_INSERT_INSERT]]
; CHECK-NEXT:    [[TMP5:%.*]] = freeze i64 [[TMP1]]
; CHECK-NEXT:    [[A_SROA_0_0_INSERT_EXT:%.*]] = zext i64 [[TMP5]] to i128
; CHECK-NEXT:    [[A_SROA_0_0_INSERT_MASK:%.*]] = and i128 [[TMP4]], -18446744073709551616
