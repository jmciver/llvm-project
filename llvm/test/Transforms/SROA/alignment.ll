...
; CHECK-DEBUGLOC-NEXT:    store double [[FREEZE]], ptr [[OUT]], align 1, !dbg [[DBG96:![0-9]+]]
...
; CHECK-DEBUGLOC-NEXT:    tail call void @llvm.dbg.value(metadata ptr undef, metadata [[META126:![0-9]+]], metadata !DIExpression()), !dbg [[DBG130]]
