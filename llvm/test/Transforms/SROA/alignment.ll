...
; CHECK-NEXT:    [[FREEZE:%.*]] = freeze i8 [[ALLOCA_SROA_0_0_COPYLOAD]]
; CHECK-NEXT:    store i8 [[FREEZE]], ptr [[GEP_B]], align 16
...
; CHECK-DEBUGLOC-NEXT:    [[FREEZE:%.*]] = freeze i8 [[ALLOCA_SROA_0_0_COPYLOAD]], !dbg [[DBG19:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    store i8 [[FREEZE]], ptr [[GEP_B]], align 16, !dbg [[DBG19]]
...
; CHECK-NEXT:    [[FREEZE5:%.*]] = freeze double [[A_SROA_4_0_COPYLOAD]]
; CHECK-NEXT:    [[FREEZE4:%.*]] = freeze double [[A_SROA_0_0_COPYLOAD]]
; CHECK-NEXT:    [[FREEZE:%.*]] = freeze double [[FREEZE5]]
...
; CHECK-NEXT:    [[FREEZE6:%.*]] = freeze double [[FREEZE4]]
; CHECK-NEXT:    store double [[FREEZE6]], ptr [[A_SROA_4_0_OUT_SROA_IDX2]], align 1
; CHECK-NEXT:    ret void
;
...
; CHECK-DEBUGLOC-NEXT:    [[FREEZE5:%.*]] = freeze double [[A_SROA_4_0_COPYLOAD]], !dbg [[DBG93:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata double [[FREEZE5]], metadata [[META88:![0-9]+]], metadata !DIExpression()), !dbg [[DBG93]]
; CHECK-DEBUGLOC-NEXT:    [[FREEZE4:%.*]] = freeze double [[A_SROA_0_0_COPYLOAD]], !dbg [[DBG94:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata double [[FREEZE4]], metadata [[META89:![0-9]+]], metadata !DIExpression()), !dbg [[DBG94]]
; CHECK-DEBUGLOC-NEXT:    [[FREEZE:%.*]] = freeze double [[FREEZE5]], !dbg [[DBG95:![0-9]+]]
...
; CHECK-DEBUGLOC-NEXT:    [[FREEZE6:%.*]] = freeze double [[FREEZE4]], !dbg [[DBG95]]
; CHECK-DEBUGLOC-NEXT:    store double [[FREEZE6]], ptr [[A_SROA_4_0_OUT_SROA_IDX2]], align 1, !dbg [[DBG95]]
