...
; CHECK-NEXT:    [[FREEZE3:%.*]] = freeze i16 poison
; CHECK-NEXT:    [[A_3_SROA_2_2_INSERT_EXT:%.*]] = zext i16 [[FREEZE3]] to i32
...
; CHECK-NEXT:    [[A_3_SROA_0_2_INSERT_EXT:%.*]] = zext i16 [[FREEZE]] to i32
...
; CHECK-NEXT:    [[FREEZE2:%.*]] = freeze i16 poison
; CHECK-NEXT:    [[RC:%.*]] = add i16 2, [[FREEZE2]]
; CHECK-NEXT:    ret i16 [[RC]]
;
bb1:
; This 12-byte alloca is split into partitions as [0,2), [2,4), [4,8), [8,10), [10, 12).
