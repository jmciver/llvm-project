...
; CHECK-PRESERVE-CFG-NEXT:    [[TMP_0_RES:%.*]] = load i8, ptr [[TMP]], align 4, !freeze_bits [[META0:![0-9]+]]
...
; CHECK-PRESERVE-CFG-NEXT:    [[TMP_0_RES:%.*]] = load i8, ptr [[TMP]], align 4, !freeze_bits [[META0]]
; CHECK-PRESERVE-CFG-NEXT:    ret i8 [[TMP_0_RES]]
;
...
; CHECK-NEXT:    [[TMP_0_RES:%.*]] = load i8, ptr [[TMP]], align 4, !freeze_bits [[META0:![0-9]+]]
