...
; CHECK-NEXT:    [[FREEZE_LOAD:%.*]] = freeze <4 x i64> poison
; CHECK-NEXT:    [[A_SROA_0_0_VEC_EXPAND:%.*]] = shufflevector <2 x i64> [[TMP1]], <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; CHECK-NEXT:    [[A_SROA_0_0_VECBLEND1:%.*]] = select <4 x i1> <i1 true, i1 true, i1 false, i1 false>, <4 x i64> [[A_SROA_0_0_VEC_EXPAND]], <4 x i64> [[FREEZE_LOAD]]
; CHECK-NEXT:    [[X_FCA_1_EXTRACT:%.*]] = extractvalue { <2 x ptr>, <2 x ptr> } [[X]], 1
; CHECK-NEXT:    [[TMP2:%.*]] = ptrtoint <2 x ptr> [[X_FCA_1_EXTRACT]] to <2 x i64>
; CHECK-NEXT:    [[A_SROA_0_0_VECBLEND:%.*]] = freeze <4 x i64> [[A_SROA_0_0_VECBLEND1]]
...
; CHECK-NEXT:    [[A_SROA_0_0_VECBLEND1:%.*]] = select <4 x i1> <i1 true, i1 true, i1 false, i1 false>, <4 x ptr> [[A_SROA_0_0_VEC_EXPAND]], <4 x ptr> [[FREEZE_LOAD]]
; CHECK-NEXT:    [[X_FCA_1_EXTRACT:%.*]] = extractvalue { <2 x i64>, <2 x i64> } [[X]], 1
; CHECK-NEXT:    [[TMP2:%.*]] = inttoptr <2 x i64> [[X_FCA_1_EXTRACT]] to <2 x ptr>
; CHECK-NEXT:    [[A_SROA_0_0_VECBLEND:%.*]] = freeze <4 x ptr> [[A_SROA_0_0_VECBLEND1]]
...
; CHECK-NEXT:    [[A_SROA_0_0_VEC_INSERT1:%.*]] = insertelement <2 x i64> [[FREEZE_LOAD]], i64 [[TMP2]], i32 0
...
; CHECK-NEXT:    [[A_SROA_0_0_VEC_INSERT:%.*]] = freeze <2 x i64> [[A_SROA_0_0_VEC_INSERT1]]
...
; CHECK-NEXT:    [[FREEZE_LOAD:%.*]] = freeze <2 x ptr> poison
