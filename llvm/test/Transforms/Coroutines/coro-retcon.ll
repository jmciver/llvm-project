...
; CHECK-NEXT:    tail call void @print(i32 5), !noalias [[META1:![0-9]+]]
; CHECK-NEXT:    tail call void @print(i32 6), !noalias [[META4:![0-9]+]]
...
; CORO-NEXT:    [[PTR_RELOAD:%.*]] = load ptr, ptr [[PTR_RELOAD_ADDR]], align 8, !freeze_bits [[META0:![0-9]+]]
