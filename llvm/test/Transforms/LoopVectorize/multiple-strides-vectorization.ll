...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i32>, ptr [[TMP12]], align 4, !alias.scope [[META0:![0-9]+]], !freeze_bits [[META3:![0-9]+]]
...
; CHECK-NEXT:    [[WIDE_LOAD8:%.*]] = load <4 x i32>, ptr [[TMP16]], align 4, !alias.scope [[META6:![0-9]+]], !noalias [[META8:![0-9]+]], !freeze_bits [[META3]]
...
; CHECK-HOIST-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i32>, ptr [[TMP6]], align 4, !alias.scope [[META0:![0-9]+]], !freeze_bits [[META3:![0-9]+]]
...
; CHECK-HOIST-NEXT:    [[WIDE_LOAD5:%.*]] = load <4 x i32>, ptr [[TMP10]], align 4, !alias.scope [[META6:![0-9]+]], !noalias [[META8:![0-9]+]], !freeze_bits [[META3]]
