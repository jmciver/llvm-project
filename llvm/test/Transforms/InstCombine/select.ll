...
; CHECK-NEXT:    [[SEL:%.*]] = select i1 [[COND:%.*]], <2 x i8> [[Y:%.*]], <2 x i8> <i8 3, i8 3>
; CHECK-NEXT:    ret <2 x i8> [[SEL]]
;
...
; CHECK-NEXT:    [[FREEZE:%.*]] = freeze <2 x ptr> <ptr poison, ptr getelementptr inbounds (i8, ptr @glb.struct.1, i64 800)>
