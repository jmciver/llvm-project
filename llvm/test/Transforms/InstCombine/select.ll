...
; CHECK-NEXT:    [[X_VAL:%.*]] = freeze i32 [[T]]
; CHECK-NEXT:    store i32 [[X_VAL]], ptr [[Y]], align 4
...
; CHECK-NEXT:    call void @scribble_on_i32(ptr nonnull [[Y]])
; CHECK-NEXT:    [[T:%.*]] = load i32, ptr [[X]], align 4
; CHECK-NEXT:    [[T_FR:%.*]] = freeze i32 [[T]]
; CHECK-NEXT:    store i32 [[T_FR]], ptr [[Y]], align 4
; CHECK-NEXT:    [[V:%.*]] = bitcast i32 [[T_FR]] to float
; CHECK-NEXT:    ret float [[V]]
;
  %x = alloca float
  %y = alloca i32
...
; CHECK-NEXT:    [[T_FR:%.*]] = freeze float [[T]]
; CHECK-NEXT:    store float [[T_FR]], ptr [[Y]], align 4
; CHECK-NEXT:    [[V:%.*]] = bitcast float [[T_FR]] to i32
; CHECK-NEXT:    ret i32 [[V]]
;
  %x = alloca float
  %y = alloca i32
...
; CHECK-NEXT:    [[T_FR:%.*]] = freeze i64 [[T]]
; CHECK-NEXT:    store i64 [[T_FR]], ptr [[Y]], align 8
; CHECK-NEXT:    [[V:%.*]] = inttoptr i64 [[T_FR]] to ptr
...
; CHECK-NEXT:    [[T_FR:%.*]] = freeze ptr [[T]]
; CHECK-NEXT:    store ptr [[T_FR]], ptr [[Y]], align 8
; CHECK-NEXT:    [[V:%.*]] = ptrtoint ptr [[T_FR]] to i64
...
; CHECK-NEXT:    [[X_VAL:%.*]] = load i128, ptr [[X]], align 8, !freeze_bits [[FREEZE_BITS0]]
; CHECK-NEXT:    [[Y_VAL:%.*]] = load i128, ptr [[Y]], align 8, !freeze_bits [[FREEZE_BITS0]]
