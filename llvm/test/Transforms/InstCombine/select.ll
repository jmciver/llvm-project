...
define <2 x i8> @select_freeze_poison_vector(i1 %cond, <2 x i8> noundef %y) {
; CHECK-LABEL: @select_freeze_poison_vector(
; CHECK-NEXT:    [[Y:%.*]] = select i1 [[COND:%.*]], <2 x i8> [[Y1:%.*]], <2 x i8> zeroinitializer
