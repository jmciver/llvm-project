...
; CHECK-NEXT:    [[Y_VAL:%.*]] = freeze i32 [[TMP_1_I]]
; CHECK-NEXT:    [[TMP_3_I:%.*]] = load i32, ptr [[X:%.*]], align 4
; CHECK-NEXT:    [[X_VAL:%.*]] = freeze i32 [[TMP_3_I]]
; CHECK-NEXT:    [[TMP_4:%.*]] = call i32 @llvm.smin.i32(i32 [[Y_VAL]], i32 [[X_VAL]])
...
; CHECK-NEXT:    [[TMP_0_VAL:%.*]] = freeze i32 [[TMP_2]]
; CHECK-NEXT:    [[TMP_3_I:%.*]] = load i32, ptr [[Y:%.*]], align 4
; CHECK-NEXT:    [[Y_VAL:%.*]] = freeze i32 [[TMP_3_I]]
; CHECK-NEXT:    [[TMP_6:%.*]] = call i32 @llvm.smax.i32(i32 [[TMP_0_VAL]], i32 [[Y_VAL]])
