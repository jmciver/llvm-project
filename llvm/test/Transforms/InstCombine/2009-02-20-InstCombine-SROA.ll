...
; IC-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TMP1]], align 4, !freeze_bits [[META0:![0-9]+]]
; IC-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[X]], align 4, !freeze_bits [[META0]]
...
; IC_SROA-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[TMP0]], align 4, !freeze_bits [[META0:![0-9]+]]
; IC_SROA-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[X]], align 4, !freeze_bits [[META0]]
...
; IC_SROA-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD27]], i32 4
...
; IC_SROA-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD29]], i32 4
...
; IC_SROA-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD31]], i32 4
...
; IC_SROA-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD33]], i32 4
...
; IC_SROA-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD37]], i32 4
...
; IC_SROA-NEXT:    [[TMP30:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD40]], i32 4
...
; IC_SROA-NEXT:    [[TMP33:%.*]] = getelementptr i8, ptr [[FREEZE_LOAD43]], i32 4
