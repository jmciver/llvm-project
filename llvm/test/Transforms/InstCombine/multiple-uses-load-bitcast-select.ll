...
; CHECK-NEXT:    [[LD1_FR:%.*]] = freeze double [[LD1]]
; CHECK-NEXT:    [[LD2:%.*]] = load double, ptr [[Z1]], align 8
; CHECK-NEXT:    [[LD2_FR:%.*]] = freeze double [[LD2]]
; CHECK-NEXT:    [[TMP10:%.*]] = fcmp olt double [[LD1_FR]], [[LD2_FR]]
; CHECK-NEXT:    [[TMP12_V:%.*]] = select i1 [[TMP10]], double [[LD1_FR]], double [[LD2_FR]]
