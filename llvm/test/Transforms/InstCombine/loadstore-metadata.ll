...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[PTR:%.*]], align 4, !tbaa [[TBAA0:![0-9]+]], !freeze [[META3:![0-9]+]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[PTR:%.*]], align 4, !alias.scope [[META4:![0-9]+]], !noalias [[META4]], !freeze [[META3]]
; CHECK-NEXT:    ret i32 [[L1]]
;
entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[L1:%.*]] = load float, ptr [[PTR:%.*]], align 4, !freeze [[META3]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[PTR:%.*]], align 4, !invariant.load [[META3]], !freeze [[META3]]
; CHECK-NEXT:    ret i32 [[L1]]
;
entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[PTR:%.*]], align 4, !nontemporal [[META7:![0-9]+]], !freeze [[META3]]
; CHECK-NEXT:    ret i32 [[L1]]
;
entry:
...
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[SRC_GEP]], align 4, !llvm.access.group [[ACC_GRP9:![0-9]+]], !freeze [[META3]]
...
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[PTR:%.*]], align 4, !noundef [[META3]], !freeze [[META3]]
; CHECK-NEXT:    ret i32 [[L1]]
;
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[L1:%.*]] = load i32, ptr [[PTR:%.*]], align 4, !noalias.addrspace [[META10:![0-9]+]], !freeze [[META3]]
; CHECK-NEXT:    ret i32 [[L1]]
;
entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[B_VAL:%.*]] = load ptr, ptr [[B:%.*]], align 1, !nonnull [[META3]], !align [[META8]], !freeze [[META3]]
; CHECK-NEXT:    [[A_VAL:%.*]] = load ptr, ptr [[A:%.*]], align 1, !nonnull [[META3]], !align [[META8]], !freeze [[META3]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[B_VAL:%.*]] = load i32, ptr [[B:%.*]], align 1, !range [[RNG11:![0-9]+]], !freeze [[META3]]
; CHECK-NEXT:    [[A_VAL:%.*]] = load i32, ptr [[A:%.*]], align 1, !range [[RNG11]], !freeze [[META3]]
