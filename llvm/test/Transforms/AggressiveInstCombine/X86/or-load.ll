...
; LE-NEXT:    [[L1:%.*]] = load i16, ptr [[P:%.*]], align 1, !freeze_bits [[META0:![0-9]+]]
; LE-NEXT:    ret i16 [[L1]]
;
...
; BE-NEXT:    [[L1:%.*]] = load i16, ptr [[P:%.*]], align 1, !freeze_bits [[META0:![0-9]+]]
; BE-NEXT:    ret i16 [[L1]]
;
  %p1 = getelementptr i8, ptr %p, i32 1
  %l1 = load i8, ptr %p
...
; LE-NEXT:    [[L1:%.*]] = load i32, ptr [[P:%.*]], align 1, !freeze_bits [[META0]]
; LE-NEXT:    ret i32 [[L1]]
;
...
; BE-NEXT:    [[L1:%.*]] = load i32, ptr [[P:%.*]], align 1, !freeze_bits [[META0]]
; BE-NEXT:    ret i32 [[L1]]
;
  %p1 = getelementptr i8, ptr %p, i32 1
  %p2 = getelementptr i8, ptr %p, i32 2
...
; LE-NEXT:    [[P2:%.*]] = getelementptr i8, ptr [[P:%.*]], i32 2
; LE-NEXT:    [[P3:%.*]] = getelementptr i8, ptr [[P]], i32 3
; LE-NEXT:    [[L1:%.*]] = load i16, ptr [[P]], align 1, !freeze_bits [[META0]]
...
; BE-NEXT:    [[P2:%.*]] = getelementptr i8, ptr [[P:%.*]], i32 2
; BE-NEXT:    [[P3:%.*]] = getelementptr i8, ptr [[P]], i32 3
; BE-NEXT:    [[L1:%.*]] = load i16, ptr [[P]], align 1, !freeze_bits [[META0]]
...
; LE-NEXT:    [[L1:%.*]] = load i64, ptr [[P]], align 4, !freeze_bits [[META0]]
...
; BE-NEXT:    [[P2:%.*]] = getelementptr i32, ptr [[P:%.*]], i32 2
; BE-NEXT:    [[P3:%.*]] = getelementptr i32, ptr [[P]], i32 3
; BE-NEXT:    [[L1:%.*]] = load i64, ptr [[P]], align 4, !freeze_bits [[META0]]
...
; LE-NEXT:    [[L1:%.*]] = load i64, ptr [[P:%.*]], align 2, !freeze_bits [[META0]]
; LE-NEXT:    ret i64 [[L1]]
;
...
; BE-NEXT:    [[L1:%.*]] = load i64, ptr [[P:%.*]], align 2, !freeze_bits [[META0]]
; BE-NEXT:    ret i64 [[L1]]
;
  %p1 = getelementptr i16, ptr %p, i32 1
  %p2 = getelementptr i16, ptr %p, i32 2
...
; LE-NEXT:  entry:
; LE-NEXT:    [[TMP0:%.*]] = load i64, ptr [[PTR:%.*]], align 1, !freeze_bits [[META0]]
...
; LE-NEXT:    [[L1:%.*]] = load i32, ptr [[P:%.*]], align 1, !alias.scope [[META1:![0-9]+]], !freeze_bits [[META0]]
...
; LE-NEXT:    [[L1:%.*]] = load i64, ptr [[P:%.*]], align 1, !freeze_bits [[META0]]
; LE-NEXT:    ret i64 [[L1]]
;
...
; BE-NEXT:    [[L1:%.*]] = load i64, ptr [[P:%.*]], align 1, !freeze_bits [[META0]]
; BE-NEXT:    ret i64 [[L1]]
;
  %p1 = getelementptr i8, ptr %p, i32 1
  %p2 = getelementptr i8, ptr %p, i32 2
...
; LE-LABEL: @eggs(
; LE-NEXT:    [[TMP3:%.*]] = load i64, ptr [[ARG:%.*]], align 1, !freeze_bits [[META0]]
...
; LE-NEXT:    [[P2:%.*]] = getelementptr i8, ptr [[P:%.*]], i32 2
; LE-NEXT:    [[L1:%.*]] = load i16, ptr [[P]], align 2
; LE-NEXT:    [[L2:%.*]] = load i16, ptr [[P2]], align 1, !freeze_bits [[META0]]
...
; BE-NEXT:    [[P2:%.*]] = getelementptr i8, ptr [[P:%.*]], i32 2
; BE-NEXT:    [[L1:%.*]] = load i16, ptr [[P]], align 2
; BE-NEXT:    [[L2:%.*]] = load i16, ptr [[P2]], align 1, !freeze_bits [[META0]]
...
; LE-NEXT:    [[L1:%.*]] = load i32, ptr [[TMP1]], align 1, !freeze_bits [[META0]]
; LE-NEXT:    ret i32 [[L1]]
;
...
; LE:       bb2:
; LE-NEXT:    [[L1:%.*]] = load i32, ptr [[P1]], align 1, !freeze_bits [[META0]]
...
; LE-NEXT:    [[L2:%.*]] = load i8, ptr [[P1]], align 1
; LE-NEXT:    store i8 0, ptr [[P3]], align 1
; LE-NEXT:    [[L3:%.*]] = load i16, ptr [[P2]], align 1, !freeze_bits [[META0]]
...
; LE-NEXT:    [[LD2:%.*]] = load i64, ptr [[TMP1]], align 4, !freeze_bits [[META0]]
