...
; SSE2-NEXT:  entry:
; SSE2-NEXT:    [[LD0:%.*]] = load i16, ptr [[Y:%.*]], align 2, !freeze [[META0:![0-9]+]]
; SSE2-NEXT:    [[LD1:%.*]] = load i16, ptr [[X:%.*]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_1:%.*]] = load i16, ptr [[PT0_1]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_1:%.*]] = load i16, ptr [[PT1_1]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_2:%.*]] = load i16, ptr [[PT0_2]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_2:%.*]] = load i16, ptr [[PT1_2]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_3:%.*]] = load i16, ptr [[PT0_3]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_3:%.*]] = load i16, ptr [[PT1_3]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_4:%.*]] = load i16, ptr [[PT0_4]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_4:%.*]] = load i16, ptr [[PT1_4]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_5:%.*]] = load i16, ptr [[PT0_5]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_5:%.*]] = load i16, ptr [[PT1_5]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_6:%.*]] = load i16, ptr [[PT0_6]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_6:%.*]] = load i16, ptr [[PT1_6]], align 2, !freeze [[META0]]
...
; SSE2-NEXT:    [[LD0_7:%.*]] = load i16, ptr [[PT0_7]], align 2, !freeze [[META0]]
; SSE2-NEXT:    [[LD1_7:%.*]] = load i16, ptr [[PT1_7]], align 2, !freeze [[META0]]
...
; SSE4-NEXT:  entry:
; SSE4-NEXT:    [[TMP0:%.*]] = load <8 x i16>, ptr [[Y:%.*]], align 2, !freeze [[META0:![0-9]+]]
; SSE4-NEXT:    [[TMP1:%.*]] = load <8 x i16>, ptr [[X:%.*]], align 2, !freeze [[META0]]
...
; AVX-NEXT:  entry:
; AVX-NEXT:    [[TMP0:%.*]] = load <8 x i16>, ptr [[Y:%.*]], align 2, !freeze [[META0:![0-9]+]]
; AVX-NEXT:    [[TMP1:%.*]] = load <8 x i16>, ptr [[X:%.*]], align 2, !freeze [[META0]]
