...
; CHECK-NEXT:    [[PTR_SROA_0_3_VEC_INSERT_FR:%.*]] = freeze <16 x i8> [[PTR_SROA_0_3_VEC_INSERT]]
...
; CHECK-NEXT:    [[PTR_SROA_0_15_VEC_INSERT:%.*]] = shufflevector <16 x i8> [[PTR_SROA_0_7_VEC_INSERT_FR]], <16 x i8> [[BC0]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 20, i32 21, i32 22, i32 23, i32 16, i32 17, i32 18, i32 19>
