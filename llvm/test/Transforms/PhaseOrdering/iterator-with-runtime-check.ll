...
; CHECK:       for.body:
; CHECK-NEXT:    [[__BEGIN1_SROA_0_05:%.*]] = phi ptr [ [[INCDEC_PTR_I:%.*]], [[FOR_LATCH:%.*]] ], [ [[TMP0]], [[FOR_COND_PREHEADER]] ]
; CHECK-NEXT:    [[CMP_NOT_I_I:%.*]] = icmp uge ptr [[__BEGIN1_SROA_0_05]], [[TMP0]]
; CHECK-NEXT:    [[CMP2_I_I:%.*]] = icmp ult ptr [[__BEGIN1_SROA_0_05]], [[ADD_PTR_I]]
; CHECK-NEXT:    [[SEL:%.*]] = select i1 [[CMP_NOT_I_I]], i1 [[CMP2_I_I]], i1 false
; CHECK-NEXT:    br i1 [[SEL]], label [[FOR_LATCH]], label [[ERROR]]
; CHECK:       for.latch:
