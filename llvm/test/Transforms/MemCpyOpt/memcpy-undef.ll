...
; check that the memcpy is removed with malloc.
define void @test_memcpy_removal_uninitialzied(ptr nocapture %foobie) nounwind noinline ssp uwtable {
; CHECK-LABEL: @test_memcpy_removal_uninitialzied(
...
declare noalias ptr @malloc(i64 noundef) nounwind allockind("alloc,uninitialized") allocsize(0) "alloc-family"="malloc"
