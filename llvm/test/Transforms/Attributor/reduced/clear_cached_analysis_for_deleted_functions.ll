...
; CGSCC-NEXT:    [[CALL23_VAL:%.*]] = load ptr, ptr [[CALL23]], align 8, !freeze_bits [[FREEZE_BITS0:![0-9]+]]
; CGSCC-NEXT:    [[CALL24]] = call ptr @list_Car(ptr nofree noundef readonly [[CALL23_VAL]]) #[[ATTR3:[0-9]+]]
; CGSCC-NEXT:    br label [[DO_BODY]]
;
entry:
  br label %do.body
